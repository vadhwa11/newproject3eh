...
/**
 * This is an object that contains data related to the mas_qualification table.
...
public abstract class BaseMasQualification  implements Serializable {

	public static String REF = "MasQualification";
	 ...
	 */
	public BaseMasQualification (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hrms.masters.business.MasQualification)) return false;
		else {
			jkt.hrms.masters.business.MasQualification masQualification = (jkt.hrms.masters.business.MasQualification) obj;
			if (null == this.getId() || null == masQualification.getId()) return false;
			else return (this.getId().equals(masQualification.getId()));
		}
	}
