...
/**
 * This is an object that contains data related to the mas_employee_caste table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="mas_employee_caste"
 */

public abstract class BaseMasEmployeeCaste  implements Serializable {

	public static String REF = "MasEmployeeCaste";
	 ...
	 */
	public BaseMasEmployeeCaste (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hms.masters.business.MasEmployeeCaste)) return false;
		else {
			jkt.hms.masters.business.MasEmployeeCaste masEmployeeCaste = (jkt.hms.masters.business.MasEmployeeCaste) obj;
			if (null == this.getId() || null == masEmployeeCaste.getId()) return false;
			else return (this.getId().equals(masEmployeeCaste.getId()));
		}
	}
