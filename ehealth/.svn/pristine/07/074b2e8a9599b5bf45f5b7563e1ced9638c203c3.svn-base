...
<h2 align="left" class="style1">Monthly Sick Discharge Report for
Staff (38-B)</h2>
<br />
...
<input type="button" name="OK" value="OK" class="button"
	onClick="submitForm('monthlySick','mis?method=searchMonthlySickDischargeReport','checkFromNTodata');" />
