...
<div class="clear"></div>
<label>Notification Date <span>* </span></label>
	
<input type="text" name="Notification_Date" id="Notification_Date"  validate='Notification Date,date,yes' value=""  class="date" onkeyup="mask(this.value,this,'2,5','/');"	 maxlength="10" onblur="validateExpDate(this,'td');"/>
<img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0" id="calToDate" onclick="javascript:setdate('',document.<%="itemGrid"%>.<%="Notification_Date"%>,event)" /> 
<label ><span>*</span> Notification No </label>
<input type="text" id="notification" name="notification" value="" MAXLENGTH="12" class="medium3" validate="Notification No,String,yes" />
<label > Application From Date </label>
<input type="text" name="fromDate" id="fromDate"  validate='Application From Date,date,yes' value=""  class="date" onkeyup="mask(this.value,this,'2,5','/');"	 maxlength="10" onblur="validateExpDate(this,'td');"/>
...
<input type="text" name="toDate" id="toDate"  validate='Application To Date,date,yes' value=""  class="date" onkeyup="mask(this.value,this,'2,5','/');"	 maxlength="10" onblur="validateExpDate(this,'td');"/>
...
<div class="paddingTop15"></div>
<div id="edited"></div>
<input type="button" name="add" id="addbutton" value="Add"	class="button" onClick="submitForm('itemGrid','/hms/hrms/training?method=saveTransferNotification','chkDate')"	accesskey="a" tabindex=1 /> 
...
function chkDate()
{
	...
	if(obj1 != "" && obj2 != "" && obj3 != "")
	{
		...
		{
			errorMsg += "Notfication Date should be less than both dates.\n ";
			return false;
		}
