...
/**
 * This is an object that contains data related to the hr_resumetechnical table.
 * Do not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 * 
 * @hibernate.class table="hr_resumetechnical"
 */

public abstract class BaseResumetechnical implements Serializable {

	public static String REF = "Resumetechnical";
	...
	public static String PROP_OBSERVER1 = "Observer1";
	public static String PROP_OBSERVER2 = "Observer2";
	public static String PROP_OBSERVER3 = "Observer3";
	 ...
	 */
	public BaseResumetechnical(java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	private java.lang.String observer1;
	private java.lang.String observer2;
	private java.lang.String observer3;
	...
	/**
	 * Return the value associated with the column: observer1
	 */
	public java.lang.String getObserver1() {
		return observer1;
	}

	/**
	 * Set the value related to the column: observer1
	 * 
	 * @param observer1
	 *            the observer1 value
	 */
	public void setObserver1(java.lang.String observer1) {
		this.observer1 = observer1;
	}

	/**
	 * Return the value associated with the column: observer2
	 */
	public java.lang.String getObserver2() {
		return observer2;
	}

	/**
	 * Set the value related to the column: observer2
	 * 
	 * @param observer2
	 *            the observer2 value
	 */
	public void setObserver2(java.lang.String observer2) {
		this.observer2 = observer2;
	}

	/**
	 * Return the value associated with the column: observer3
	 */
	public java.lang.String getObserver3() {
		return observer3;
	}

	/**
	 * Set the value related to the column: observer3
	 * 
	 * @param observer3
	 *            the observer3 value
	 */
	public void setObserver3(java.lang.String observer3) {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof jkt.hrms.recruitment.masters.business.Resumetechnical)) {
			return false;
		} else {
			jkt.hrms.recruitment.masters.business.Resumetechnical resumetechnical = (jkt.hrms.recruitment.masters.business.Resumetechnical) obj;
			if (null == this.getId() || null == resumetechnical.getId()) {
				return false;
			} else {
				return (this.getId().equals(resumetechnical.getId()));
			}
		}
	}
