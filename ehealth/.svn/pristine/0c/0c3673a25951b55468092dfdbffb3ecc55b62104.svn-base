...
public interface TrainingHandlerService {
	...
	// *********************************** Start Training Module's Training
	// Master By Rajendra ***********************************************//
	...
	Map<String, Object> searchTrainingMaster(String trainingCode,
			String trainingName);
	Map<String, Object> saveProcessingDetails(Map<String, Object> dataMap, Box box);
	
	Map<String, Object> forwardProcessingDetails(Map<String, Object> dataMap, Box box);
	...
	Map<String, Object> showTransferProcessingJsp(Map<String, Object> datmap);

	Map<String, Object> saveVacancyPosition(HrVacancyPost hrvp,
			Map<String, Object> dataMap);
