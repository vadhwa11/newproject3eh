		...
		<tr>
			...
			<table width="402" height="348" border="0" align="center"
				...
				<tr>
					...
					<div id="editusergroup"><br> <!-- new code !-->
...
%>
						...
						<tr>
							<td><input name="assignAccessRight" type="submit"
								...
								onClick="if(validate('userGroupAccessRights')){submitForm('userGroupAccessRights','/hms/hms/login?method=assignAccessRightsToUserGroup')}"></td>
							<td><input name="Cancel" type="button" class="button"
								value="Cancel" onclick="javascript:history.back()"></td>
							<td><input name="reset" type="button"
								class="buttonHighlight" value="Reset"
								onclick="submitForm('userGroupAccessRights','/hms/hms/login?method=showUserGroupAccessRights');"></td>
						</tr>
						<tr>
							<td colspan="3">&nbsp;</td>
						</tr>
