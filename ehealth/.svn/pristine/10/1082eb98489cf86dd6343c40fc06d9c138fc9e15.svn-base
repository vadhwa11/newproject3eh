...
/**
 * This is an object that contains data related to the mas_care_type table.
...
public abstract class BaseMasCareType  implements Serializable {
	 ...
	 * @param careTypeCode the care_type_code value
	 */
	 ...
	 * @param careTypeName the care_type_name value
	 */
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hms.masters.business.MasCareType)) return false;
		else {
			jkt.hms.masters.business.MasCareType masCareType = (jkt.hms.masters.business.MasCareType) obj;
			if (null == this.getId() || null == masCareType.getId()) return false;
			else return (this.getId().equals(masCareType.getId()));
		}
	}
