...
<textarea id="presentingComplaints" name="presentingComplaints" class="comorBiditylarge" validate="presenting Complaints,string,no" cols="0" rows="0" maxlength="300"></textarea>
<div class="clear"></div>
