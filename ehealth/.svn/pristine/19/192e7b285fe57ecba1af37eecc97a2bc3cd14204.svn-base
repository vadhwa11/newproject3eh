  					...
  					while(itr.hasNext())
  					{
  			          ...
  			          if(patientPrescriptionDetails.getManufacturer()!=null)
  			          {
  			        	...
  			        	manufactureId =patientPrescriptionDetails.getManufacturer().getId();
  			        	 ...
  			        	 Float dosage= patientPrescriptionDetails.getDosage();
  			        	 String type = "";
  			        	 String frequency="";
  			        	 int frequencyId=0;
  			        	 ...
  			        	 if(patientPrescriptionDetails.getTotal()!=null && !patientPrescriptionDetails.getTotal().equals("")){
		...
		<tr>
			...
			<td>
		       ...
		       <%if(patientPrescriptionDetails.getRoute()!=null){ %>
		        <input	type="hidden" name="route<%=i%>" id="route<%=i%>" value="<%=patientPrescriptionDetails.getRoute()!=null?patientPrescriptionDetails.getRoute().getId()!=null?patientPrescriptionDetails.getRoute().getId():"":""%>" />
		        <%}else{ %>
	...
	//	}
		...
		for(var index=0;index<counter;index++){
			...
			if(toEval.checked==true){
			  ...
			  /* var lenTab = window.opener.document.getElementById("prescriptionTabGrid").rows.length;
			  var rTab = window.opener.document.getElementById("prescriptionTabGrid").insertRow(lenTab); B*/
			  ...
			  var cellRight0 = r.insertCell(0);
				...
				var e1 = document.createElement('input');
				e1.type = 'text';
				e1.name = 'nomenclaturepTab' + len;
				e1.id = 'nomenclaturepTab' + len;
				...
				var e1 = document.createElement('input');
				e1.type = 'hidden';
				e1.name = 'pvmsNopTab' + len;
				e1.id = 'pvmsNopTab' + len;
				 e1.value = pvmsNo;
				cellRight1.appendChild(e1);
				...
				var e1 = document.createElement('input');
				e1.name = 'dosagepTab' + len;
				e1.id = 'dosagepTab' + len;
				e1.style.width = "34px";
				...
				var e1 = document.createElement('Select');
				e1.name = 'frequencypTab' + len;
				e1.id = 'frequencypTab' + len;
				//e1.style.width = "69px";
				e1.style.width = "55px";
				e1.style.background = "#FFFF99";
				...
				e21.type = 'hidden';
				e21.name = 'sosQtypTab' + len;
				e21.id = 'sosQtypTab' + len;
				e21.size = '5';
				...
				var e21 = document.createElement('input');
				e21.type = 'hidden';
				e21.name = 'frequencyValuepTab' + len;
				e21.id = 'frequencyValuepTab' + len;
				e21.size = '5';
				e21.value=freqValue;
				e21.setAttribute('tabindex', '1');
				cellRight1.appendChild(e21);
				...
				eDiv.setAttribute("style","width:75px; float: left");
				var e1 = document.createElement('input');
				e1.type = 'text';
				e1.name = 'noOfDayspTab' + len;
				e1.className = "textYellow opdTextBoxTSmall";
				e1.style.width = "14px";
				e1.id = 'noOfDays' + len;
				e1.size = '3';
				...
				var e1 = document.createElement('Select');
				e1.name = 'instrunctionpTab' + len;
				e1.id = 'instrunctionpTab' + len;
				//e1.style.width = "90px";
				e1.style.width = "80px";
				e1.style.background = "#FFFF99";
				...
				var e1 = document.createElement('input');
				e1.type = 'text';
				e1.name = 'splInstrunctionpTab' + len;
				e1.id = 'splInstrunctionpTab' + len;
				e1.style.width = "60px";
...
function checkRepeatPrescriptionItem(cnt,visitId,pvmsNo) {
  		...
  		var visitId = visitId;
  		var nomenclature = window.opener.document.getElementById("nomenclaturepTab" + cnt).value
