...
<c:if test="${not empty requestScope.map.sampleScreeningList}">
 ...
 <thead>
		...
		<tr onclick="submitForm('pendingSamlpeScreening','/hms/hms/bloodBank?method=showScreeningProcessJsp&samplId=${samplescreening.id}')" 
			style="cursor: pointer;">
		<td><input type="hidden" name="sampleCollectionId${samplescreening.id}" value="${samplescreening.id}"/>
