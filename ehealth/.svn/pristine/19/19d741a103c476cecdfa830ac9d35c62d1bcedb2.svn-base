...
<select id="mainAccountId"  name="<%=ACCOUNT_ID %>" >
...
<input type="text" name="<%= FROM_DATE%>" id="from_date" value="<%=date %>" validate="From Date,yes" class="date" MAXLENGTH="30" readonly="readonly" /> 
...
<input type="text" name="<%= TO_DATE%>" id="to_date" value="<%=date %>" validate="To Date,yes"	class="date" MAXLENGTH="30" readonly="readonly" /> 
