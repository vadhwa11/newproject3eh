...
/**
 * This is an object that contains data related to the hr_resumehrdetailshistory
 * table. Do not modify this class because it will be overwritten if the
 * configuration file related to this class is modified.
 * 
 * @hibernate.class table="hr_resumehrdetailshistory"
 */

public abstract class BaseResumehrdetailshistory implements Serializable {

	public static String REF = "Resumehrdetailshistory";
	...
	// constructors
	public BaseResumehrdetailshistory() {
		initialize();
	}
	 ...
	 */
	public BaseResumehrdetailshistory(java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof jkt.hrms.recruitment.masters.business.Resumehrdetailshistory)) {
			return false;
		} else {
			jkt.hrms.recruitment.masters.business.Resumehrdetailshistory resumehrdetailshistory = (jkt.hrms.recruitment.masters.business.Resumehrdetailshistory) obj;
			if (null == this.getId() || null == resumehrdetailshistory.getId()) {
				return false;
			} else {
				return (this.getId().equals(resumehrdetailshistory.getId()));
			}
		}
	}
