...
<select name="categoryId" id="categoryId" validate="Item Category,metachar,no"  onblur="submitProtoAjaxWithDivName('annualDepartmentIndent','stores?method=getItemListForGrp','gridDiv');">
...
<select name="classId" id="classId" validate="Item Group,metachar,no" onblur="submitProtoAjaxWithDivName('annualDepartmentIndent','stores?method=getItemListForGrp','gridDiv');" >
<%	if(classList.size() !=0){%>
