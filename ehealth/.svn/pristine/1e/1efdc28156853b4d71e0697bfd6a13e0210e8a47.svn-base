...
public class PatientSampleCollectionDataToLeanServerSchedular extends
		QuartzJobBean {

	private static final Logger logger = org.apache.log4j.Logger
			.getLogger(PatientSampleCollectionDataToLeanServerSchedular.class);
	...
	protected void executeInternal(JobExecutionContext context)
		...
		Map<String, Object> dataMap = labDataService
				.getPatientSampleCollectionDataForLeanServer();
