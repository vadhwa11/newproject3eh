...
prop.load(in);
%>
<div id="testDiv"><label><span>*</span><%=prop.getProperty("com.jkt.hms.ipd_no") %></label> 
<select 	name="inpId" validate="<%=prop.getProperty("com.jkt.hms.ipd_no") %>,string,yes" id="adNo">
