...
<label> CollectionCenter Code </label>
<input type="radio"	name="<%=SELECTED_RADIO  %>" value="1" checked="checked" class="radiobutMargin" /> 
<label> CollectionCenter Name </label> 
...
<input type="hidden" name="<%=JASPER_FILE_NAME%>" value="Dg_collection_center">
		...
		if(searchCollectionCenterList.size()>0)
		 {
			...
			{
	%> <h4><a href="laboratory?method=showCollectionCenterJsp">Show All
Records</a></h4> <%
			}
		 }
...
<div class="clear"></div>
<div class="Block">
<label><span>*</span> CollectionCenter Code </label> 
<input id="codeId" type="text" name="<%= CODE%>" value="" validate="CollectionCenter Code,string,yes" class="textbox_size20" MAXLENGTH="8" / tabindex=1>
<label><span>*</span> CollectionCenter Name </label> 
<input type="text" name="<%= SEARCH_NAME %>" value="" validate="CollectionCenter Name,string,yes" class="textbox_size20" MAXLENGTH="30" / tabindex=1 onkeypress="return submitenter(this,event,'laboratory?method=addCollectionCenter')">
	<script>
...
<input type="button" name="add" id="addbutton" value="Add"
	class="button"
	onClick="submitForm('collectionCenter','laboratory?method=addCollectionCenter');"
	accesskey="a" tabindex=1 /> <input type="button" name="edit"
	id="editbutton" value="Update" style="display: none;" class="button"
	onClick="submitForm('collectionCenter','laboratory?method=editCollectionCenter')"
	accesskey="u" tabindex=1 /> <input type="button" name="Delete"
	id="deletebutton" value="Activate" style="display: none;"
	class="button"
	onClick="submitForm('collectionCenter','laboratory?method=deleteCollectionCenter&flag='+this.value)"
