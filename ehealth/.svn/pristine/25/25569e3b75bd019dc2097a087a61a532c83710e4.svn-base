...
<div class="titleBg">
<h2>Intrim Indent Processing BY KMSCL Pending List</h2>
</div>
...
<table border="0" cellpadding="0" cellspacing="0">
					...
					%>
					<tr onclick="submitForm('annualIndentProcessingByKMSCLPendingList','stores?method=showEmergencyIndentProcessingByKMSCL&storeInternalMId=<%=storeInternalIndentM.getId() %>');">
