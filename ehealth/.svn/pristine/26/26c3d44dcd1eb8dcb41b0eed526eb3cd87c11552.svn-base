...
var bankArray=new Array();
 ...
 if(b==true){ %>
		     --%><div class="titleBg">
<h2>MLC(24 Hours) Patient Bill Discount</h2>
</div>
<div class="clear"></div>
<!--Block One Starts-->
...
<input type="button" class="button" tabindex="8" value="Discount"
	name="Submit"
	onclick="submitForm('deposit','opd?method=updateBillsForMLC');"
	align="right" />
