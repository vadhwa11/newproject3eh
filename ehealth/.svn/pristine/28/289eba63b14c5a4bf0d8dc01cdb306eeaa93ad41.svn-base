...
public interface PubHealthDataService {
	...
	Map<String, Object> saveIntoLocationParameter(
...
//VK	
	...
	Map<String, Object> detailTransferMember(Box box,
...
//KM
	...
	Map<String, Object> detailApplockPassword(Box box,
			Map<String, Object> details);
	...
	Map<String, Object> shownXmplRepordt();
	...
	Map<String, Object> getItemListForAutoCompleteForICDandInvastigation(Map mapForDS);
	...
	Map<String, Object> showDashboardTargetDetails(Box box);
