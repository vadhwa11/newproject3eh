		...
		<table width="20%" align="right" border="0" cellpadding="0"
			...
			<tr>
				...
				<td width="7%" background="/hms/jsp/images/toolbuttBack.gif"><input
					type="button" name="Add" value="Add" onClick="openPopupWindow();"
					class="toolbutton"></td>
				<td width="1%" background="/hms/jsp/images/toolbuttBack.gif"></td>
				<td width="10%" background="/hms/jsp/images/toolbuttBack.gif"><input
					type="button" name="Submit" value="Submit" onClick="upd();"
					class="toolbutton"></td>
				<td width="2%" background="/hms/jsp/images/toolbuttBack.gif"></td>
				<td width="9%" background="/hms/jsp/images/toolbuttBack.gif"><input
					type="button" name="Reset" value="Reset" class="buttonHighlight"></td>
				<td width="2%" background="/hms/jsp/images/toolbuttBack.gif"></td>
				<td width="9%" background="/hms/jsp/images/toolbuttBack.gif"><input
...
<input type="hidden"
	...
	name="<%=BOS_ID%>" id="bosNo" value="<%=bosNo%>" readonly="readonly"
	class="readOnly" MAXLENGTH="8"/  > <label class="bodytextB">BOS
Date :</label> <input type="text" name=<%=BOS_DATE%> class="textbox_size20"
	value="<%=currentDate%>" readonly /> <br />
<div class="Height10"></div>
<input type="button" name="Submit" id="addbutton"
	value="Import Condemnation Entry" class="buttonbig"
	onClick="importBosData();" /> <br />
<div class="Height10"></div>
<% if (pagedArray == null) { %>
...
<table width="100%" colspan="7" id="bosDetails" class="grid_header"
	...
	<thead>
		<tr>
			<td width="10%" rowspan="2"><label valign="left"
				class="smalllabel">S.No.</label></td>
			<td width="10%" rowspan="2"><label valign="left"
				class="smalllabel">PVMS No</label></td>
			<td width="10%" rowspan="2"><label valign="left"
				class="smalllabel">Nomenclature</label></td>
			<td width="10%" rowspan="2"><label valign="left"
				class="smalllabel">A/U</label></td>
			<td width="10%" rowspan="2"><label valign="left"
				class="smalllabel">SerialNo</label></td>
			<td width="10%" rowspan="2"><label valign="left"
				class="smalllabel">Qty</label></td>
			<td colspan="4" align="center" class="smalllabel">Condition of
			Item</td>
			<td colspan="5" align="center" class="smalllabel">Recommendation
			of Board</td>
			<td align="center" class="smalllabel">&nbsp;</td>
			<td>&nbsp;</td>
		</tr>
		<tr>
...
<% } else { %> <!--<div style="width: 15px; height: 20px; float:left;"></div>-->
<div
...
<br />
<div
	style="overflow: auto; width: 100%; height: 200px; padding-left: 9px; border: 1px solid;">
<table width="100%" colspan="7" id="bosDetails" class="grid_header"
	style="border: 1px solid;" border="1" cellpadding="0" cellspacing="0">
	<thead>
		<tr>
			<td width="10%" rowspan="2"><label valign="left"
				class="smalllabel">S.No.</label></td>
