...
<div class="Block">
<form name="empPerformanceReviewCard" method="post" action="">
...
%><div class="titleBg">
<h2>Employee Performance Review Card</h2>
</div>

<div class="clear"></div>
<label>Employee</label> <select name="frmEmpCode" id="frmEmpCode">
...
<input type="button" class="button" value="print" name="print"
	onclick="submitForm('empPerformanceReviewCard','/hms/hrms/report?method=printEmpPerformanceReviewCard');" />
</form>
</div>