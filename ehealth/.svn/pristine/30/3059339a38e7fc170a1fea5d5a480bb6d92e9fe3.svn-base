...
<%
	...
	int patientMlcId = 0;
	if(map.get("patientMlcId") !=null){
		patientMlcId=(Integer)map.get("patientMlcId");
	}
...
<input type="hidden" name="patientMlcId" id="patientMlcId" value="<%=patientMlcId%>" />
...
function getBackPage(){
	...
	window.location="/hms/hms/mlc?method=showPatientMlcWaitingList";
...
function printReport(){
	...
	var patientmlcId=document.getElementById('patientMlcId').value;
	var mortuaryRegdDetailId=document.getElementById('mortuaryRegdDetailId').value;
	alert("patientmlcId..."+patientmlcId+"mortuaryRegdDetailId...."+mortuaryRegdDetailId);
	window.location="/hms/hms/mlc?method=generateReportForMortuary&patientMlcId="+patientmlcId+"&mortuaryRegdDetailId="+mortuaryRegdDetailId;
