...
<%
	...
	List<HesRefilledCylinderDeliveryHeader> hesRoutineWorkList = new ArrayList<HesRefilledCylinderDeliveryHeader>();
	...
	if (map.get("hesRoutineWorkList")!= null)
		hesRoutineWorkList = (List<HesRefilledCylinderDeliveryHeader>)map.get("hesRoutineWorkList");
...
<%
		...
		String dt_challan = "";
		String challanDate = "";
		for (HesRefilledCylinderDeliveryHeader emptyCylinderHeader : hesRoutineWorkList )
		{
...
<input type="button" name="sss" align="right" class="button" value="Submit"
 onclick="if(checkFilledRow()){submitForm('purchaseGrid','hes?method=updateRefilledCylinderDeliveryEntry');}" />
