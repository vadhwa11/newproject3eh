...
<form name="instituteWiseIndentApprovalPendingList" method="post">
<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
<div class="titleBg">
<h2>Pending List For  Institute Wise Annual Indent Approval </h2>
</div>
...
<table border="0" cellpadding="0" cellspacing="0">
					...
					%>
					<tr onclick="submitForm('instituteWiseIndentApprovalPendingList','stores?method=showInstituteAnnualIndentApprovalJsp&storeInternalMId=<%=storeInternalIndentM.getId() %>');">
