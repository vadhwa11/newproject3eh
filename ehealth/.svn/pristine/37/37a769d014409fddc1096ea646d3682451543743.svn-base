...
<input type="button" name="OK" id="addbutton" value="Print" class="button" onClick="submitForm('cashRegister','account?method=printSanctionAmountReport');" accesskey="a" tabindex=1 />
