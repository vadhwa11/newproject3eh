...
<form name="consentStored" action="" method="post">
...
<div class="clear"></div>
<div class="titlebg">
<h2>Consent Letter Upload and Download</h2>
</div>
<div class="Block">
...
<div id="searchbar">
	<input type="button" name="Back" value="Back" class="buttonHighlight"	tabindex="1" onclick="showBack('consentStored')" />	
...
function popwindowUploadDocuments() {
	...
	if(patienthinid !=""){
		var url="/hms/hms/ot?method=openUploadPopWindow&hinId="+patienthinid+"&visitId="+<%=visitId%>+"&inpatientId="+<%=inpatientId%>+"&otConsent=y"+"&"+csrfTokenName+"="+csrfTokenValue;
...
function showBack(formName)
{
  ...
  obj.action = "/hms/hms/ot?method=showUploadOtConsentLetter";
  obj.submit();
}
</script>