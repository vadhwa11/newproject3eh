...
<table>
	<tr><th>S No.</th><th>Name</th><th>Address</th><th>Contact No</th><th>Head Of Department</th><th>Type</th></tr>
	...
	%> 
		    ...
		    <td><%= survey.getPerson1Name() != null ? survey.getPerson1Name() : ""%> </td>
		    <td><%= survey.getType() != null && survey.getType().equals("HO")? "Hospital" : "Clinic"%> </td>
