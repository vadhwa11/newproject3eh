...
/**
 * This is an object that contains data related to the hr_employee_shift_details
 * table. Do not modify this class because it will be overwritten if the
 * configuration file related to this class is modified.
 * 
 * @hibernate.class table="hr_employee_shift_details"
 */

public abstract class BaseHrEmployeeShiftDetails implements Serializable {

	public static String REF = "HrEmployeeShiftDetails";
	...
	// constructors
	public BaseHrEmployeeShiftDetails() {
		initialize();
	}
	 ...
	 */
	public BaseHrEmployeeShiftDetails(java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	// many to one
	private jkt.hrms.masters.business.HrMasShiftCodes sundayShift;
	private jkt.hms.masters.business.MasHospital hospital;
	private jkt.hrms.masters.business.HrMasShiftCodes mondayShift;
	private jkt.hrms.masters.business.HrMasShiftCodes thursdayShift;
	private jkt.hrms.masters.business.HrMasShiftCodes wednesdayShift;
	private jkt.hrms.masters.business.HrMasShiftCodes saturdayShift;
	private jkt.hrms.masters.business.HrMasShiftCodes fridayShift;
	private jkt.hms.masters.business.MasEmployee employee;
	private jkt.hrms.masters.business.HrMasShiftCodes tuesdayShift;
	 ...
	 */
	public jkt.hrms.masters.business.HrMasShiftCodes getSundayShift() {
		return sundayShift;
	}
	...
	public void setSundayShift(
			jkt.hrms.masters.business.HrMasShiftCodes sundayShift) {
	 ...
	 */
	public jkt.hrms.masters.business.HrMasShiftCodes getMondayShift() {
		return mondayShift;
	}
	...
	public void setMondayShift(
			jkt.hrms.masters.business.HrMasShiftCodes mondayShift) {
	 ...
	 */
	public jkt.hrms.masters.business.HrMasShiftCodes getThursdayShift() {
	...
	public void setThursdayShift(
			jkt.hrms.masters.business.HrMasShiftCodes thursdayShift) {
	 ...
	 */
	public jkt.hrms.masters.business.HrMasShiftCodes getWednesdayShift() {
	...
	public void setWednesdayShift(
			jkt.hrms.masters.business.HrMasShiftCodes wednesdayShift) {
	 ...
	 */
	public jkt.hrms.masters.business.HrMasShiftCodes getSaturdayShift() {
	...
	public void setSaturdayShift(
			jkt.hrms.masters.business.HrMasShiftCodes saturdayShift) {
	 ...
	 */
	public jkt.hrms.masters.business.HrMasShiftCodes getFridayShift() {
		return fridayShift;
	}
	...
	public void setFridayShift(
			jkt.hrms.masters.business.HrMasShiftCodes fridayShift) {
	 ...
	 */
	public jkt.hrms.masters.business.HrMasShiftCodes getTuesdayShift() {
		return tuesdayShift;
	}
	...
	public void setTuesdayShift(
			jkt.hrms.masters.business.HrMasShiftCodes tuesdayShift) {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof jkt.hrms.masters.business.HrEmployeeShiftDetails)) {
			return false;
		} else {
			jkt.hrms.masters.business.HrEmployeeShiftDetails hrEmployeeShiftDetails = (jkt.hrms.masters.business.HrEmployeeShiftDetails) obj;
			if (null == this.getId() || null == hrEmployeeShiftDetails.getId()) {
				return false;
			} else {
				return (this.getId().equals(hrEmployeeShiftDetails.getId()));
			}
		}
	}
