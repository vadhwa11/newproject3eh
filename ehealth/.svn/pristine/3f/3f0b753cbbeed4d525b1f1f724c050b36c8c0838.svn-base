...
/**
 * This is an object that contains data related to the central_server_result_data table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="central_server_result_data"
 */

public abstract class BaseCentralServerResultData  implements Serializable {

	public static String REF = "CentralServerResultData";
	...
	// constructors
	public BaseCentralServerResultData () {
		initialize();
	}
	 ...
	 */
	public BaseCentralServerResultData (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hms.masters.business.CentralServerResultData)) return false;
		else {
			jkt.hms.masters.business.CentralServerResultData centralServerResultData = (jkt.hms.masters.business.CentralServerResultData) obj;
			if (null == this.getId() || null == centralServerResultData.getId()) return false;
			else return (this.getId().equals(centralServerResultData.getId()));
		}
	}
