...
<input type="button" name="add" id="addbutton" value="Back" class="button" onClick="submitForm('patientAD','pubHealth?method=showSchoolAnganwadiRegistrationJsp');" accesskey="a" tabindex=1 />
