...
%>
	...
	<%}%>
		...
		<label>Patient Name</label><input type="text"
			...
			No</label> <input type="text" name="<%=MOBILE_NO %>" value="" MAXLENGTH="50" />
...
%>
	...
	<input type="button" value="Search" class="button"
		onclick="submitForm('patientSearch','/hms/hms/investigation?method=searchPatientForQC','checkFromNTodata');"
		accesskey="a" />
