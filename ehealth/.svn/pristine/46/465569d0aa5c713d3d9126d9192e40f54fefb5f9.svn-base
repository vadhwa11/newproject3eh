...
<select id="<%= ITEM_TYPE_ID %>"	name="<%=ITEM_TYPE_ID %>" validate="Item Type,string,yes" tabindex=1 onblur="submitProtoAjaxWithDivName('itemGrid','/hms/hms/procurement?method=getSectionGLList&type='+this.value,'testDiv');" tabindex=1>
