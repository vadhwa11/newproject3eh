...
/**
 * This is an object that contains data related to the lean_server_patient_reg_data table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="lean_server_patient_reg_data"
 */

public abstract class BaseLeanServerPatientRegData  implements Serializable {

	public static String REF = "LeanServerPatientRegData";
	...
	// constructors
	public BaseLeanServerPatientRegData () {
		initialize();
	}
	 ...
	 */
	public BaseLeanServerPatientRegData (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hms.masters.business.LeanServerPatientRegData)) return false;
		else {
			jkt.hms.masters.business.LeanServerPatientRegData leanServerPatientRegData = (jkt.hms.masters.business.LeanServerPatientRegData) obj;
			if (null == this.getId() || null == leanServerPatientRegData.getId()) return false;
			else return (this.getId().equals(leanServerPatientRegData.getId()));
		}
	}
