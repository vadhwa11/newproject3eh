...
<div class="Block">
	...
	<img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0" onclick="setdate('',document.balancesheet.select_date,event)" />
...
<div class="clear"></div>
<input type="button" name="add" id="addbutton" value="Print" class="button" onClick="submitForm('balancesheet','account?method=printBalanceSheetReport');" accesskey="a" tabindex=1 />
