...
<select  validate="Month,string,no" name="atpJphniJhiMonths" onblur="submitProtoAjaxWithDivNameToShowStatus('approval','/hms/hms/pubHealth?method=getMonthsForApprve&monthValue='+this.value,'testDivs');">
<%
