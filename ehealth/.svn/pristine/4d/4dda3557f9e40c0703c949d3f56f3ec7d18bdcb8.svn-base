...
public class XSSRequestWrapper extends HttpServletRequestWrapper {
    ...
    private String stripXSS(String value) {
        if (value != null) {
            ...
            // Avoid onerror= expressions
            scriptPattern = Pattern.compile("onloadeddata(.*?)=", Pattern.CASE_INSENSITIVE | Pattern.MULTILINE | Pattern.DOTALL);
            value = scriptPattern.matcher(value).replaceAll("");
         ...
         // Avoid onerror= expressions
            scriptPattern = Pattern.compile("onpageshow(.*?)=", Pattern.CASE_INSENSITIVE | Pattern.MULTILINE | Pattern.DOTALL);
            value = scriptPattern.matcher(value).replaceAll("");
            
         // Avoid onerror= expressions
            scriptPattern = Pattern.compile("onpagehide(.*?)=", Pattern.CASE_INSENSITIVE | Pattern.MULTILINE | Pattern.DOTALL);
            value = scriptPattern.matcher(value).replaceAll("");
