...
<label>CHC</label><input type="radio" name="center" id="center" value="chc" onclick="submitProtoAjaxWithDivName('death','/hms/hms/pubHealth?method=getchclist&district='+this.value,'tDiv');">
<label>PHC</label><input type="radio" name="center" id="center" value="phc" onclick="submitProtoAjaxWithDivName('death','/hms/hms/pubHealth?method=getchclist&district='+this.value,'tDiv');">
</div>
...
<div class="clear"></div>
 <div id="tDiv">
    ...
    <select name="cdeath" id="cdeath" validate="" multiple="multiple" class="list" size="6" style="width:187px; margin: 0 1px 5px;">
...
<input type="button" name="add" id="addbutton" value="Generate Report"
	class="buttonBig"
	onClick="submitForm('death','pubHealth?method=generateDeathRegisterReport','checkk()');"
