...
public interface ProjectTrackingDataService {
	...
	Map<String, Object> saveRoleWiseResourceRequired(Map<String, Object> generalMap);
	...
	Map<String, Object> updateRoleWiseResourceRequired(
...
/********************************** Methods Start For QA Approval Status JSP  ******************************************/
