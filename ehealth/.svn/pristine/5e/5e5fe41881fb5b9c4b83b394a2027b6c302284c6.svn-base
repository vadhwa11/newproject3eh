...
<input type="radio"	name="<%=SELECTED_RADIO  %>" value="1" checked="checked" class="radiobutMargin"  validate="BabyStatus Code,int,no" /> 
<label>BabyStatus Name </label> 
<input type="radio" name="<%=SELECTED_RADIO %>" value="2" class="radiobutMargin" validate="BabyStatus Name,int,no" />
...
<input type="hidden"
	name="<%=JASPER_FILE_NAME%>" value="Mas_baby_status">
		...
		if(searchBabyStatusList.size()>0)
		 {
			...
			{
	%> <h4><a href="inPatientMaster?method=showBabyStatusJsp">Show All
Records</a></h4> <%
			}
		 }
...
<input
	type="hidden" name="<%=POJO_PROPERTY_NAME %>" value="BabyStatusName"><input
	type="hidden" name="title" value="BabyStatus"><input
	type="hidden" name="<%=JSP_NAME %>" value="babyStatus"><input
	type="hidden" name="pojoPropertyCode" value="BabyStatusCode">
<div class="paddingTop5"></div>
<div class="clear"></div>
<div class="Block">
<label><span>*</span> BabyStatus Code</label> 
<input id="codeId" type="text" name="<%= CODE%>" value=""	validate="BabyStatus Code,string,yes" class="textbox_size20"	MAXLENGTH="8" / tabindex=1>
<label><span>*</span> BabyStatus Name</label>
 <input type="text" name="<%= SEARCH_NAME %>" value=""	validate="BabyStatus Name,string,yes" class="textbox_size20"	MAXLENGTH="30" / tabindex=1	onkeypress="return submitenter(this,event,'inPatientMaster?method=addBabyStatus')">
 <script>
...
<input type="button" name="add" id="addbutton" value="Add"
	class="button"
	onClick="submitForm('babyStatus','inPatientMaster?method=addBabyStatus');"
	accesskey="a" tabindex=1 /> <input type="button" name="edit"
	id="editbutton" value="Update" style="display: none;" class="button"
	onClick="submitForm('babyStatus','inPatientMaster?method=editBabyStatus')"
	accesskey="u" tabindex=1 /> <input type="button" name="Delete"
	id="deletebutton" value="Activate" style="display: none;"
	class="button"
	onClick="submitForm('babyStatus','inPatientMaster?method=deleteBabyStatus&flag='+this.value)"
