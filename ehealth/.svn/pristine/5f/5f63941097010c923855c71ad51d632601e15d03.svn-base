...
<select name="<%=CLASS %>" validate="Class,string,yes"   tabindex=1    onblur="submitProtoAjaxWithDivNameToShowStatus('student','/hms/hms/pubHealth?method=populateDivision&surveyIdMap=<%=surveyIdMap%>&classId='+this.value,'testDivSection');">
