...
<label>Patient Name</label> <input type="text" name="<%=P_FIRST_NAME %>"
	...
	onclick="submitForm('patientSearch','/hms/hms/investigation?method=searchPatientForResultValidationLabForEmpanelled','checkFromNTodata');"
...
<div class="clear"></div>
<form name="pendingResultValidationLabForEmpanelled" method="post" action="">
...
<script type="text/javascript" language="javascript">
	...
	formName = "pendingResultValidationLabForEmpanelled";
	start = 0
