...
public interface StoresHandlerService {
	...
	// --------------------methods added by vikas on 20/04/09------------
	...
	// ------------------------------------Start of Methods Written By Deepti
	// tevatia-------------------------------
	...
	Map getBalance1ModifyMap(int balanceId, int pageNo,
			Map<String, Object> dataMap);

	boolean updateNextBalance1(Map<String, Object> masterAndDetailMap)
			throws java.text.ParseException;

	Map addNextOrSubmitBalance(Map<String, Object> dataMap,Box box);

	Map<String, Object> getItemDetailsForStockTakingAdd(Box box);

	// ------------------------------------End of Methods Written By Deepti
	// tevatia-------------------------------
	...
	Map<String, Object> showDeptIssueWithoutIndentJsp(
			Map<String, Object> dataMap);
	...
	Map<String, Object> getItemListForVendorByAutocomplete(
			Map<String, Object> dataMap);
...
/*	Map<String, Object> checkIssueNo(Map<String, Object> dataMap);*/
	...
	Map<String, Object> getDemandListForOtherInstitute(
			Map<String, Object> dataMap);
 ...
 //VK
	...
	Map<String, Object> getsearchPatientReturnDrug(Box box);//added by govind 30-9-2016
	
	Map<String, Object> getItemListForAutoCompleteForStockRegister(Map<String, Object> map);
	
	Map<String, Object> searchDirectDispensing(Box box);//added by govind 15-10-2016
