...
<input type="button" name="Search" id="addbutton"	onclick="submitProtoAjaxWithDivNameForVillageSurvey('observation','/hms/hms/pubHealth?method=getlistbyVisit','tDivss');" value="Search" class="button"  />
