...
<div class="clear"></div>
<div class="titleBg">
<h2>Update Death Certificate</h2>
</div>
<%
...
<div class="Block">
<label><span>*</span> Death Certificate No</label> 
<input 	type="text" name="<%=BIRTH_CERTIFICATE_NO%>" id="<%=BIRTH_CERTIFICATE_NO%>" value="" class="textbox_date" validate="DCNo,string,yes"
MAXLENGTH="10" onblur="submitProtoAjaxWithDivName('fatalDocumentPanchnamaReport','mis?method=showUpdateDeathCertificate','testDiv')" />
<div id="testDiv">
<div class="clear"></div>
</div>
<div class="clear"></div>
