...
<div class="Block">
<form name="observation_ward_Waiting_List" method="post" action="">
<div class="clear"></div>
...
<script type="text/javascript" language="javascript">
	...
	while(iterator.hasNext())
	{
		...
		data_arr[<%= i%>][10] ='<input type="button" value="ADMIT" name="admit" class="buttonAuto" onClick="submitForm(\'observation_ward_Waiting_List\',\'/hms/hms/opd?method=opdPatientObservationStatus&opdId=<%=opdId%>\');"/>'
	<%
		i++;
	}
	}catch(Exception e){
	...
	formName = "observation_ward_Waiting_List"
