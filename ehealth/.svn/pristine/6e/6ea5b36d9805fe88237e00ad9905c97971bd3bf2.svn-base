...
<form name="form6A" method="post" action="" >
<div class="titleBg"> <h2>Form 6A</h2></div>
<div class="clear"></div>
<div class="Block">
...
<input name="Ok" type="button" class="button" value="OK" onclick="submitForm('form6A','report?method=printForm6A');"/>
