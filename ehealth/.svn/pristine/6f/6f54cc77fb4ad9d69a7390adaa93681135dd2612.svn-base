...
<textarea name="<%=RequestConstants.INDENT_FROM%>" cols="25" rows="2"
	class="txtarea" validate="Hosp/Unit Addr ,string,yes"
	onKeyPress="limitText(this,70);"></textarea> <label class="bodytextB"><font
	id="error"></font>Item req for Dept/WARD:</label> <select
...
<label class="bodytextB"><font id="error"></font>Nomenclature of
Item :</label> <input type="text" value="" tabindex="1"
...
<input type="hidden" name="<%=RequestConstants.INDENT_ID %>"
	value="<%=indentId%>" id="indentId" /> <input type="button" name="sss"
	align="right" class="button" value="Submit"
	onclick="{submitForm('indentGrid','nonExp?method=addNextOrSubmitIndentToSOC&buttonName=submit');}" />
	...
	<tbody>
		<tr>
			...
			<td colspan="9"><textarea
				...
				validate="Brief mention of functions and Justification of proposed eqpt ,string,no"></textarea>
			</td>
		</tr>
		<tr>
			<td valign="top" width="201"><font class="bodytextBtab"><font
			...
			<td colspan="9"><textarea
				...
				validate="Existing facilities at the hospital and deficiency / inadequacy if any  ,string,no"></textarea>
			</td>
		</tr>
		<tr>
			<td valign="top" width="201"><font class="bodytextBtab"><font
			...
			<td colspan="9"><textarea
				...
				validate="How was the work going on in the absence of subject equipment ,string,no"></textarea>
			</td>
		</tr>
		<tr>
			<td valign="top" width="201"><font class="bodytextBtab"><font
			...
			<td colspan="9"><textarea name="<%=RequestConstants.FEEDBACK%>"
				...
				validate="Feedback about the performance from hospitals having the equipment ,string,no"></textarea>
			</td>
		</tr>
		<tr>
			<td valign="top" width="201"><font class="bodytextBtab"><font
			...
			<td colspan="9"><textarea
				...
				onKeyPress="limitText(this,256);"
				validate="No. of patients will be benefited from the equipment ,string,no"></textarea>
			</td>
		</tr>
		<tr>
			<td valign="top" width="201"><font class="bodytextBtab"><font
			...
			<td colspan="9"><textarea
				...
				onKeyPress="limitText(this,256);"
				validate="Desirability of out sourcing the required service from economy point of view ,string,no"></textarea>
			</td>
		</tr>
		<tr>
			<td valign="top" width="201"><font class="bodytextBtab"><font
			...
			<td colspan="9"><textarea
				...
				validate="Manufacturer (Full Address),string,no"></textarea></td>
		</tr>
		<tr>
			<td valign="top" width="201"><font class="bodytextBtab"><font
			...
			<td colspan="9"><input type="text"
				...
				onKeyPress="limitText(this,20);" value="" class="textbox_size20"
				validate="Country of origin,string,no" MAXLENGTH="20" /></td>
		</tr>
		<tr>
			<td valign="top" width="201"><font class="bodytextBtab"><font
			...
			<td colspan="9"><textarea
				...
				onKeyPress="limitText(this,100);"
				validate="Indian agent  Delhi Address ,string,no"></textarea></td>
		</tr>
		<tr>
			<td valign="top" width="201"><font class="bodytextBtab"><font
				id="error"></font>STD code, Tele No : </font></td>
			<td colspan="9"><input name="<%=RequestConstants.STD_CODE %>"
				type="text" onKeyPress="limitText(this,7);" class="smcaption"
				size="6" validate="STD code ,int,no" /> <input type="text"
				name="<%=RequestConstants.TELE_NO %>" value=""
				onKeyPress="limitText(this,10);" class="textbox_size20"
				validate="Tele No  ,numWithoutSpaces,no" MAXLENGTH="10" /></td>
		</tr>
		<tr>
			<td valign="top" width="201"><font class="bodytextBtab"><font
			...
			<td colspan="9"><input type="text"
				...
				validate="Fax No,numWithoutSpaces,no" MAXLENGTH="10" /></td>
		</tr>
		<tr>
			<td valign="top" width="201"><font class="bodytextBtab"><font
			...
			<td colspan="9"><input type="text"
				...
				value="" class="textbox_size20" validate="Email,email,no"
				MAXLENGTH="20" /></td>
		</tr>
		<tr>
			<td valign="top" width="201"><font class="bodytextBtab"><font
			...
			<td colspan="9"><textarea
				...
				onKeyPress="limitText(this,256);" cols="30"
				validate="Local Address ,string,no"></textarea></td>
		</tr>
		<tr>
			<td valign="top" width="201"><font class="bodytextBtab"><font
				id="error"></font>STD code, Tele No : </font></td>
			<td colspan="9"><input
				...
				validate="Local STD code,string,no" /> <input type="text"
				name="<%=RequestConstants.LOCAL_TELE_NO %>" value=""
				onKeyPress="limitText(this,10);" class="textbox_size20"
				validate="Local Tel no,numWithoutSpaces,no" MAXLENGTH="10" /></td>
		</tr>
		<tr>
			<td valign="top" width="201"><font class="bodytextBtab"><font
				id="error"></font>Fax No: </font></td>
			<td colspan="9"><input type="text"
				...
				onKeyPress="limitText(this,10);" value="" class="textbox_size20"
				validate="Local Fax No,numWithoutSpaces,no" MAXLENGTH="10" /></td>
		</tr>
		<tr>
			<td valign="top" width="201"><font class="bodytextBtab"><font
				id="error"></font>Email: </font></td>
			<td colspan="9"><input type="text"
				...
				onKeyPress="limitText(this,130);" value="" class="textbox_size20"
				MAXLENGTH="20" /></td>
		</tr>
		<tr>
			<td valign="top" width="201"><font class="bodytextBtab"><font
			...
			<td colspan="9"><input type="text"
				...
				class="textbox_size20" MAXLENGTH="7" /></td>
		</tr>
		<tr>
			<td valign="top" width="201"><font class="bodytextBtab"><font
			...
			<td colspan="9"><textarea
				...
				validate="Must accessories (attach list with qty)  ,string,no"></textarea>
			</td>
		</tr>
		<tr>
			<td valign="top" width="201"><font class="bodytextBtab"><font
			...
			<td colspan="9"><textarea
				...
				onKeyPress="limitText(this,256);" rows="2" cols="30"
				validate="Essential accessories (attach list with qty) ,string,no"></textarea>
			</td>
		</tr>
		<tr>
			<td valign="top" width="201"><font class="bodytextBtab"><font
			...
			<td colspan="9"><textarea
				...
				validate="AT/SO number and qty. of similar items received ,string,no"></textarea>
			</td>
		</tr>
		<tr>
			<td valign="top" width="201"><font class="bodytextBtab"><font
			...
			<td colspan="9"><textarea
				...
				validate="Reference of indents not yet materialized ,string,no"></textarea>
			</td>
		</tr>
		<tr>
			<td valign="top" width="201"><font class="bodytextBtab"><font
		...
		<tr>
			...
			<td colspan="9"><input type="text"
				...
				onKeyPress="limitText(this,256);" value="" class="textbox_size20"
		...
		<tr>
			...
			<td colspan="9"><select
				name="<%= RequestConstants.CONSUMABLE_REQUIRED%>">
				<option value="0">Select</option>
		...
		<tr>
			...
			<td colspan="9"><input type="text"
				name="<%=RequestConstants.IF_YES_QTY %>" value=""
