...
<form name="departmentWiseProjectCostReport" method="post" action="">
<div class="titleBg">
<h2>Department wise Project Cost Report</h2></div>
    ...
    <div class="clear"></div>
		...
		<%} %>
     	...
     	<select name="<%=DEPARTMENT_ID%>"  validate="Project,string,no" onChange="populateEmployee1(this.value,'departmentWiseProjectCostReport')">
    	...
    	<input name="<%=FROM_DATE%>" id="fromDateForApply" type="text" readonly validate='From Date,date,yes' value="" class="date" />
   		<img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0" id="calFromDate" 
   			onclick="javascript:setdate('',document.departmentWiseProjectCostReport.<%=FROM_DATE%>,event)"  />
    	...
    	<img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0" id="calToDate"
    		onclick="javascript:setdate('',document.departmentWiseProjectCostReport.<%=TO_DATE%>,event)" />
...
%>
    	...
    	<div class="clear"></div>
    	<input type="button" class="button" value="print" name="print" onclick="submitForm('departmentWiseProjectCostReport','/hms/hrms/report?method=printDepartmentWiseProjectCostReport');"/>
