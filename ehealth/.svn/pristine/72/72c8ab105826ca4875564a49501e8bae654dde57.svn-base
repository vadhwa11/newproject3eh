...
<%
        ...
        System.out.println("maritalStatusList==="+maritalStatusList.size());
        ...
        if(map.get("occupationList") != null){
         ...
         if(map.get("template")!=null){
        	 templateId = Integer.parseInt((String)map.get("template"));
         }
         String tempLateName = "";
...
function showCoords(event) {
	alert("inside methgod")
    var x = event.clientX;
    var y = event.clientY;
    var coor = "X coords: " + x + ", Y coords: " + y;
    document.getElementById("example").innerHTML = coor;
}
...
<!-- <div id="example" onmousedown="showCoords(event)" onmouseup="clearCoor()">
			...
			int i=0;
				if(masForGorupParameter.size()>0)
				{
					...
					for(MasSpecialityDeptGroup deptGroup: masForGorupParameter)
						...
						<div class="clear"></div>
<input type="button" class="buttonAdd" alt="Add" tabindex="4"	value="&nbsp;" onclick="addRowForPrimaryLesion();" />
  ...
  <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tablestyle" id="primaryLessionGrid"> 
    ...
    <tr>
     ...
     <td>
      ...
      <td>
		<select name="typeOfPrimaryLesion1" id="typeOfPrimaryLesion1">
		<option value="">Select</option>
     ...
     <td>
		...
		<input  type="text" maxlength="120" validate="Duration,metachar,no" tabindex="1" value="" name="primaryLargestSize1" ></td>
		<td>
  ...
  <table width="500" border="0" cellpadding="5" cellspacing="0" style="width:600px; float:left;" class="tablestyle" id="secondaryLessionGrid"> 
    ...
    <tr>
     ...
     <td>
		...
		<input  type="text" maxlength="120" validate="Duration,metachar,no" tabindex="1" value="" name="secondaryLargestSize1" ></td>
		<td>
