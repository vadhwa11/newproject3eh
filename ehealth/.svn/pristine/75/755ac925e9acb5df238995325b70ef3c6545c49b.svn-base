...
<div class="leftMenu">Project Setting

	<div class="clear"></div>	
	<input type="image" src="/hms/jsp/images/buttonIcons/patientIssue.jpg" class="buttonBig" name="ProjectVitals" onClick="submitForm('projectvitals','projectTracking?method=showAddProjectVitals','validateRadio');" value="Project Vitals" height="34" width="188" />
	
	<input type="image" src="/hms/jsp/images/buttonIcons/intakeOutput.jpg" class="buttonBig" name="OtherVitals" onClick="submitForm('projectvitals','projectTracking?method=showOtherVitalsJsp','validateRadio');" value="Other Vitals" height="34" width="188" />
	
	<input type="image" src="/hms/jsp/images/buttonIcons/intakeOutput.jpg" class="buttonBig" name="CountryWisePatient" onClick="submitForm('projectvitals','projectTracking?method=showCountryWisePatientJsp','validateRadio');" value="Country Wise Patient" height="34" width="188" />
	
	<input type="image" src="/hms/jsp/images/buttonIcons/monthlyIndent.jpg"class="buttonBig" onClick="submitForm('projectvitals','projectTracking?method=showProjectCalendarJsp','validateRadio');" value="Project Calendar" height="34" width="188" />
	
	<input type="image" src="/hms/jsp/images/buttonIcons/intakeOutput.jpg" class="buttonBig" name="PVisitSchedule" onClick="submitForm('projectvitals','projectTracking?method=showPatientVisitScheduleJsp','validateRadio');" value="Schedule Entry" height="34" width="188" />
	
	<input type="image" src="/hms/jsp/images/buttonIcons/wardConsumption.jpg" class="buttonBig" name="VendorContract" onClick="submitForm('projectvitals','projectTracking?method=showVendorContractJsp','validateRadio');" value="Vendor Contract" height="34" width="188" />
	
	<input type="image" src="/hms/jsp/images/buttonIcons/patientDiagnosis.jpg" class="buttonBig" onClick="submitForm('projectvitals','projectTracking?method=showRoleWiseResourceReuiredJsp','validateRadio');" height="34" value="Role Mapping" width="188" />
	
	<input type="image" src="/hms/jsp/images/buttonIcons/monthlyIndent.jpg"class="buttonBig" onClick="submitForm('projectvitals','projectTracking?method=showBudgetSettingJsp','validateRadio');" value="Budget Setting" height="34" width="188" />
	
	<input type="button"  src="/hms/jsp/images/buttonIcons/clinicalSetup.jpg" name="SitePaymentSchedule" onClick="submitForm('projectvitals','projectTracking?method=showSitePaymentScheduleJsp','validateRadio');" value="Site Payment Schedule"  class="buttonBig" height="34" width="188" />
	
	<input type="image" src="/hms/jsp/images/buttonIcons/patientDiagnosis.jpg" class="buttonBig" onClick="submitForm('projectvitals','projectTracking?method=showRoleResourceMappingJsp','validateRadio');" height="34" value="Role Resource Mapping" width="188" />
	
	<input type="image" src="/hms/jsp/images/buttonIcons/patientDiagnosis.jpg" class="buttonBig" onClick="submitForm('projectvitals','projectTracking?method=showFeasibilityStudyJsp','validateRadio');" height="34" value="Feasibility Study" width="188" />
	
	<input type="image" src="/hms/jsp/images/buttonIcons/patientDiagnosis.jpg" class="buttonBig" onClick="submitForm('projectvitals','projectTracking?method=showSqVisitUpdateJsp','validateRadio');" height="34" value="SQ Visit Update" width="188" />
