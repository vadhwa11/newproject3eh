...
<input type="text" name="<%=VOUCHER_DATE %>" id="voucherDate" value="<%=date %>" class="calDate" readonly="readonly" tabindex=1 validate="Voucher Date ,date,no" MAXLENGTH="30" />
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"	id="voucherDetails" class="cmntable">
	...
	<td> <input id="accountNameId<%=i%>" type="text" size="30"  name="accountName<%=i%>" value="" validate="Account,metachar,yes" tabindex=1 onblur="validateAccountName(this.value,<%=i %>,'slId')" />
		...
		<script type="text/javascript" language="javascript" charset="utf-8">
			  function eventCallback(element, entry){
					return entry + "&amtType=" + document.getElementById('hiddenDrCrId').value+ "&schemeId=" + document.getElementById('schemeId').value;
				}
	...
	<tr class="background">
		...
		<td colspan=2><input id="totalCrAmountId" size="10" type="text" class="readOnlySmall" readonly="readonly" name="<%=TOTAL_CR_AMOUNT %>" value="" validate="Total CrAmount,float,yes"  MAXLENGTH="15" tabindex=1 /></td>
	</tr>
	<tr class="background">
		<td colspan=6 class="right">Total Sales Voucher Control Fig.</td>
...
<input id="voucherNarrationId" type="text" name="<%=NARRATION %>" value="" class="extraLarge" MAXLENGTH="100" tabindex=1 />
...
<input type="button" name="add" id="addbutton" value="Add TO Template" class="buttonBig" onClick="addNarrationInAjax('salesVoucher');" accesskey="a" tabindex=1 />
<div class="clear"></div>
<div class="clear"></div>
...
<div class="clear"></div>
<div class="clear"></div>
<input type="button" name="add" id="addbutton" value="Submit" class="button" onClick="submitForm('salesVoucher','account?method=submitSalesVoucher','validateNarration','validateTotalDrCr');" accesskey="a" tabindex=1 />
