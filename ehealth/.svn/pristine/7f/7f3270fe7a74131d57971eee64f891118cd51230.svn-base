...
public interface ProjectTrackingMasterDataService {
	...
	Map<String, Object> searchSponserType(String trialPhaseCode, String trialPhaseName);
...
//------------------------- Patient Visit Master ----------------- 
	...
	boolean deletePatientVisit(int patientVisitId, Map<String, Object> generalMap);
...
//------------------------- Document  Master ----------------- 
	...
	//------------------------- Department Task Map  ----------------- 
		...
		Map<String, Object> searchProjectStatus(String projectStatusCode, String projectStatusName);
