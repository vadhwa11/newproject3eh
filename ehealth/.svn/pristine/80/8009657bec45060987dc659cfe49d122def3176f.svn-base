...
<div class="header">
<div class="floatLeft"><img src="/hms/jsp/images/clinirx/logo.jpg"
	alt="clinirx Logo" /></div>
<!---for header text--->
<div class="hdText">
<div class="hdTextFix">&nbsp; <%	
String userName ="";
...
<a href="http://www.clinirx.com" target="_blank">www.clinirx.com</a> <span
	class="paddLeft30"> <script type="text/javascript">
/*
...
//-->
	...
	class="paddingLeft30"><a href="/hms/hms/login?method=homePage">Home</a></span>
...
<!---header text ends---> <%		if (session != null && session.getAttribute("users") == null) { %>
<div class="paddLeft155"><img
	src="/hms/jsp/images/clinirx/omegaLogo.jpg" alt="Omega" /></div>
