...
public class OutboundMessage extends Message
{
	...
	SerialModemGateway smg1=new SerialModemGateway("modem.com1", "COM1", 57600, "Nokia", "6310i"); 
	...
	public OutboundMessage()
	{
		...
		setPriority(0);
		setRefNo("");
		setGatewayId(smg1.getGatewayId());
		setRetryCount(0);
	}
	...
	/**
	 * Returns the recipient of this outbound message.g
	 * 
