...
/**
 * This is an object that contains data related to the hr_encashment_details
 * table. Do not modify this class because it will be overwritten if the
 * configuration file related to this class is modified.
 * 
 * @hibernate.class table="hr_encashment_details"
 */
...
public abstract class BaseHrEncashmentDetails implements Serializable {
	 ...
	 */
	public void setEmpIdBal(
			jkt.hrms.masters.business.HrEmployeeBalanceNew empIdBal) {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof jkt.hrms.masters.business.HrEncashmentDetails)) {
			return false;
		} else {
			jkt.hrms.masters.business.HrEncashmentDetails hrEncashmentDetails = (jkt.hrms.masters.business.HrEncashmentDetails) obj;
			if (null == this.getId() || null == hrEncashmentDetails.getId()) {
				return false;
			} else {
				return (this.getId().equals(hrEncashmentDetails.getId()));
			}
		}
	}
