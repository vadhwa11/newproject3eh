 ...
 *
 */
public class SOE_1449233760370_194861 extends JREvaluator
{
    ...
    public Object evaluate(int id) throws Throwable
    {
        ...
        switch (id)
        {
            case 0 : 
            {
                value = (java.lang.String)("E:\\EHealth-Maven\\EHealth\\src\\main\\webapp\\Reports\\");//$JR_EXPR_ID=0$
                break;
            }
            case 1 : 
            {
            ...
            case 13 : 
            {
                value = (java.util.Date)(((java.util.Date)parameter_fromDate.getValue()));//$JR_EXPR_ID=13$
                break;
            }
            case 14 : 
            {
                value = (java.util.Date)(((java.util.Date)parameter_toDate.getValue()));//$JR_EXPR_ID=14$
                break;
            }
            case 15 : 
            {
                value = (java.util.Date)(((java.sql.Date)field_voucher_date.getValue()));//$JR_EXPR_ID=15$
                break;
            }
            case 16 : 
            {
                value = (java.lang.String)(((java.lang.String)field_cheque_no.getValue()));//$JR_EXPR_ID=16$
                break;
            }
            case 17 : 
            {
                value = (java.math.BigDecimal)(((java.math.BigDecimal)field_cr_amount0.getValue()));//$JR_EXPR_ID=17$
                break;
            }
            case 18 : 
            {
            ...
            case 19 : 
            {
                value = (java.lang.Object)(((java.lang.Integer)parameter_financialYearId.getValue()));//$JR_EXPR_ID=19$
                break;
            }
            case 20 : 
            {
            ...
            case 21 : 
            {
                value = (java.lang.Object)(((java.util.Date)parameter_toDate.getValue()));//$JR_EXPR_ID=21$
                break;
            }
            case 22 : 
            {
            ...
            case 23 : 
            {
                value = (java.lang.String)(((java.lang.String)parameter_SUBREPORT_DIR.getValue()) + "//fundsReceivedAndExpenseSubReport.jasper");//$JR_EXPR_ID=23$
                break;
            }
           default :
           {
    ...
    public Object evaluateOld(int id) throws Throwable
    {
        ...
        switch (id)
        {
            ...
            case 15 : 
            {
                value = (java.util.Date)(((java.sql.Date)field_voucher_date.getOldValue()));//$JR_EXPR_ID=15$
                break;
            }
            case 16 : 
            {
                value = (java.lang.String)(((java.lang.String)field_cheque_no.getOldValue()));//$JR_EXPR_ID=16$
                break;
            }
            case 17 : 
            {
                value = (java.math.BigDecimal)(((java.math.BigDecimal)field_cr_amount0.getOldValue()));//$JR_EXPR_ID=17$
                break;
            }
            case 18 : 
            {
