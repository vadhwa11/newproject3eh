...
<div class="titleBg">
<h2>Stock Register Report Date Wise</h2>
</div>
<div class="clear"></div>
<div class="Block">
...
<select id="itemGroupId" name="<%=GROUP_ID%>" validate="Group Name,String,no" >
...
<div class="clear"></div>
<input type="button" class="buttonBig" value="Generate Report"	onclick="submitForm('stockRegisterReport','/hms/hms/stores?method=stockRegisterReportDateWiseDetails');"></input>
<div class="clear"></div>
<div class="division"></div>
<div class="clear"></div>
