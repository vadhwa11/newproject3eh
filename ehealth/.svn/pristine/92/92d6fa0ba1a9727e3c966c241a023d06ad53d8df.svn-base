...
<div class="Block"><label><span>*</span> From Date</label> <input
	type="text" name="<%= FROM_DATE%>" id="fromDate" value="<%=date %>" class="date"
...
<%
	 if(flag.equals("billServicingRegister") || flag.equals("billDispensingRegister")){
