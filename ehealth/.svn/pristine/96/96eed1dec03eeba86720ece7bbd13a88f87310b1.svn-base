...
<div id="contentHolder1"><label
	style="font: bold 13px arial color :   #000; font-weight: bold; text-decoration: underline; float: right; text-align: center; font-size: 12px; width: 100%; margin-top: 10px;">SHRI VINOBA BHAVE CIVIL HOSPITAL</label>
<div class="Clear"></div>
<label
	style="font: bold 13px arial color :   #000; font-weight: bold; text-decoration: underline; float: right; text-align: center; font-size: 12px; width: 100%; margin-top: 0px;"> U.T. OF DADRA & NAGAR HAVELI, SILVASSA</label>
...
Reg No: </label> <label class="value" style="padding-left: 0px;">: <%=hinNo%></label>
