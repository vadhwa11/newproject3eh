	...
	public void showResult() {
		...
		if (validOperands) {
			if (source == addButton) {
				...
				switch (operator) {
				case 1:
					resultField.setText(Double
							.toString(operandOne + operandTwo));
					operandOne = 0.0;
					operandTwo = 0.0;
					break;
				case 2:
				...
				case 4:
					if (operandTwo != 0.0) {
						resultField.setText(Double.toString(operandOne
								/ operandTwo));
						operandOne = 0.0;
						operandTwo = 0.0;
					} else {
				...
				if (resultField.getText().equals("0")) {
					...
					resultField.setText(Double.toString(1.0 / Double
							.parseDouble(resultField.getText())));
				}
			} else if (source == one1) {
				if (resultField.getText().equals("0")) {
				...
				if (!(resultField.getText().equals("0") || resultField
						.getText().equals("0.0"))
