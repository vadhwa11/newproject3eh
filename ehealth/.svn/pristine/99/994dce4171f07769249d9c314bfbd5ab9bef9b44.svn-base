...
<div class="clear"></div>
<div class="Block">
<input id="oralFlag" name="oralMedicinePathologyFlag" tabindex="1" value="oralMedicinePathologyFlag" type="hidden"  />
<input type="hidden" name="templateName" value="Oral Medicine Pathology"/>

<label>Presenting Complaints  </label> 
<input id="presentingComplaints" type="text"  name="presentingComplaints" value="" class="textbox_size20" validate="Presenting Complaints,metachar,no" maxlength="120">

<label class="auto"> History of Presenting Complaint </label> 
<input type="text" name="historyOfPresentingComplaint" value="" class="textbox_size20" style="width:157px;" validate="History of  Presenting Complaints,metachar,no" maxlength="120">

<div class="clear"></div>
<label class="auto">Past Medical & Dental History</label> 
<input type="text" name="pastMedicalDentalHistory" value="" class="textbox_size20" style="width:170px;" validate="Past Medical & Dental History,metachar,no" maxlength="120">

<label>Family History </label> 
<input type="text" name="familyHistory" value="" class="textbox_size20" validate="Family History,metachar,no" maxlength="120">

<div class="clear"></div>
<label>Personal & Social History </label> 
<input type="text" name="personalSocialHistory" value="" class="textbox_size20" validate="Personal & Social History ,metachar,no" maxlength="120">

<div class="clear"></div>
<h4>Habits</h4>
<label>Dietary Habits</label> 
<input type="text" name="dietaryHabits" value="" class="textbox_size20"  validate="Dietary Habits,metachar,no" maxlength="120">

<label>Brushing Habits </label> 
<input type="text" name="brushingHabits" value="" class="textbox_size20" validate="Brushing Habits,metachar,no" maxlength="120">
<div class="clear"></div>
...
<td><input type="text" name="SmokingDailyStartAge" value="" class="textbox_size20"  onkeypress="javascript:return isNumber(event)" maxlength="5" validate="Smoking Daily Start Age,int,no"></td>
<td><input type="text" name="SmokelessDailyStartAge" value="" class="textbox_size20"  onkeypress="javascript:return isNumber(event)" maxlength="5" validate="Smokeless Daily Start Age,int,no"></td>
<td><input type="text" name="AlcoholDailyStartAge" value="" class="textbox_size20"  onkeypress="javascript:return isNumber(event)" maxlength="5" validate="Alcohol Daily Start Age,int,no"></td>
</tr>
<tr>
<td>5. How many years ago did you first start using daily?</td>
<td><input type="text" name="SmokingDailyStartYear" value="" class="textbox_size20" onkeypress="javascript:return isNumber(event)" maxlength="5" validate="Smoking Daily Start Year,int,no"></td>
<td><input type="text" name="SmokelessDailyStartYear" value="" class="textbox_size20" onkeypress="javascript:return isNumber(event)" maxlength="5"validate="Smokeless Daily Start Year,int,no"></td>
<td><input type="text" name="AlcoholDailyStartYear" value="" class="textbox_size20"  onkeypress="javascript:return isNumber(event)" maxlength="5" validate="Alcohol Daily Start Year,int,no"></td>
</tr>
<tr>
...
<td><input type="text" name="SmokingDailyProduct" value="" class="textbox_size20"  onkeypress="javascript:return isNumber(event)" maxlength="5" validate="Smoking Daily Product,int,no"></td>
<td><input type="text" name="SmokelessDailyProduct" value="" class="textbox_size20"  onkeypress="javascript:return isNumber(event)" maxlength="5" validate="Smokeless Daily Product,int,no"></td>
<td><input type="text" name="AlcoholDailyProduct" value="" class="textbox_size20"  onkeypress="javascript:return isNumber(event)" maxlength="5" validate="Alcohol Daily Product,int,no"></td>
</tr>
<tr>
<td>7. How soon after you wake up do you have your first smoke / chewing-tobacco/drink?</td>
<td><input type="text" name="SmokingAfterWakeup" value="" class="textbox_size20"  onkeypress="javascript:return isNumber(event)" maxlength="5" validate="Smoking After Wakeup,int,no"></td>
<td><input type="text" name="SmokelessAfterWakeup" value="" class="textbox_size20"  onkeypress="javascript:return isNumber(event)" maxlength="5" validate="Smokeless After Wakeup,int,no"></td>
<td><input type="text" name="AlcoholAfterWakeup" value="" class="textbox_size20"  onkeypress="javascript:return isNumber(event)" maxlength="5" validate="Alcohol After Wakeup,int,no"></td>
</tr>
...
<td><input type="text" name="SmokingLessDailyStartAge" value="" class="textbox_size20"  onkeypress="javascript:return isNumber(event)" maxlength="5" validate="Smoking Less Daily Start Age,int,no"></td>
<td><input type="text" name="SmokelessLessDailyStartAge" value="" class="textbox_size20"  onkeypress="javascript:return isNumber(event)" maxlength="5" validate="Smokeless Less Daily Start Age,int,no"></td>
<td><input type="text" name="AlcoholLessDailyStartAge" value="" class="textbox_size20"  onkeypress="javascript:return isNumber(event)" maxlength="5" validate="Alcohol Less Daily Start Age,int,no"></td>
</tr>
<tr>
<td>9. How many years ago did you first start using daily?</td>
<td><input type="text" name="SmokingLessDailyStartYear" value="" class="textbox_size20" onkeypress="javascript:return isNumber(event)" maxlength="5" validate="Smoking Less Daily Start Year,int,no"></td>
<td><input type="text" name="SmokelessLessDailyStartYear" value="" class="textbox_size20"  onkeypress="javascript:return isNumber(event)" maxlength="5" validate="Smokeless Less Daily Start Year,int,no"></td>
<td><input type="text" name="AlcoholLessDailyStartYear" value="" class="textbox_size20"  onkeypress="javascript:return isNumber(event)" maxlength="5" validate="Alcohol Less Daily Start Year,int,no"></td>
</tr>
<tr>
<td>10. On an average how many of the following products do you use in a usual week?</td>
<td><input type="text" name="SmokingLessDailyProduct" value="" class="textbox_size20" onkeypress="javascript:return isNumber(event)" maxlength="5" validate="Smoking Less Daily Product,int,no"></td>
<td><input type="text" name="SmokelessLessDailyProduct" value="" class="textbox_size20"  onkeypress="javascript:return isNumber(event)" maxlength="5" validate="Smokeless Less Daily Product,int,no"></td>
<td><input type="text" name="AlcoholLessDailyProduct" value="" class="textbox_size20"  onkeypress="javascript:return isNumber(event)" maxlength="5" validate="Alcohol Less Daily Product,int,no"></td>
</tr>
<tr>
...
<td><input type="text" name="SmokingDailyStartAgeFormer" value="" class="textbox_size20"  onkeypress="javascript:return isNumber(event)" maxlength="5" validate="Smoking Daily Start Age Former,int,no"></td>
<td><input type="text" name="SmokelessDailyStartAgeFormer" value="" class="textbox_size20"  onkeypress="javascript:return isNumber(event)" maxlength="5" validate="Smokeless Daily Start Age Former,int,no"></td>
<td><input type="text" name="AlcoholDailyStartAgeFormer" value="" class="textbox_size20"  onkeypress="javascript:return isNumber(event)" maxlength="5" validate="Alcohol Daily Start Age Former,int,no"></td>
</tr>
<tr>
<td>12. How many years ago did you first start using daily?</td>
<td><input type="text" name="SmokingDailyStartYearFormer" value="" class="textbox_size20"  onkeypress="javascript:return isNumber(event)" maxlength="5" validate="Smoking Daily Start Year Former,int,no"></td>
<td><input type="text" name="SmokelessDailyStartYearFormer" value="" class="textbox_size20" onkeypress="javascript:return isNumber(event)" maxlength="5" validate="Smokeless Daily Start Year Former,int,no"></td>
<td><input type="text" name="AlcoholDailyStartYearFormer" value="" class="textbox_size20"  onkeypress="javascript:return isNumber(event)" maxlength="5" validate="Alcohol Daily Start Year Former,int,no"></td>
</tr>
<tr>
<td>13. How long has it been since you stopped using?</td>
<td><input type="text" name="SmokingStopYearFormer" value="" class="textbox_size20"  onkeypress="javascript:return isNumber(event)" maxlength="5" validate="Smoking Stop Year Former,int,no"></td>
<td><input type="text" name="SmokelessStopYearFormer" value="" class="textbox_size20" onkeypress="javascript:return isNumber(event)" maxlength="5" validate="Smokeless Stop Year Former,int,no"></td>
<td><input type="text" name="AlcoholStopYearFormer" value="" class="textbox_size20"  onkeypress="javascript:return isNumber(event)" maxlength="5" validate="Alcohol Stop Year Former,int,no"></td>
</tr>
<tr>
...
<td><input type="text" name="SmokingNoVisitedDoctorFromer" value="" class="textbox_size20"  onkeypress="javascript:return isNumber(event)" maxlength="5" validate="Smoking No Visited Doctor Fromer,int,no"></td>
<td><input type="text" name="SmokelessNoVisitedDoctorFromer" value="" class="textbox_size20" onkeypress="javascript:return isNumber(event)" maxlength="5" validate="Smokeless No Visited Doctor Fromer,int,no"></td>
<td><input type="text" name="AlcoholNoVisitedDoctorFromer" value="" class="textbox_size20"  onkeypress="javascript:return isNumber(event)" maxlength="5" validate="Alcohol No Visited Doctor Fromer,int,no"></td>
</tr>
<tr>
...
<td>
<div class="yesNo">Yes <input type="radio"	name="visittt" value="Yes" /></div>
<div class="yesNo">No <input type="radio"	name="visittt" value="No" /></div>
</td>
</tr>
<tr>
...
<tr>
<th colspan="4" align="left">D.Cessation</th>
</tr>
<tr>
...
<td><input type="text" name="SmokingQuitPeriod" value="" class="textbox_size20"  onkeypress="javascript:return isNumber(event)" maxlength="5" validate="Smoking Quit Period,int,no"></td>
<td><input type="text" name="SmokelessQuitPeriod" value="" class="textbox_size20"  onkeypress="javascript:return isNumber(event)" maxlength="5" validate="Smokeless Quit Period,int,no"></td>
<td><input type="text" name="AlcoholQuitPeriod" value="" class="textbox_size20" onkeypress="javascript:return isNumber(event)" maxlength="5" validate="Alcohol Quit Period,int,no"></td>
</tr>
<tr>
...
<td><input type="text" name="SmokingTryQuitting" value="" class="textbox_size20"   maxlength="10" validate="Smoking Try Quitting,int,no"></td>
<td><input type="text" name="SmokelessTryQuitting" value="" class="textbox_size20"  maxlength="10" validate="Smokeless Try Quitting,int,no"></td>
<td><input type="text" name="AlcoholTryQuitting" value="" class="textbox_size20"  maxlength="10" validate="Alcohol Try Quitting,int,no"></td>
</tr>
</table>
</div>
...
<input type="text" name="Developmental" value="" class="textbox_size20" validate="Developmental,metachar,no" maxlength="120">


<label>Nutritional</label> 
<input type="text" name="Nutritional" value="" class="textbox_size20" validate="Nutritional,metachar,no" maxlength="120"> 

<div class="clear"></div>
<label>Head</label> 
<input type="text" name="Head" value="" class="textbox_size20" validate="Head,metachar,no" maxlength="120">


<label>Skull </label> 
<input type="text" name="Skull" value="" class="textbox_size20" validate="Skull,metachar,no" maxlength="120">

<div class="clear"></div>
<label>Eyes</label> 
<input type="text" name="Eyes" value="" class="textbox_size20" validate="Eyes,metachar,no" maxlength="120">


<label>Ears </label> 
<input type="text" name="Ears" value="" class="textbox_size20" validate="Ears,metachar,no" maxlength="120">

<div class="clear"></div>
<label>Nose</label> 
<input type="text" name="Nose" value="" class="textbox_size20" validate="Nose,metachar,no" maxlength="120">


<label>Skin </label> 
<input type="text" name="Skin" value="" class="textbox_size20" validate="Skin,metachar,no" maxlength="120">

<div class="clear"></div>
<label>Hair</label> 
<input type="text" name="Hair" value="" class="textbox_size20" validate="Hair,metachar,no" maxlength="120">


<label>Nails </label> 
<input type="text" name="Nails" value="" class="textbox_size20" validate="Nails,metachar,no" maxlength="120">

<div class="clear"></div>
<label>Lymph nodes</label> 
<input type="text" name="LymphNodes" value="" class="textbox_size20" validate="Lymph nodes,metachar,no" maxlength="120">
<div class="clear"></div>

<h4>Systemic Examination</h4>


<label>Alimentary system</label> 
<input type="text" name="alimentarySystem" value="" class="textbox_size20" validate="Alimentary system,metachar,no" maxlength="120">


<label>Respiratory system</label> 
<input type="text" name="respiratorySystem" value="" class="textbox_size20" validate="Respiratory system,metachar,no" maxlength="120">

<div class="clear"></div>
<label>Cardiovascular system</label> 
<input type="text" name="cardiovascularSystem" value="" class="textbox_size20" validate="Cardiovascular system,metachar,no" maxlength="120">


<label>Central Nervous System </label> 
<input type="text" name="centralNervousSystem" value="" class="textbox_size20" validate="Central Nervous System ,metachar,no" maxlength="120">

<div class="clear"></div>
<label>Musculoskeletal System</label> 
<input type="text" name="musculoskeletalSystem" value="" class="textbox_size20" validate="Musculoskeletal System,metachar,no" maxlength="120">


<label>Genitourinary System </label> 
<input type="text" name="genitourinarySystem" value="" class="textbox_size20" validate="Genitourinary System,metachar,no" maxlength="120">
...
<label>Head</label> 
<input type="text" name="OralHead" value="" class="textbox_size20" validate="Head,metachar,no" maxlength="120">


<label>Facial form</label> 
<input type="text" name="OralFacialForm" value="" class="textbox_size20" validate="Facial form,metachar,no" maxlength="120">

<div class="clear"></div>
<label>Hair</label> 
<input type="text" name="OralHair" value="" class="textbox_size20" validate="Hair,metachar,no" maxlength="120">


<label>Skin </label> 
<input type="text" name="OralSkin" value="" class="textbox_size20" validate="Skin,metachar,no" maxlength="120">

<div class="clear"></div>
<label>Eyes</label> 
<input type="text" name="OralEyes" value="" class="textbox_size20" validate="Eyes,metachar,no" maxlength="120">


<label>Ears </label> 
<input type="text" name="OralEar" value="" class="textbox_size20" validate="Ears,metachar,no" maxlength="120">

<div class="clear"></div>
<label>Nose</label> 
<input type="text" name="OralNose" value="" class="textbox_size20" validate="Nose,metachar,no" maxlength="120">


<label>Throat </label> 
<input type="text" name="OralThroat" value="" class="textbox_size20" validate="Throat,metachar,no" maxlength="120">
...
<input type="radio"	name="salivaryGlands" id="salivaryGlands" value="NonPalpable" class="checkboxMargin" onclick="dataSalivaryGlands(this.value);" />
<div id="salivaryGlandsDiv" style="display: none;">
<label style="width:133px;">Palpable</label>
<input type="text" name="PalpableTxt" value="" class="textbox_size20"  maxlength="120">

</div>
<div class="clear"></div>
<label class="auto">Cranial Nerves Examination </label> 
<input type="text" name="OralCranialNervesExamination" value="" class="textbox_size20" validate="Cranial Nerves Examination,metachar,no" maxlength="120">

<label>Neck</label> 
<input type="text" name="OralNeck" value="" class="textbox_size20" validate="Neck,metachar,no" maxlength="120">
<div class="clear"></div>
<label>TMJ</label> 
<input type="text" name="OralTmj" value="" class="textbox_size20" validate="TMJ,metachar,no" maxlength="120">
...
<label>Mouth Opening</label>
<input type="text" name="MouthOpening" value="" class="textbox_size20" validate="Mouth Opening,metachar,no" maxlength="120">
<div class="clear"></div>
...
<label class="wdth60">No</label>  
<input type="radio"	name="OralHygieneStatus" value="No" style="margin-right:30px;" />
<label>Dentition Status</label>
<input type="text" name="DentitionStatus" value="" class="textbox_size20" validate="Dentition Status,metachar,no" maxlength="120">
 		...
 		<option value="Lateral">Lateral borders of tongue</option>
 			<option value="Ventral">Ventral surface of tongue</option>
 				...
 				<option value="SoftPalate">Soft Palate</option>
 					<option value="FloorOfMouth">Floor </option>
...
<input type="text" name="Inspection" value="" class="textbox_size20" validate="Inspection,metachar,no" maxlength="120">


<h4>Palpation</h4>
<label>Dorsum</label>
<input type="text" name="Dorsum" value="" class="textbox_size20" validate="Dorsum,metachar,no" maxlength="120">



<label>Ventral Surface</label>
<input type="text" name="Ventral" value="" class="textbox_size20" validate="Ventral Surface,metachar,no" maxlength="120">
<div class="clear"></div>

<label>Lateral Border</label>

 <input type="text"	name="lactation" value="" id="lactation" class="textbox_size20" validate="Lateral Border,metachar,no" maxlength="120">


<label>Local Examination Findings</label>
<input type="text" name="Local" value="" class="textbox_size20" validate="Local Examination Findings,metachar,no" maxlength="120">

<div class="clear"></div>
<label>Case Summary</label>
<input type="text" name="Case" value="" class="textbox_size20" validate="Case Summary,metachar,no" maxlength="120">
