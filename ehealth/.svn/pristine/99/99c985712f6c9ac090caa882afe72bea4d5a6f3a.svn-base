...
<h2 align="left" class="style1">MIS Daily Report</h2>
...
<label class="bodytextB"><font id="error">*</font> To Date:</label> <input
	...
	onClick="setdate('',document.misDailyReport.<%=TO_DATE%>,event)" /> <br />
<div id="contentHolder" style="padding-left: 15px;"><input
	type="button" name="OK" value="OK" class="cmnButton"
