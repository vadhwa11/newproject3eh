...
<script type="text/javascript" language="javascript">
	...
	formFields = [
			[0, "CylinderHeaderId", "id"],[1, "<%=RADIO_FOR_TABLE%>"], [2,"Entry No"], [3,"Entry Date"], [4,"Challan No"], [5,"Challan Date"] , [6,"Employee Name"],[7,"<%=STATUS%>"] ];
	 statusTd =7;
...
<script type="text/javascript" language="javascript">
		...
		data_header[3][0] = "Challan No"
		data_header[3][1] = "data";
		data_header[3][2] = "15%";
		data_header[3][3] = "Challan No";
		
		data_header[4] = new Array;
		data_header[4][0] = "Challan Date"
		data_header[4][1] = "data";
		data_header[4][2] = "15%";
		data_header[4][3] = "Challan Date";
		
		data_header[5] = new Array;
		data_header[5][0] = "Employee Name"
		data_header[5][1] = "data";
		data_header[5][2] = "15%";
		data_header[5][3] = "Employee Name";
...
<%		
			if(searchList != null)
			{
	        	...
	        	{    
	        		...
	        		String EmpName = (String)(object[5]+" " +object[6]);
%>
					...
					data_arr[<%= counter%>][6] = "<%= EmpName%>"
<% 
					if(object[7].equals("y"))
					{
%>
