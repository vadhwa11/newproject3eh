...
<form name="instituteWisePendingList" method="post">
<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
<div class="titleBg">
<h2>Institute Wise Pending List</h2>
</div>
...
<table border="0" cellpadding="0" cellspacing="0">
					...
					%>
					<tr onclick="submitForm('instituteWisePendingList','stores?method=showInstitutionAnnualIndentCreationJsp&storeInternalMId=<%=storeInternalIndentM.getId() %>');">
...
<input type="button" name="Next/Update" type="submit" value="display"	onClick="submitForm('instituteWisePendingList','stores?method=showInstitutionAnnualIndentCreationJsp');" class="button" />
