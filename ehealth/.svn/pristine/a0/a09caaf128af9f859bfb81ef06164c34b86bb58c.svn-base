...
<label>CHC</label>
<select name="chcphc" id="chcphc" onblur="submitProtoAjaxWithDivName('birth','/hms/hms/pubHealth?method=getBasicCenterList&chcphc='+this.value,'testDiv');" >
<%	if(chcList.size() >0){%>
...
<label>Basic-Section / Sub-center </label>
    <select name="bcsc" id="bcsc" class=""  validate="">
             	<option value="0">Select</option>
	</select>
