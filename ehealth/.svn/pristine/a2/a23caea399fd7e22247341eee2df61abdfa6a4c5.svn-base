...
public interface HesDataService 
{
	...
	Map<String, Object> searchEquipmentEntry(Map<String, Object> searchFieldMap);
	...
	Map<String, Object> searchEquipmentBreakdownEntry(Map<String, Object> searchFieldMap);
