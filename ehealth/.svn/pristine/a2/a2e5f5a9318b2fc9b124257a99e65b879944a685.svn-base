...
public interface LabHandlerService {
	...
	Map<String, Object> getSampleValidationDetailsForEmpanelled(Map<String, Object> mapForDs);
	...
	Map<String, Object> getOrderDetails(Map<String, Object> infoMap);
	...
	Map<String, Object> getPatientDetailsGrossingInHisto(
			Map<String, Object> mapForDs);
	...
	Set<DgMasTestKit> getAllTestsKitLab(Map<String, Object> detailsMap);
	...
	Map<String, Object> getHinNo(Map<String, Object> map);
