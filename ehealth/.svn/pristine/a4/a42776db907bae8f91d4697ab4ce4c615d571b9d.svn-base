...
<input id="serialNoId" type=hidden name="<%=SERIAL_NO%>"
	...
	<label class="value"> <%=serialSeqNo %> </label>  --%>
	 ...
	 <input	type="text"  name="BagNumber" value="<%=BagNum %>" tabindex=1 maxlength="20" readonly="readonly"
	...
	maxlength="20" readonly="readonly" tabindex=1 /><label class="labelSmall">ml</label>
	<div class="clear"></div>
...
<table width="100%" colspan="7" id="chargeDetails" cellpadding="0"
	...
	<tbody>
		...
		for(BloodSampleScreeningDetail bsd:screenDetailList){
		%>
		<tr>
			...
			<!-- <input type="text" id="result" value=""
				...
				<input type="radio" checked="checked" name="reactive<%=bsd.getInvestigation().getId()  %>" value="n">
			</td>
...
<!--   <div id="divs2" class="desc" style="display: none;">
   
<label>Rh Typing</label> 
   
	<select id="pType" name="sgRh"
	validate="Type,string,no">
	<option value="">Select</option>
	<option value="+">+ve</option>
	<option value="-">-ve</option>
...
<input type="button" class="button" value="Submit"
	onclick="submitForm('testEntry','bloodBank?method=submitBloodTestEntry');"
	align="right" /> 
