...
<label><%=prop.getProperty("com.jkt.hms.registration_no") %></label>
 <input type="text" id="hinNo" name="<%=HIN_NO %>" value="" onblur="if(this.value != ''){submitForm('billingDepositsSearch','ipd?method=searchPatientFOrAdvance');}" MAXLENGTH="50" />
 
 <label>Name</label>
 <input type="text" id="patientName" name="patientName" value="" onblur="if(this.value != ''){submitForm('billingDepositsSearch','ipd?method=searchPatientFOrAdvance');}" MAXLENGTH="15" />
  <label>Mobile No.</label>
   <input type="text" id="mobileNo" name="mobileNo" value="" onblur="if(this.value != ''){submitForm('billingDepositsSearch','ipd?method=searchPatientFOrAdvance');}" MAXLENGTH="15" />
<%-- <label>Patient First Name</label>
 <input type="text" id="pFName" name="<%=P_FIRST_NAME %>" value="" onblur="if(this.value != ''){submitForm('billingDepositsSearch','ipd?method=searchPatientFOrAdvance');}" MAXLENGTH="15" />
  <label>Patient Mid Name</label>
   <input type="text" id="pMName" name="<%=P_MIDDLE_NAME %>" value="" onblur="if(this.value != ''){submitForm('billingDepositsSearch','ipd?method=searchPatientFOrAdvance');}" MAXLENGTH="15" />

<div class="clear"></div>

<label>Patient Last Name</label> <input type="text" id="pLName" name="<%=P_LAST_NAME%>" value="" MAXLENGTH="15" /> --%>
<div class="clear"></div>
</div>
</div>
<input type="button" name="search"  onclick="submitForm('billingDepositsSearch','billing?method=searchPatient','checkBlankSearch');" value="Search" class="button" accesskey="a" />
<div class="clear"></div>
</div>
