...
<!-- 		<input type="button" name="Report" value="Generate Report" class="buttonBig" onClick="submitForm('messageBilling','generalMaster?method=generateReportsForBilling');" accesskey="g" tabindex=1 />
 -->	    		
 <input type="button" name="Report" value="Generate Report" class="buttonBig" onClick="submitForm('messageBilling','billing?method=printfinalBillSettlementSummary');" accesskey="g" tabindex=1 />
	    
	    <!-- <input type="button" name="Report" value="Excel Report" class="buttonBig" 
	    onClick="submitForm('messageBilling','generalMaster?method=generateReportsForBillingExcel');" accesskey="e" tabindex=1 /> -->
