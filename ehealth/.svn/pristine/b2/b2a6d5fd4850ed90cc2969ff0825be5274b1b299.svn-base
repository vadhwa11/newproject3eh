...
/**
 * This is an object that contains data related to the ot_procedure_notes_entry_detail table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="ot_procedure_notes_entry_detail"
 */
...
public abstract class BaseOtProcedureNotesEntryDetail  implements Serializable {
	 ...
	 * @param otProcedureHeader the ot_procedure_header_id value
	 */
	public void setOtProcedureHeader (jkt.hms.masters.business.OtProcedureNotesEntryHeader otProcedureHeader) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hms.masters.business.OtProcedureNotesEntryDetail)) return false;
		else {
			...
			if (null == this.getId() || null == otProcedureNotesEntryDetail.getId()) return false;
			else return (this.getId().equals(otProcedureNotesEntryDetail.getId()));
		}
	}
