...
public interface OpBillingDataService {

/*	Map<String, Object> getPatientDetailsForOpBilling(Box box);*/
...
/*	Map<String, Object> showOPBillServecing(Map<String, Object> map);*/
	...
	String generatePaymentAdviceNo(String flag,int hospitalId);
	...
	Map<String, Object> getPatientDetailsForOpBilling(
			Map<String, Object> parameterMap);

	Map<String, Object> getReferedPatient(Box box);

	Map<String, Object> getInpatientBilDispensingDetail(Box box);
