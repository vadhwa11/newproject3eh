...
<input type="button" name="OK" id="addbutton" value="Print For National Health Mission" class="inputButtonAutu" onClick="submitForm('cashRegister','account?method=printStatementOfExpenditureReport');" accesskey="a" tabindex=1 />
<input type="button" name="OK" id="addbutton" value="Print For NRHM" class="buttonBig" onClick="submitForm('cashRegister','account?method=printStatementOfExpenditureReportForNRHM');" accesskey="a" tabindex=1 />
