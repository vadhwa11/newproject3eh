...
<form name="responce" method="post">

<h4><font id="error"><%=message%></font></h4>
<input type="button" class="button" name="Reset" value="Back" onclick="submitForm('responce','/hms/hms/pubHealth?method=showDateWiseDayBlockCompletion');">
