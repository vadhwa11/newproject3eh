...
<div class="logo" title="e-Health Kerala- Empanelled Stores Login"></div>
...
<div class="clear"></div>
<div id="main">
<form name="loginForm" method="post" action="/hms/hms/login?method=validateEmpanelledLogin" autocomplete="off">
...
<input id="loginName" type="text"
	name="<%=LOGIN_NAME%>" value="" validate='User Name,metachar,yes' maxlength="12" autocomplete="off"/> <script>
...
<label class="login">Password <span>*</span></label>
 ...
 <input type="password" id="password"
	name="<%=PASSWORD%>" value="" validate='Password,metachar,yes'	 maxlength="12" autocomplete="off" />
<div class="clear"></div>


<div class="clear"></div>
  
<input name="Login2" type="button" value="Sign In" 	alt="Sign In" title="Sign In" class="button" onclick="submitForm('loginForm','/hms/hms/login?method=validateEmpanelledLogin');" />
...
</a> <br /> <span>Disclaimer:This site is best viewed with a resolution of 1170 x 768 (or higher) and supports Microsoft IE9, Chrome 23, Firefox 16.<span class="ver">[ ver: 32.04.16 ]</span></span>
</div>
</body>
</html>
