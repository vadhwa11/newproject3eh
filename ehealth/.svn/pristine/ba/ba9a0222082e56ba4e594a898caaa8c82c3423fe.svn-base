...
<form name="stateWiseIndentApprovalPendingList" method="post">
<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
<div class="titleBg">
<h2>Annual State Wise Indent Approval Pending List</h2>
</div>
...
<table border="0" cellpadding="0" cellspacing="0">
					...
					%>
					<tr onclick="submitForm('stateWiseIndentApprovalPendingList','stores?method=showStateAnnualIndentApprovalJsp&storeInternalMId=<%=storeInternalIndentM.getId() %>');">
