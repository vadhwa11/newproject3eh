...
%>
<form name="annualDepartmentIndentApproval" method="post">
<div class="titleBg">
<h2>Department Annual Indent Approval</h2>
</div>
...
<table border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						<th><input type="checkbox" name="srno1" id="srNoId1" onchange="toggle1()"></input></th>
						<th>Item Code</th>
						<th>Item Name</th>
						<th>Unit</th>
					...
					<tr>
						...
						<td><input type="text" value="<%=storeInternalIndentT.getItem().getNomenclature()!= null?storeInternalIndentT.getItem().getNomenclature():"" %>" readonly="readonly" tabindex="1" name="nomenclature" size="30" id="<%=nomenclature+i %>" onblur="getOtherItemsForDepartmentIndent(<%=i %>);"  />
						...
						<%-- <td><input type="text" size="8" value="<%=storeInternalIndentT.getStockInHand()!= null?storeInternalIndentT.getStockInHand():"" %>" name="stock" validate="Stock In Hand,num,no" id="<%=stock+i %>"  readonly="readonly" /></td>--%>
						<td><input type="text" size="8" value="<%=storeInternalIndentT.getIncrementalPercentage()!= null?storeInternalIndentT.getIncrementalPercentage().intValue():"" %>" name="incrementalPercentage" id="incrementalPercentageId<%=i %>" onblur="calculateIndentQty(<%=i %>);"  readonly="readonly" /></td>
						<td><input type="text" size="8" value="<%=storeInternalIndentT.getIncrementalQuantity()!= null?storeInternalIndentT.getIncrementalQuantity().intValue():"" %>" name="incrementalQty" id="incrementalQtyId<%=i %>" onblur="calculateIndentQty(<%=i %>);" readonly="readonly" /></td>
						...
						<td><input type="text" size="8" value="<%=storeInternalIndentT.getQtyRequest()!= null?storeInternalIndentT.getQtyRequest():"" %>" name="qtyRequest" id="<%=qtyRequest+i %>" validate="Demanded Qty,num,no" readonly="readonly" /></td>
						<td><input type="text" size="8" value="<%=storeInternalIndentT.getRemarks()!= null?storeInternalIndentT.getRemarks():"" %>" name="remarks" id="remarks<%=i %>" validate="Remarks,string,no" readonly="readonly" />
...
<label>Remarks</label>
<textarea name="approvalRemarks"   validate="Remarks,string,no" cols="0" rows="0" class="large" maxlength="198" tabindex="1" ></textarea>
...
<div class="clear"></div>
<input type="button" name="Next/Update" type="submit" value="Approve"	onClick="submitForm('annualDepartmentIndentApproval','stores?method=submitAnnualDepartmentApproval','validateRows');" class="button">
<input type="button" name="Next/Update" type="submit" value="Reject"	onClick="submitForm('annualDepartmentIndentApproval','stores?method=submitAnnualDepartmentApproval');" class="button">
