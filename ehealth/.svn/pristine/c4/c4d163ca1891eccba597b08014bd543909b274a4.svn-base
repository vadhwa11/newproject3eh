...
<input type="button" name="add" id="addbutton" value="Back" class="button" onClick="submitForm('patientAD','pubHealth?method=showStudentRegistrationJsp');" accesskey="a" tabindex=1 />
