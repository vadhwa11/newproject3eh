...
<label></label> 
<input	type="text" value="<%=reportNo%>" name="<%=REPORT_NO %>"	class="readonly" readonly="readonly" /> 
...
<label>Diagnosis </label> <label></label> <%if(visit.getDiagnosis()!= null){ %>
<label class="value"><%=visit.getDiagnosis().getDiagnosisConclusionName() %></label>
<%}else{ %> <label class="value">-</label> <%} %>
<div class="clear"></div>
<label>AnalCanal</label>
<label></label> 
<input type="text" value=""	class="large" name="<%=ANAL_CANCAL %>" id="b2" />
<div class="clear"></div>
<label>Rectum</label>
<label></label> 
<input type="text" value=""	class="large" name="<%=RECTUM %>" id="b3" />
<div class="clear"></div>
<label>Sigmoid</label>
<label></label> 
<input type="text" value=""	class="large" name="<%=SIGMOID %>" id="b4" />
<div class="clear"></div>
<label>Descending Colon</label>
<label></label> 
<input type="text"	value="" class="large" name="<%=DESCENDING_COLON %>" id="b5" />
<div class="clear"></div>
<label>Transverse Colon</label>
<label></label> 
<input type="text"	value="" class="large" name="<%=TRANSVERSE_COLON %>" id="b6" />
<div class="clear"></div>
<label>Cecum</label>
<label></label> 
<input type="text" value=""	class="large" name="<%=CECUM %>" id="b7" />
<div class="clear"></div>
<label>Biopsy</label>
<label></label> 
<input type="text" value=""	class="large" name="<%=BIOPSY %>" id="b8" />
<div class="clear"></div>
...
<div class="clear"></div>
<div class="division"></div>
<input type="button" class="button" value="Submit"	onclick="submitForm('gastroEnterologyColonoscopy','opd?method=addGastroEnterologyColonoscopy','blankSpace');"	align="right" /> 
<input type="button" class="button" value="View"	onclick="showJSP('gastroEnterologyColonoscopy');" /> 
