...
/**
 * This is an object that contains data related to the ot_surgey_pa_anesthesiologist_detail table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="ot_surgey_pa_anesthesiologist_detail"
 */

public abstract class BaseOtSurgeyPaAnesthesiologistDetail  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hms.masters.business.OtSurgeyPaAnesthesiologistDetail)) return false;
		else {
			...
			if (null == this.getId() || null == otSurgeyPaAnesthesiologistDetail.getId()) return false;
			else return (this.getId().equals(otSurgeyPaAnesthesiologistDetail.getId()));
		}
	}
