...
//---Added By dipali
	...
	Map<String, Object> submitIntrOperatioveForOt(OtIntraOperativeTimeOut sSS,
			int hinId,Map<String,Object> dataMap);

	Map<String, Object> getOtTime(Map<String, Object> map);

	Map<String, Object> getInvestigationListForAutoComplete(
	...
	Map<String, Object> showCalenderForOt(Map dataMap);
