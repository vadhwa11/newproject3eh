...
<div class="titleBg"><h2>Fixed Prosthodontics</h2></div>

<form name="patientUpdate" method="post">
<div class="Block">
<input id="fixedProsthodonticsFlag" name="fixedProsthodonticsFlag" tabindex="1" value="fixedProsthodonticsFlag" type="hidden"  />
<input type="hidden" name="templateName" value="Fixed Prosthodontics"/>
...
<input tabindex="1" name="historyOfAllergy" id="historyOfAllergy" value="Yes" type="radio" class="radiobutMargin" onclick="displayTextValueFPhistoryOfAllergy(this.value);">
<label class="auto">No</label>
<input tabindex="1" name="historyOfAllergy" id="historyOfAllergy" value="No" type="radio" style="margin-right:21px;" onclick="displayTextValueFPhistoryOfAllergy(this.value);">
...
<div class="clear"></div>
<div class="paddingTop5"></div>
<input type="hidden" name="flagTeeth" id="flagTeeth" maxlength="40" tabindex="1" value="Impactions">
...
<input tabindex="1" name="typeOfGuidance" id="typeOfGuidance" value="Canine guided" type="radio" class="radiobutMargin">
<label class="auto">Group function</label>
<input tabindex="1" name="typeOfGuidance" id="typeOfGuidance" value="Group function" type="radio" style="margin-right:21px;">
<div class="clear"></div>
...
<input tabindex="1" name="deviation" id="deviation" value="Present" type="radio" class="radiobutMargin" onclick="displayTextValueFPdeviation(this.value);">
<label class="auto">Absent</label>
<input tabindex="1" name="deviation" id="deviation" value="Absent" type="radio" class="radiobutMargin" onclick="displayTextValueFPdeviation(this.value);">
...
<label>Pain</label>
<label class="auto">Present</label>
<input tabindex="1" name="pain" id="pain" value="Present" type="radio" class="radiobutMargin" onclick="displayTextValueFPpain(this.value);">
<label class="auto">Absent</label>
<input tabindex="1" name="pain" id="pain" value="Absent" type="radio" class="radiobutMargin" onclick="displayTextValueFPpain(this.value);">
...
<label class="auto">Present</label>
<input tabindex="1" name="clicking" id="clicking" value="Present" type="radio" class="radiobutMargin" onclick="displayTextValueFPclicking(this.value);">
<label class="auto">Absent</label>
<input tabindex="1" name="clicking" id="clicking" value="Absent" type="radio" class="radiobutMargin" onclick="displayTextValueFPclicking(this.value);">
...
<label class="lable185">Residual Roots</label>
<label class="wdth90">Present</label>
<input tabindex="1" name="residualRoots" id="residualRoots" value="Present" type="radio" class="radiobutMargin" onchange="displayTextValueFPresidualRoots(this.value);">
<label class="wdth90">Absent</label>
<input tabindex="1" name="residualRoots" id="residualRoots" value="Absent" type="radio" class="radiobutMargin" onchange="displayTextValueFPresidualRoots(this.value);">
<div style="display:none" id="residualRootsDiv">
<input type="text" name="residualRootsValue" id="residualRootsValue" maxlength="128" tabindex="1">
</div>
<div class="clear"></div>

<label class="lable185">Periapical Status of Abutments</label>
<label class="wdth90">Healthy</label>
<input tabindex="1" name="periapicalStatus" id="periapicalStatusH" value="Healthy" type="radio" class="radiobutMargin" onchange="displayTextValueFPperiapicalStatusH(this.value);">
<label class="wdth90">Diseased</label>
<input tabindex="1" name="periapicalStatus" id="periapicalStatusD" value="Diseased" type="radio" class="radiobutMargin" onchange="displayTextValueFPperiapicalStatusH(this.value);">
<div style="display:none" id="periapicalStatusDiv">
<input type="text" name="periapicalStatusValue" id="periapicalStatusValue" maxlength="128" tabindex="1">
</div>
<div class="clear"></div>

<label class="lable185">Root Resorption</label>
<label class="wdth90">Present</label>
<input tabindex="1" name="rootResorption" id="rootResorption" value="Present" type="radio" class="radiobutMargin" onchange="displayTextValueFProotResorption(this.value);">
<label class="wdth90">Absent</label>
<input tabindex="1" name="rootResorption" id="rootResorption" value="Absent" type="radio" class="radiobutMargin" onchange="displayTextValueFProotResorption(this.value);">
<div style="display:none" id="rootResorptionDiv">
<input type="text" name="rootResorptionValue" id="rootResorptionValue" maxlength="128" tabindex="1">
</div>
<div class="clear"></div>

<label class="lable185">Crown Root Ratio of Abutments</label>
<label class="wdth90">Ideal</label>
<input tabindex="1" name="crownRootRatio" id="crownRootRatio" value="Ideal" type="radio" class="radiobutMargin" onchange="displayTextValueFPcrownRootRatio(this.value);">
<label class="wdth90">Optimum</label>
<input tabindex="1" name="crownRootRatio" id="crownRootRatio" value="Optimum" type="radio" class="radiobutMargin" onchange="displayTextValueFPcrownRootRatio(this.value);">
<div style="display:none" id="crownRootRatioDiv">
<input type="text" name="crownRootRatioValue" id="crownRootRatioValue" maxlength="128" tabindex="1">
</div>
<div class="clear"></div>

<label class="lable185">Continuity of Lamina Dura</label>
<label class="wdth90">Continuous</label>
<input tabindex="1" name="continuityOfLaminaDura" id="continuityOfLaminaDura" value="Continuous" type="radio" class="radiobutMargin" onchange="displayTextValueFPcontinuityOfLaminaDura(this.value);">
<label class="wdth90">Non continuous</label>
<input tabindex="1" name="continuityOfLaminaDura" id="continuityOfLaminaDura" value="Non continuous" type="radio" class="radiobutMargin" onchange="displayTextValueFPcontinuityOfLaminaDura(this.value);">
<div style="display:none" id="continuityOfLaminaDuraDiv">
<input type="text" name="continuityOfLaminaDuraValue" id="continuityOfLaminaDuraValue" maxlength="128" tabindex="1">
</div>
<div class="clear"></div>

<label class="lable185">Vertical/Horizontal Bone Loss</label>
<label class="wdth90">Present</label>
<input tabindex="1" name="verticalHorizontal" id="verticalHorizontal" value="Present" type="radio" class="radiobutMargin" onchange="displayTextValueFPverticalHorizontal(this.value);">
<label class="wdth90">Absent</label>
<input tabindex="1" name="verticalHorizontal" id="verticalHorizontal" value="Absent" type="radio" class="radiobutMargin" onchange="displayTextValueFPverticalHorizontal(this.value);">
<div style="display:none" id="verticalHorizontalDiv">
<input type="text" name="verticalHorizontalValue" id="verticalHorizontalValue" maxlength="128" tabindex="1">
</div>
<div class="clear"></div>

<label class="lable185">Treatment Planning</label>
<!-- <input type="text" name="treatmentPlanning" id="treatmentPlanning" maxlength="40" tabindex="1"> -->
<textarea rows="" cols="" id="treatmentPlanning" name="treatmentPlanning" style="margin:0px; width:550px;" maxlength="256" validate="Dental History,string,no"  onkeyup="return checkLength(this)"></textarea>
...
<style>
.lable185 {width:180px !important;}
.wdth90 {width:90px !important;}
.wdth56 {width:56px !important;}
</style>
