...
<input type="hidden" name="<%=POJO_PROPERTY_DISCRIPTION %>" value="PoDeliveryTermsDescription">
<input type="hidden" name="title" value="PoDeliveryTerms"> 
<input type="hidden" name="<%=JSP_NAME %>" value="poDeliveryTerms">
<div class="paddingTop5"></div>
<div class="clear"></div>
<div class="Block">
<label><span>*</span> PO Type</label> 
<select name="<%=SEARCH_NAME%>" validate="PO Type,alphanumeric,yes">
<option value="0">Select</option>
<option value="Delivery">Delivery</option>
<option value="Payment">Payment</option>
</select> 
<label><span>*</span> Description</label> 
<input type="text" name="<%= DESCRIPTION%>" value="" validate="Description,alphanumeric,yes" MAXLENGTH="100" onkeypress="return submitenter(this,event,'pharmacy?method=addPoDeliveryTerms')" />
<div class="clear"></div>
...
<input type="button" name="edit" id="editbutton" value="Update" style="display: none;" class="button" onClick="submitForm('poDeliveryTerms','pharmacy?method=editPoDeliveryTerms')" accesskey="u" tabindex=1 />
<input type="button" name="Delete" id="deletebutton" value="Activate" style="display: none;" class="button" onClick="submitForm('poDeliveryTerms','pharmacy?method=deletePoDeliveryTerms&flag='+this.value)" accesskey="d" tabindex=1 /> 
