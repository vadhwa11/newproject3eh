...
<input type="text" class="date"
	id="fromDateId" name="fromDate" value="" readonly="readonly"
...
<input type="text" class="date"
	id="lastDateId" name="lastDate" value="" readonly="readonly"
	validate="Date of Collection,date,no" MAXLENGTH="10" tabindex="1" />
	 <img
	src="/hms/jsp/images/cal.gif" width="16" height="16" border="0"
	validate="Pick a date"
...
<label>Indent Number</label> 
 ...
 <thead>
		...
		<tr>
			<td><%=HMSUtil.convertDateToStringTypeDateOnly(bldIndentIssueM.getIssueHeader().getIssueDate())  %></td>
			<!-- <td></td> -->
			<td><%=bldIndentIssueM.getIssueHeader().getBloodRequestHd().getHin().getHinNo() %></td>
			<td><%=bldIndentIssueM.getIssueHeader().getBloodRequestHd().getHin().getFullName() %></td>
