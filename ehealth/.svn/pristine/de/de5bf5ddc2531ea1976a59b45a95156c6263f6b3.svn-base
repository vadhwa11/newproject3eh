...
<form name="ipvoucherMapping" method="post" action="">
<div class="titleBg">
...
<label><span>*</span>From Date:</label>
	...
	<img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0" onclick="setdate('',document.ipvoucherMapping.<%=FROM_DATE %>,event)" />

<label><span>*</span>To Date:</label>
	<input type="text" name="<%=TO_DATE %>" id="to_date" value="<%=date %>" class="date" readonly="readonly" MAXLENGTH="30" />
	<img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0" onclick="setdate('',document.ipvoucherMapping.<%=TO_DATE %>,event)" />

<div class="clear"></div>

<input type="button" name="Submit11" id="addbutton" value="Dispaly" class="button" onClick="submitForm('ipvoucherMapping','account?method=dispalyIpSalesBillingAmount');" accesskey="a" tabindex=1 />
<div class="clear"></div>
...
<tr>
	...
	<%if(charityObj[0]!= null){ %>
	<td><%=(BigDecimal)charityObj[0] %><input type="hidden" id="drAmountId<%=i %>" name="drAmtId<%=i %>" value="<%=(BigDecimal)charityObj[0] %>"   /></td>
	<%}else{ %>
	<td>0.00</td>
	<%} %>
	<td>0.00<input type="hidden" id="crAmountId<%=i %>" name="crAmtId<%=i %>" value="<%=0.00%>"   /></td>
...
<input type="button" name="Submit11" id="addbutton" value="Submit" class="button" onClick="submitForm('ipvoucherMapping','account?method=postSalesIpVoucherMapping','validateTotalDrCr');" accesskey="a" tabindex=1 />
	<div class="clear"></div>
</div>
