...
<input type="button" name="search" value="Search" class="button"
	onclick="submitForm('search','laboratory?method=searchBiopsyLab','checkSearch')"
...
<input type="button" name="Report" value="Generate Report"
	...
	name="<%=JASPER_FILE_NAME%>" value="Mas_biopsy_lab" validate="Administrative Sex Code,string,no">
...
<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
<input
	type="hidden" name="<%= POJO_NAME %>" value="MasBiopsyLab"><input
	type="hidden" name="<%=POJO_PROPERTY_NAME %>" value="BiopsyLabName"><input
	type="hidden" name="title" value="BiopsyLab"><input
	type="hidden" name="<%=JSP_NAME %>" value="biopsyLab"><input
	type="hidden" name="pojoPropertyCode" value="BiopsyLabCode">
<div class="paddingTop5"></div>
<div class="clear"></div>
<div class="Block">
<label><span>*</span> BiopsyLab Code </label> <input
	id="codeId" type="text" name="<%= CODE%>" value=""
	validate="BiopsyLab Code,string,yes" class="textbox_size20"
	MAXLENGTH="8" / tabindex=1><label><span>*</span> BiopsyLab
Name </label> <input type="text" name="<%= SEARCH_NAME %>" value=""
	validate="BiopsyLab Name,string,yes" class="textbox_size20"
	MAXLENGTH="30" / tabindex=1
	onkeypress="return submitenter(this,event,'laboratory?method=addBiopsyLab')"><script>
...
<input type="button" name="add" id="addbutton" value="Add"
	class="button"
	onClick="submitForm('biopsyLab','laboratory?method=addBiopsyLab');"
	accesskey="a" tabindex=1 /> <input type="button" name="edit"
	id="editbutton" value="Update" style="display: none;" class="button"
	onClick="submitForm('biopsyLab','laboratory?method=editBiopsyLab')"
	accesskey="u" tabindex=1 /> <input type="button" name="Delete"
	id="deletebutton" value="Activate" style="display: none;"
	class="button"
	onClick="submitForm('biopsyLab','laboratory?method=deleteBiopsyLab&flag='+this.value)"
