...
<meta name="description" content="A genogram is a family tree diagram for visualizing hereditary patterns." />
  ...
  <meta charset="UTF-8">
  <script src="/hms/jsp/js/familyTree.js"></script>
	...
	if(map.get("nodes")!=null)
		nodes = (JSONArray) map.get("nodes");
	if(map.get("patientFTId")!=null)
		patientFTId = (Integer) map.get("patientFTId");
          ...
          { 
            ...
            nodeSelectionAdornmentTemplate:
              $(go.Adornment, "Auto",         
                ...
                $(go.Shape, "Circle", { fill: "white", stroke: null }),
                $(go.Placeholder)
              ),
      ...
      myDiagram.nodeTemplateMap.add("M",  // male
		...
		{ deletable: false, toolTip: tooltiptemplate },
          ...
          $(go.Panel,
            ...
            ,
			   new go.Binding("fill", "", genderBrushConverter)),
            $(go.Panel,
...
function genderBrushConverter(person) {
     ...
     if(person.status=="y")
      ...
      setupDiagram(myDiagram, /*[
          { key: 0, n: "fa", s: "M",   a: ["C", "F", "K"] },
          { key: 1, n: "mother", s: "F", vir:0, a: ["B", "H", "K"] },
          { key: 2, n: "indu", s: "F", m: 1, f: 0, a: ["C", "H", "L"] },
          { key: 3, n: "param", s: "F", m:1,f:0,a: ["C"] },
          { key: 4, n: "self", s: "M", m: 1, f: 0, a: ["E", "H"] },
         ...
         <%=nodes%>
         ,
        <%=patientFTId%> /* focus on this person */);
    }
...
<div id="sample">
  <div id="myDiagramDiv" style=" width:100%; height:600px;margin-top: -100px">
  <%if(nodes.equals("[]")){ %>
  No records.
  <%}%>
  </div>
