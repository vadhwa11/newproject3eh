...
/**
 * This is an object that contains data related to the mas_icd_main_category table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="mas_icd_main_category"
 */
...
public abstract class BaseMasIcdMainCategory  implements Serializable {
	 ...
	 * @param icdMaincategoryCode the icd_maincategory_code value
	 */
	 ...
	 * @param icdMaincategoryName the icd_maincategory_name value
	 */
	 ...
	 * @param masIcdSubCategories the MasIcdSubCategories value
	 */
	public void setMasIcdSubCategories (java.util.Set<jkt.hms.masters.business.MasIcdSubCategory> masIcdSubCategories) {
		this.masIcdSubCategories = masIcdSubCategories;
	}

	public void addToMasIcdSubCategories (jkt.hms.masters.business.MasIcdSubCategory masIcdSubCategory) {
		if (null == getMasIcdSubCategories()) setMasIcdSubCategories(new java.util.TreeSet<jkt.hms.masters.business.MasIcdSubCategory>());
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hms.masters.business.MasIcdMainCategory)) return false;
		else {
			jkt.hms.masters.business.MasIcdMainCategory masIcdMainCategory = (jkt.hms.masters.business.MasIcdMainCategory) obj;
			if (null == this.getId() || null == masIcdMainCategory.getId()) return false;
			else return (this.getId().equals(masIcdMainCategory.getId()));
		}
	}
