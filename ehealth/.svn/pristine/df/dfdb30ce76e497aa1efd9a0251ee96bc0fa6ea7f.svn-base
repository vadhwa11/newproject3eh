...
<%--<label>Demand No.</label> <input type="text"
	...
	<%if(indentDate != null){ %>
	 <input type="text" name="<%=DEMAND_DATE %>" value="<%= HMSUtil.convertDateToStringTypeDateOnly(indentDate) %>" readonly="readonly"   />
	 <%}else{ %>
	 <input type="text" name="<%=DEMAND_DATE %>" value="<%=date %>" readonly="readonly"   />
	 <%} %>
...
<table border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<td><input type="text" size="5" value="<%=storeInternalIndentT.getItem().getItemConversion()!= null?storeInternalIndentT.getItem().getItemConversion().getItemUnitName():"" %>" name="au" id="<%="au"+""+i %>" readonly="readonly" /></td>
						<td><input type="text" size="5" value="<%=storeInternalIndentT.getPrevYearIndQty()!= null?storeInternalIndentT.getPrevYearIndQty().intValue():"" %>" name="year1IndentQty" id="year1IndentQtyId<%=i %>" readonly="readonly" /></td>
						<td><input type="text" size="5" value="<%=storeInternalIndentT.getPrevToPrevYearIndQty()!= null?storeInternalIndentT.getPrevToPrevYearIndQty().intValue():"" %>" name="year2IndentQty" id="year2IndentQtyId<%=i %>"  readonly="readonly" /></td>
						<td><input type="text" size="5" value="<%=storeInternalIndentT.getPrevYearConsmQty()!= null?storeInternalIndentT.getPrevYearConsmQty().intValue():"" %>" name="previousYearConsumption"  id="previousYearConsumptionId<%=i %>"  readonly="readonly" /></td>
						<td><input type="text" size="5" value="<%=storeInternalIndentT.getStockInHand()!= null?storeInternalIndentT.getStockInHand():"" %>" name="stock" validate="Stock In Hand,num,no" id="<%=stock+i %>"  readonly="readonly" /></td>
						<td><input type="text" size="4" value="<%=storeInternalIndentT.getLeadTime()!= null?storeInternalIndentT.getLeadTime().intValue():"" %>" name="leadTime" validate="Lead Time,num,no" id="leadTimeId<%=i %>" readonly="readonly"  /></td>
						<td><input type="text" size="4" value="<%=storeInternalIndentT.getConsInLeadTime()!= null?storeInternalIndentT.getConsInLeadTime().intValue():"" %>" name="consumptionInLeadTime" validate="Consumption In Lead Time,num,no" id="consumptionInLeadTimeId<%=i%>" readonly="readonly"   /></td>
						<td><input type="text" size="4" value="<%=storeInternalIndentT.getIncrementalPercentage()!= null?storeInternalIndentT.getIncrementalPercentage().intValue():"" %>" name="incrementalPercentage" id="incrementalPercentageId<%=i %>" readonly="readonly"  /></td>
						<td><input type="text" size="4" value="<%=storeInternalIndentT.getIncrementalQuantity()!= null?storeInternalIndentT.getIncrementalQuantity().intValue():"" %>" name="incrementalQty" id="incrementalQtyId<%=i %>" readonly="readonly"/></td>
						<td><input type="text" size="4" value="<%=storeInternalIndentT.getPendingIndentQty()!= null?storeInternalIndentT.getPendingIndentQty().intValue():"" %>" name="pendingIndentQty" id="pendingIndentQtyId<%=i %>" validate="Pending Indent Qty,num,no" readonly="readonly"/></td>
						<td><input type="text" size="5" value="<%=storeInternalIndentT.getRequiredQty()!= null?storeInternalIndentT.getRequiredQty().intValue():"" %>" name="requiredQty" id="requiredQtyId<%=i %>" validate="Requested Qty,num,no" readonly="readonly" /></td>
						<td><input type="text" size="5" value="<%=storeInternalIndentT.getAdditionalQty()!= null?storeInternalIndentT.getAdditionalQty().intValue():"" %>" name="additionalQty" validate="Stock In Hand,num,no" id="additionalQtyId<%=i %>"  readonly="readonly" /></td>
						<td><input type="text" size="5" value="<%=storeInternalIndentT.getQtyRequest()!= null?storeInternalIndentT.getQtyRequest():"" %>" name="qtyRequest" id="<%=qtyRequest+i %>" validate="Demanded Qty,num,no" readonly="readonly" /></td>
						<td><input type="text" size="5" value="<%=storeInternalIndentT.getRemarks()!= null?storeInternalIndentT.getRemarks():"" %>" name="remarks" id="remarks<%=i %>" validate="Remarks,string,no" />
						<input type="hidden" value="<%=storeInternalIndentT.getId()!= null?storeInternalIndentT.getId():"" %>" name="itemId" id="<%=itemId+i %>" /></td>
...
<textarea name="dhsRemarks"   validate="Remarks,string,no" cols="0" rows="0" class="large" maxlength="198" tabindex="1" ></textarea>
...
<div class="clear"></div>
<input type="button" name="Next/Update" type="submit" value="Approve"	onClick="submitForm('annualStateIndentApproval','stores?method=submitAnnualStateApproval','validateRows');" class="button">
<input type="button" name="Next/Update" type="submit" value="SendBack"	onClick="submitForm('annualStateIndentApproval','stores?method=submitAnnualDepartmentApproval');" class="button">
