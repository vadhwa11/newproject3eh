...
function validateTaperedForm(){
	...
	window.opener.document.getElementById("totalOtTab"+<%=row%>).value=parseFloat(total);
	window.opener.document.getElementById("totalOtTab"+<%=row%>).readOnly=true;
	window.opener.document.getElementById("dosageOtTab"+<%=row%>).value="";
	window.opener.document.getElementById("dosageOtTab"+<%=row%>).readOnly=true;
	window.opener.document.getElementById("dosageOtTab"+<%=row%>).removeAttribute('onblur');
	window.opener.document.getElementById("nomenclatureOtTab"+<%=row%>).readOnly=true;
	window.opener.document.getElementById("nomenclatureOtTab"+<%=row%>).removeAttribute('onblur');
	window.opener.document.getElementById("nomenclatureOtTab"+<%=row%>).setAttribute('onblur','editTaperedMedicine('+<%=row%>+','+<%=itemId%>+')');
	window.opener.document.getElementById("routeOtTab"+<%=row%>).disabled= true;
	window.opener.document.getElementById("unitOtTab"+<%=row%>).readOnly=true;
	window.opener.document.getElementById("unitOtTab"+<%=row%>).value="";
	window.opener.document.getElementById("unitOtTab"+<%=row%>).removeAttribute('onblur');
	window.opener.document.getElementById("frequencyOtTab"+<%=row%>).disabled= true;
	window.opener.document.getElementById("noOfDaysOtTab"+<%=row%>).readOnly=true;
	window.opener.document.getElementById("noOfDaysOtTab"+<%=row%>).removeAttribute('onblur');
	window.opener.document.getElementById("noOfDaysOtTab"+<%=row%>).value="";
	if(window.opener.document.getElementById("instrunctionOtTab"+<%=row%>)!=null){
	window.opener.document.getElementById("instrunctionOtTab"+<%=row%>).disabled= true;
	}
	if(window.opener.document.getElementById("instructionOtTab"+<%=row%>)!=null){
		window.opener.document.getElementById("instructionOtTab"+<%=row%>).disabled= true;
	}
	if(window.opener.document.getElementById("unitLableOtTab"+<%=row%>)!=null){
		window.opener.document.getElementById("unitLableOtTab"+<%=row%>).readOnly=true;
	}
	if(window.opener.document.getElementById("splInstrunctionOtTab"+<%=row%>)!=null){
		window.opener.document.getElementById("splInstrunctionOtTab"+<%=row%>).readOnly=true;
		window.opener.document.getElementById("splInstrunctionOtTab"+<%=row%>).value=dosage;
	}
	if(window.opener.document.getElementById("itemRadioOtTab"+<%=row%>)!=null){
		window.opener.document.getElementById("itemRadioOtTab"+<%=row%>).disabled= true;  
	}	
	if(window.opener.document.getElementById("itemBatchNoIdOtTab"+<%=row%>)!=null){
		window.opener.document.getElementById("itemBatchNoIdOtTab"+<%=row%>).disabled= true;  
	}
...
function cancelFunction(update){
	if(update=="N"){
	window.opener.document.getElementById("nomenclatureOtTab"+<%=row%>).value="";
