...
/**
 * This is an object that contains data related to the hr_resumestatus table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 * 
 * @hibernate.class table="hr_resumestatus"
 */

public abstract class BaseResumestatus implements Serializable {

	public static String REF = "Resumestatus";
	...
	public static String PROP_NOTICE_PERIOD_REIMBURSEMENTS = "NoticePeriodReimbursements";
	 ...
	 */
	public BaseResumestatus(java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	private java.lang.Integer noticePeriodReimbursements;
	...
	/**
	 * Return the value associated with the column: notice_period_reimb
	 */
	public java.lang.Integer getNoticePeriodReimbursements() {
		return noticePeriodReimbursements;
	}

	/**
	 * Set the value related to the column: notice_period_reimb
	 * 
	 * @param noticePeriodReimbursements
	 *            the notice_period_reimb value
	 */
	public void setNoticePeriodReimbursements(
			java.lang.Integer noticePeriodReimbursements) {
		this.noticePeriodReimbursements = noticePeriodReimbursements;
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof jkt.hrms.recruitment.masters.business.Resumestatus)) {
			return false;
		} else {
			jkt.hrms.recruitment.masters.business.Resumestatus resumestatus = (jkt.hrms.recruitment.masters.business.Resumestatus) obj;
			if (null == this.getId() || null == resumestatus.getId()) {
				return false;
			} else {
				return (this.getId().equals(resumestatus.getId()));
			}
		}
	}
