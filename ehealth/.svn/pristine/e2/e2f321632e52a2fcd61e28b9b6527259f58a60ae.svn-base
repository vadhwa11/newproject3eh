...
/**
 * This is an object that contains data related to the mas_anesthesia table.
...
public abstract class BaseMasAnesthesia  implements Serializable {
	 ...
	 * @param anesthesiaCode the anesthesia_code value
	 */
	 ...
	 * @param anesthesiaName the anesthesia_name value
	 */
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hms.masters.business.MasAnesthesia)) return false;
		else {
			jkt.hms.masters.business.MasAnesthesia masAnesthesia = (jkt.hms.masters.business.MasAnesthesia) obj;
			if (null == this.getId() || null == masAnesthesia.getId()) return false;
			else return (this.getId().equals(masAnesthesia.getId()));
		}
	}
