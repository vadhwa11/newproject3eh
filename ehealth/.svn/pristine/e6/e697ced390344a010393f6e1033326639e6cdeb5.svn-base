...
<%
	...
	List<PatientWiseMlc> patientDetails=new ArrayList<PatientWiseMlc>();
	 if(map.get("patientDetails") != null){
		 patientDetails =(List)map.get("patientDetails");
		}
	 System.out.println("ptMlc==="+patientDetails.size());
	List<ExpiryDetails> discharge=new ArrayList<ExpiryDetails>();
	 List<MortuaryRegisterDetails> mortuaryRegisterList = new ArrayList<MortuaryRegisterDetails>();
	 if(map.get("discharge") != null){
		 discharge =(List<ExpiryDetails>)map.get("discharge");
		}
...
<input type="hidden" name="hinId" id="hinId" value="<%=discharge.get(0).getHin().getId() %>" >
...
<%System.out.println("The Value in jsp.111111111111111..........."+discharge.get(0).getId()); %>
...
<input type="button" name="Submit" id="Submit" value="Save" class="buttonBig" onClick="submitForm('mortuaryRegister','mlc?method=submitMortuaryRegister&flagStatus=save');" accesskey="a" tabindex=1 />
<input type="button" name="Submit" id="Submit" value="Submit" class="buttonBig" onClick="submitForm('mortuaryRegister','mlc?method=submitMortuaryRegister&flagStatus=submit');" accesskey="a" tabindex=1 />
...
<input type="hidden" name="hinId" id="hinId" value="<%=opdPatientDetails.get(0).getVisit().getHin().getId() %>" >
...
<input type="hidden" name="hinId" id="hinId" value="<%=patientDetails.get(0).getHin().getId() %>" >

<label>UHID</label> 
<!-- <input type="text"  name="hinNo" id="hinNo" onblur="getMedicoLegalDetails(this.value);"> -->
<%if(patientDetails.size() >0){ %>
<input type="text" readonly="readonly"  name="hinNo" id="hinNo" value="<%=patientDetails.get(0).getOpdPatientDetail().getVisit().getHin().getHinNo()!=null?patientDetails.get(0).getOpdPatientDetail().getVisit().getHin().getHinNo():"" %>" >
<%}else{ %>
<input type="text" name="hinNo" id="hinNo" value="" >
<%} %>
</div>
...
<label>Deceased Name</label>
<%if(patientDetails.size() >0){ %>
<input type="text" readonly="readonly"  name="deceasedName" id="deceasedName" value="<%=patientDetails.get(0).getOpdPatientDetail().getVisit().getHin().getFullName()!=null?patientDetails.get(0).getOpdPatientDetail().getVisit().getHin().getFullName():"" %>">
<%}else{ %>
<input type="text"  name="deceasedName" id="deceasedName" value="">
<%} %>
<input type="hidden"  name="opdPatientDetailId" id="opdPatientDetailId" value="<%=patientDetails.get(0).getOpdPatientDetail()!= null?patientDetails.get(0).getOpdPatientDetail().getId():""%>"> 
<input type="hidden"  name="patiientWiseMlcId" id="patiientWiseMlcId" value="<%= patientDetails.get(0).getId()%>">
<%System.out.println("The Value in jsp............"+patientDetails.get(0).getId()); %>
<input type="hidden"  name="hinId" id="hinId" value="<%=patientDetails.get(0).getHin().getId()%>">

<label>Age</label>
<%if(patientDetails.size() >0){ %>
<input type="text" readonly="readonly"  name="age" id="age" value="<%=patientDetails.get(0).getOpdPatientDetail().getVisit().getHin().getAge()!=null?patientDetails.get(0).getOpdPatientDetail().getVisit().getHin().getAge():"" %>">
<%}else{ %>
<input type="text" name="age" id="age" value="">
<%} %>
<label>Sex</label>
<%if(patientDetails.size() >0){ %>
<input type="text" readonly="readonly" name="gender" id="gender" value="<%=patientDetails.get(0).getOpdPatientDetail().getVisit().getHin().getSex().getAdministrativeSexName()!=null?patientDetails.get(0).getOpdPatientDetail().getVisit().getHin().getSex().getAdministrativeSexName():"" %>">
<%}else{ %>
<input type="text"  name="gender" id="gender" value="" >
<%} %>
<div class="clear"></div>
