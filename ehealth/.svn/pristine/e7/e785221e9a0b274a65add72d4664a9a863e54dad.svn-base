...
<div class="titleBg">
<h2>Pharmacy Statatics Report</h2>
</div>
<div class="clear"></div>
<div class="Block">
...
<label> Summary Type</label> <input type="radio" name="reportName"
	value="PharmacyConsumptionStaticSummary" checked="checked" /> <label>
Detail Type</label> <input type="radio" name="reportName"
	value="PharmacyConsumptionStatic" />
<div class="clear"></div>
...
<select id="itemGroupId" name="<%=GROUP_ID%>">
<option value="0">Select</option>
...
<div class="clear"></div>
<input type="button" class="buttonBig" value="Generate Report"	onclick="submitForm('stockRegisterReport','/hms/hms/stores?method=printPharmacyConsumptionReport');"></input>
<div class="clear"></div>
<div class="division"></div>
<div class="clear"></div>
