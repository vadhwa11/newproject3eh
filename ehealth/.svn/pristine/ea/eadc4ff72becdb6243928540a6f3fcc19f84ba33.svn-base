...
public interface ProcurementDataService {
	...
	Map<String, Object> saveQuotationRequisitionApprovalJsp(Box box,Map<String, Object> dataMap);
	...
	Map<String, Object> showPendingListForApprovalOfQuotationRequisitionJsp(Box box, Map<String, Object> dataMap);

	Map<String, Object> showQuotationRequisitionApprovalJsp(Box box,Map<String, Object> dataMap);

	Map<String, Object> showPendingListForSubmittingQuotationJsp(Box box,Map<String, Object> dataMap);

	Map<String, Object> showQuotationSubmissionJsp(Box box,Map<String, Object> dataMap);

	Map<String, Object> showAccessoryDetailsJsp(Box box,Map<String, Object> dataMap);

	Map<String, Object> showTechnicalApprovalJsp(Box box,Map<String, Object> dataMap);

	Map<String, Object> showCommercialApprovalJsp(Box box,Map<String, Object> dataMap);
	Map<String, Object> showNegotiationJsp(Box box,Map<String, Object> dataMap);

	Map<String, Object> showPendingListForCreatingPOWOJsp(Box box,Map<String, Object> dataMap);
	Map<String, Object> showPendingTechnicalApprovalJsp(Box box,Map<String, Object> dataMap);
	Map<String, Object> showPendingCommercialApprovalJsp(Box box,Map<String, Object> dataMap);

	Map<String, Object> showPOCreationJsp(Box box, Map<String, Object> dataMap);

	Map<String, Object> showPendingForPOApprovalJsp(Box box,Map<String, Object> dataMap);
	...
	Map<String, Object> showEquipmentDetailJsp(Box box,Map<String, Object> dataMap);
	...
	Map<String, Object> showPendingListForAuctionJsp(Box box,Map<String, Object> dataMap);

	Map<String, Object> showAuctionDetailJsp(Box box,Map<String, Object> dataMap);

	Map<String, Object> showInsuranceDetailJsp(Box box,Map<String, Object> dataMap);

	Map<String, Object> showInsuranceClaimAndTrackingJsp(Box box,Map<String, Object> dataMap);
 ...
 //	Map<String, Object> showVendorListJsp(Box box, Map<String, Object> dataMap);
	...
	//Map<String, Object> saveItemQuotationSubmissionJsp(Box box,
...
//	Map<String, Object> getSectionGLList(Map<String, Object> dataMap);
	...
	Map<String, Object> addMuableAssets(MultipartFormDataRequest mRequest, Map<String, Object> dataMap);
	...
	Map<String, Object> showAssetDetailsMovableJsp(Map<String, Object> details);
	...
	Map<String, Object> submitPoCreationDirect(Box box,
			Map<String, Object> dataMap);
