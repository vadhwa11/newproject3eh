...
/**
 * This is an object that contains data related to the central_server_visit_data table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="central_server_visit_data"
 */

public abstract class BaseCentralServerVisitData  implements Serializable {

	public static String REF = "CentralServerVisitData";
	...
	// constructors
	public BaseCentralServerVisitData () {
		initialize();
	}
	 ...
	 */
	public BaseCentralServerVisitData (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hms.masters.business.CentralServerVisitData)) return false;
		else {
			jkt.hms.masters.business.CentralServerVisitData centralServerVisitData = (jkt.hms.masters.business.CentralServerVisitData) obj;
			if (null == this.getId() || null == centralServerVisitData.getId()) return false;
			else return (this.getId().equals(centralServerVisitData.getId()));
		}
	}
