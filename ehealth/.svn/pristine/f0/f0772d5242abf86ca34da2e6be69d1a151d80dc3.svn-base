...
<%} %> 
<form name="prescriptionDetails" method="post" action="">
<div class="titleBg">
<h2>All Prescription Search</h2> 
...
<img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0" validate="Pick a date"	onclick="javascript:setdate('<%=FROM_DATE%>',prescriptionDetails.<%=FROM_DATE%>,true);" />
<label > To Date</label> 
<input type="text"	name="<%=TO_DATE%>" value="<%=date %>" class="date" MAXLENGTH="30"	readonly="readonly" /> 
<img src="/hms/jsp/images/cal.gif" width="16"	height="16" border="0" validate="Pick a date"	onclick="javascript:setdate('<%=FROM_DATE%>',document.prescriptionDetails.<%=TO_DATE%>,true);" />
...
<div class="clear"></div>
<input type="button" name="search" value="Search" class="button" onClick="submitForm('prescriptionDetails','stores?method=showPatientPrescriptionReport');"	accesskey="g" tabindex=1 />
