...
<div class="leftMenu">Approval
	...
	<input type="image" src="/hms/jsp/images/buttonIcons/patientDiagnosis.jpg" class="buttonBig" name="SQ Approval" onClick="submitForm('projectvitals','projectTracking?method=showSQApprovalStatus','validateRadio');" value="SQ Approval" height="34" width="188" />
	
	<input type="image" src="/hms/jsp/images/buttonIcons/patientDiagnosis.jpg" class="buttonBig" name="QA Approval" onClick="submitForm('projectvitals','projectTracking?method=showQAApprovalStatus','validateRadio');" value="QA Approval" height="34" width="188" />
	
	<input type="image" src="/hms/jsp/images/buttonIcons/patientDiagnosis.jpg" class="buttonBig" name="Project Approval" onClick="submitForm('projectvitals','projectTracking?method=showProjectApproval','validateRadio');" value="Project Approval" height="34" width="188" />
