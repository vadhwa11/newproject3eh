...
<div class="titleBg">
<h2>Format For Reporting monthly Test Results</h2>
</div>
<form name="monthlySummary" target="_blank" action="" method="post">
<div class="Block"><label><span>*</span>From Date</label> <input
	...
	onClick="setdate('<%=currentDate %>',document.monthlySummary.<%=FROM_DATE%>,event)" />
...
<label><span>*</span>To Date</label> <input type="text" class="date"
	...
	src="/hms/jsp/images/cal.gif" width="16" height="16" border="0"
	validate="Pick a date"
	onClick="setdate('<%=currentDate %>',document.monthlySummary.<%=TO_DATE%>,event)" />
</select> 
<script type="text/javascript">
...
<input type="button" name="OK" value="OK" class="button"
	onClick="submitForm('monthlySummary','lab?method=generateMonthlyTestResultRepor','validateFromToDate');" />
...
<script type="text/javascript" language="javascript">
	...
	function validateFromToDate(){
		...
		obj1 = eval(document.monthlySummary.fromDate)
		obj2 = eval(document.monthlySummary.toDate)
