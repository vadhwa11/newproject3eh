...
<%
	...
	if (map.get("fixedListMap") != null) {
		fixedListMap = (Map) map.get("fixedListMap");
	}
	
	System.out.println("jsp fixedListMap "+fixedListMap.size()+" resultEntryIndex "+resultEntryIndex);
%>
<div class="clear"></div>
<!-- Table Starts -->
<%
...
<tr>
 ...
 %>
	...
	<td><input id="checkId<%=resultEntryIndexForMultiple%>"
		...
		value="testValidate" type="hidden" class="check" />
		<input
		type="hidden" name="acceptedId<%=resultEntryIndexForMultiple%>"
		value="<%=dgResultEntryHeader.getId()%>" /><!-- added by govind 01-07-2017-->
		</td>
...
<%
	if (dgDetail.getSubInvestigation().getResultType()
			...
			request.setAttribute("dgDetailForMultipleTestType",
					dgDetail);
%><jsp:include page="resultValidationForMultipleTestType1.jsp"
	flush="true">
...
<%
	if (dgDetail.getSubInvestigation().getResultType()
			...
			request.setAttribute(
					...
					dgResultEntryHeader);
%>
<jsp:include page="resultValidationForMultipleTestType2.jsp"
	flush="true">
	<jsp:param name="resultEntryIndex" value="<%=resultEntryIndex%>" />
	<jsp:param name="resultEntryIndexForMultiple"
		value="<%=resultEntryIndexForMultiple%>" />
...
<%
	if (dgDetail.getSubInvestigation().getResultType()
			...
			request.setAttribute(
					...
					dgResultEntryHeader);
%>
<jsp:include page="resultValidationForMultipleTestType3.jsp"
	flush="true">
	<jsp:param name="resultEntryIndex" value="<%=resultEntryIndex%>" />
	<jsp:param name="resultEntryIndexForMultiple"
		value="<%=resultEntryIndexForMultiple%>" />
...
<%
	if (dgDetail.getSubInvestigation().getResultType()
			...
			request.setAttribute(
					...
					dgResultEntryHeader);
%>
<jsp:include page="resultValidationForMultipleTestType4.jsp"
	flush="true">
	<jsp:param name="resultEntryIndex" value="<%=resultEntryIndex%>" />
	<jsp:param name="resultEntryIndexForMultiple"
		value="<%=resultEntryIndexForMultiple%>" />
...
<%
	if (dgDetail.getSubInvestigation().getResultType()
			...
			request.setAttribute(
					...
					dgResultEntryHeader);
%>
<jsp:include page="resultValidationForMultipleTestType5.jsp"
	flush="true">
	<jsp:param name="resultEntryIndex" value="<%=resultEntryIndex%>" />
	<jsp:param name="resultEntryIndexForMultiple"
		value="<%=resultEntryIndexForMultiple%>" />
...
<%
	if (dgDetail.getSubInvestigation().getResultType()
			...
			request.setAttribute(
					...
					dgResultEntryHeader);
%>
<jsp:include page="resultValidationForMultipleTestType6.jsp"
	flush="true">
	<jsp:param name="resultEntryIndex" value="<%=resultEntryIndex%>" />
	<jsp:param name="resultEntryIndexForMultiple"
		value="<%=resultEntryIndexForMultiple%>" />
...
<%
	if (dgDetail.getSubInvestigation().getResultType()
			...
			request.setAttribute(
					...
					dgResultEntryHeader);
%>
<jsp:include page="resultValidationForMultipleTestType7.jsp"
	flush="true">
	<jsp:param name="resultEntryIndex" value="<%=resultEntryIndex%>" />
	<jsp:param name="resultEntryIndexForMultiple"
		value="<%=resultEntryIndexForMultiple%>" />
...
<%
	if (dgDetail.getSubInvestigation().getResultType()
			...
			request.setAttribute(
					...
					dgResultEntryHeader);
%>
<jsp:include page="resultValidationForMultipleTestType8.jsp"
	flush="true">
	<jsp:param name="resultEntryIndex" value="<%=resultEntryIndex%>" />
	<jsp:param name="resultEntryIndexForMultiple"
		value="<%=resultEntryIndexForMultiple%>" />
...
<%
	if (dgDetail.getSubInvestigation().getResultType()
			...
			request.setAttribute(
					...
					dgResultEntryHeader);
%>
<jsp:include page="resultValidationForMultipleTestType9.jsp"
	flush="true">
	<jsp:param name="resultEntryIndex" value="<%=resultEntryIndex%>" />
	<jsp:param name="resultEntryIndexForMultiple"
		value="<%=resultEntryIndexForMultiple%>" />
...
<%
	if (dgDetail.getSubInvestigation().getResultType()
			...
			request.setAttribute(
					...
					dgResultEntryHeader);
%>
<jsp:include page="resultValidationForMultipleTestType10.jsp"
	flush="true">
	<jsp:param name="resultEntryIndex" value="<%=resultEntryIndex%>" />
	<jsp:param name="resultEntryIndexForMultiple"
		value="<%=resultEntryIndexForMultiple%>" />
...
<%
	if (dgDetail.getSubInvestigation().getResultType()
			...
			request.setAttribute(
					...
					dgResultEntryHeader);
%>
<jsp:include page="resultValidationForMultipleTestType11.jsp"
	flush="true">
	<jsp:param name="resultEntryIndex" value="<%=resultEntryIndex%>" />
	<jsp:param name="resultEntryIndexForMultiple"
		value="<%=resultEntryIndexForMultiple%>" />
...
<%
	if (dgDetail.getSubInvestigation().getResultType()
			...
			request.setAttribute(
					...
					dgResultEntryHeader);
%>
<jsp:include page="resultValidationForMultipleTestType12.jsp"
	flush="true">
	<jsp:param name="resultEntryIndex" value="<%=resultEntryIndex%>" />
	<jsp:param name="resultEntryIndexForMultiple"
		value="<%=resultEntryIndexForMultiple%>" />
...
<%
	if (dgDetail.getSubInvestigation().getResultType()
			...
			request.setAttribute(
					...
					dgResultEntryHeader);
%>
<jsp:include page="resultValidationForMultipleTestType13.jsp"
	flush="true">
	<jsp:param name="resultEntryIndex" value="<%=resultEntryIndex%>" />
	<jsp:param name="resultEntryIndexForMultiple"
		value="<%=resultEntryIndexForMultiple%>" />
	...
	if (dgDetail.getSubInvestigation().getResultType()
		...
		List<DgFixedValue> fixedValList = new ArrayList<DgFixedValue>();
			...
			request.setAttribute(
					"dgResultEntryHeaderForMultipleTestType",
					dgResultEntryHeader);
			//changed by govind 25-10-2016 end 
			String invId=dgDetail.getSubInvestigation().getId().toString();
			System.out.println("jsp invId "+invId);
			if (fixedListMap.get(invId) != null) {
				fixedValList = (List<DgFixedValue>) fixedListMap.get(invId);
...
%>
<jsp:include page="resultValidationForMultipleTestType14.jsp"
	flush="true">
	<jsp:param name="resultEntryIndex" value="<%=resultEntryIndex%>" />
	<jsp:param name="resultEntryIndexForMultiple"
		value="<%=resultEntryIndexForMultiple%>" />
...
<%
	if (dgDetail.getSubInvestigation().getResultType()
			...
			request.setAttribute(
					...
					dgResultEntryHeader);
%>
<jsp:include page="resultValidationForMultipleTestType15.jsp"
	flush="true">
	<jsp:param name="resultEntryIndex" value="<%=resultEntryIndex%>" />
	<jsp:param name="resultEntryIndexForMultiple"
		value="<%=resultEntryIndexForMultiple%>" />
...
<%
	if (dgDetail.getSubInvestigation().getResultType()
			...
			request.setAttribute(
					...
					dgResultEntryHeader);
%>
<jsp:include page="resultValidationForMultipleTestType16.jsp"
	flush="true">
	<jsp:param name="resultEntryIndex" value="<%=resultEntryIndex%>" />
	<jsp:param name="resultEntryIndexForMultiple"
		value="<%=resultEntryIndexForMultiple%>" />
...
<%
	if (dgDetail.getSubInvestigation().getResultType()
			...
			request.setAttribute(
					...
					dgResultEntryHeader);
%>
<jsp:include page="resultValidationForMultipleTestType17.jsp"
	flush="true">
	<jsp:param name="resultEntryIndex" value="<%=resultEntryIndex%>" />
	<jsp:param name="resultEntryIndexForMultiple"
		value="<%=resultEntryIndexForMultiple%>" />
...
<%
	if (dgDetail.getSubInvestigation().getResultType()
			...
			request.setAttribute(
					...
					dgResultEntryHeader);
%>
<jsp:include page="resultValidationForMultipleTestType18.jsp"
	flush="true">
	<jsp:param name="resultEntryIndex" value="<%=resultEntryIndex%>" />
	<jsp:param name="resultEntryIndexForMultiple"
		value="<%=resultEntryIndexForMultiple%>" />
...
<%
	if (dgDetail.getSubInvestigation().getResultType()
			...
			request.setAttribute(
					...
					dgResultEntryHeader);
%>
<jsp:include page="resultValidationForMultipleTestType19.jsp"
	flush="true">
	<jsp:param name="resultEntryIndex" value="<%=resultEntryIndex%>" />
	<jsp:param name="resultEntryIndexForMultiple"
		value="<%=resultEntryIndexForMultiple%>" />
...
<%
	if (dgDetail.getSubInvestigation().getResultType()
			...
			request.setAttribute(
					...
					dgResultEntryHeader);
%>
<jsp:include page="resultValidationForMultipleTestType20.jsp"
	flush="true">
	<jsp:param name="resultEntryIndex" value="<%=resultEntryIndex%>" />
	<jsp:param name="resultEntryIndexForMultiple"
		value="<%=resultEntryIndexForMultiple%>" />
...
<%
	if (dgDetail.getSubInvestigation().getResultType()
			...
			request.setAttribute(
					...
					dgResultEntryHeader);
%>
<jsp:include page="resultValidationForMultipleTestType21.jsp"
	flush="true">
	<jsp:param name="resultEntryIndex" value="<%=resultEntryIndex%>" />
	<jsp:param name="resultEntryIndexForMultiple"
		value="<%=resultEntryIndexForMultiple%>" />
...
<%
	if (dgDetail.getSubInvestigation().getResultType()
			...
			request.setAttribute(
					...
					dgResultEntryHeader);
%>
<jsp:include page="resultValidationForMultipleTestType22.jsp"
	flush="true">
	<jsp:param name="resultEntryIndex" value="<%=resultEntryIndex%>" />
	<jsp:param name="resultEntryIndexForMultiple"
		value="<%=resultEntryIndexForMultiple%>" />
