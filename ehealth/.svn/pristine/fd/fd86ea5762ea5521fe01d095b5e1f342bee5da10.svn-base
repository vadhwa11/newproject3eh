 ...
 * 
 * @hibernate.class table="hr_mas_leave_type"
 */
...
public abstract class BaseHrMasLeaveType implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof jkt.hrms.masters.business.HrMasLeaveType)) {
			return false;
		} else {
			jkt.hrms.masters.business.HrMasLeaveType hrMasLeaveType = (jkt.hrms.masters.business.HrMasLeaveType) obj;
			if (null == this.getId() || null == hrMasLeaveType.getId()) {
				return false;
			} else {
				return (this.getId().equals(hrMasLeaveType.getId()));
			}
		}
	}
