...
public interface OPDHandlerService {
	...
	Map<String, Object> viewOpdTemplateDepartmentWise(Map<String, Object> parameterMap);

	Map<String, Object> viewOpdTemplateDepartmentWisePreNext(Map<String, Object> parameterMap);
	...
	Map<String, Object> filldoctoreName(int deptId);
	...
	Map<String, Object> getSnomedCTDetails(Map<String, Object> map);
	...
	Map<String, Object> showPopUpHistoryOfPastIllness(Map<String, Object> dataMap);
	...
	Map<String,Object>submitSecondOpinion(Map<String,Object>map);
	
	Map<String,Object>getDistrictHospital(Map<String,Object>map);
	
	Map<String,Object>getHospitalDepartment(Map<String,Object>map);
	
	Map<String,Object>getDoctorDepartment(Map<String,Object>map);
	...
	Map<String, Object> openImageForDisplay(int imageId,int hospitalId,int depId);
	...
	Map<String, Object> getOPClinicalReadViewList(Map<String, Object> mapForDS);
	...
	Map<String, Object> getPatientEpisodeList(String hinNo);
...
//added by govind 15-9-2016
	...
	Map<String, Object> saveGeneralProforma(Box box,
	...
	Map<String, Object> saveDiagnosticRecord(Map<String, Object> mapForDS,Box box, HttpServletRequest request);
	...
	Map<String, Object> saveOralMedicinePathology(Map<String, Object> mapForDS,Box box, HttpServletRequest request);
	...
	Map<String, Object> showOutSideResultEntryForAntenatal(
			Map<String, Object> requestParametersMap);

	Map<String, Object> saveOutSideResultEntryForAntenatal(
			Map<String, Object> requestParametersMap);
	...
	Map<String, Object> showDermatologyLeprosyProformaJsp(Map<String, Object> requestParametersMap);
	...
	Map<String, Object> showFamilyPlanningGynecologyJsp(Map<String, Object> famPlanGynMap);
	...
	Map<String, Object> getVitalDetails(Map<String, Object> map);
