...
public class FontManager {
	...
	public static void registerAllFont() throws IOException {
		...
		for (String fontFileName: fontFileNames) {
			//InputStream is = FontManager.class.getResourceAsStream("E:\\HCL\\UIDAI\\KYCDemoClient\\uidai-sample-gui-app\\src\\main\\resources\\font\\"+fontFileName);
			InputStream is = FontManager.class.getResourceAsStream("/font/"+fontFileName);
