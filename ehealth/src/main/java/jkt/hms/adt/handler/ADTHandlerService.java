...
public interface ADTHandlerService {
	...
	Map<String, Object> submitAdmissionInformation(
	...
	Map<String, Object> getPatientDetailsForTransfer(
	...
	Map<String, Object> getAttachPatientDetails(
	...
	Map<String, Object> checkForDuplicateOfAdnoInAttach(
	...
	Map<String, Object> checkOffLineAdNoDuplicationFor(
			Map<String, Object> dataMap);
	...
	/**
	 * code for hospital access Report
	 * such as State,District,Block,Village
