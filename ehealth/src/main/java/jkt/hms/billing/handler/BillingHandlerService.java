...
public interface BillingHandlerService {
	...
	int getChargeSlipNo(String string,int hospitalId);
	...
	List<Inpatient> getAdNo(String hin, int hopitalId);
	...
	Map<String, Object> getChargeCodeForMainCharge(int mainChargeId,
			int inpatientId);
