...
*/
	...
	int populateAvailableBlood(int bloodBankId,int comoponentId);
	...
	boolean validatePatientBloodRequest(Map<String, Object> detaMap);
	...
	Map<String, Object> showSearchPatientRecordsForVisitJsp(Map<String, Object> map);
	 ...
	 Map<String, Object> populateDonorRegistrationFrom(int deptId,
