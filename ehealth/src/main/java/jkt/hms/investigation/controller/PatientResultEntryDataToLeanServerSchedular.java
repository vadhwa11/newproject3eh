...
public class PatientResultEntryDataToLeanServerSchedular extends QuartzJobBean {

	private static final Logger logger = org.apache.log4j.Logger
			.getLogger(PatientResultEntryDataToLeanServerSchedular.class);
	...
	protected void executeInternal(JobExecutionContext context)
		...
		Map<String, Object> dataMap = investigationDataService
				.getPatientResultEntryDataForLeanServer();
	...
	private String hl7MessageSender(String msg, MasHospital hospital) {
		...
		try {
			...
			logger.debug("MalformedURLException in Patient Result Entry Data To Lean Server Schedular");
		} catch (ConnectException e) {
			logger.debug("Connection refused in Patient Result Entry Data To Lean Server Schedular");
		} catch (SocketTimeoutException e) {
			logger.debug("Connection timeout in Patient Result Entry Data To Lean Server Schedular");
		} catch (IOException e) {
			logger.debug("IOException in Patient Result Entry Data To Lean Server Schedular");
		}
