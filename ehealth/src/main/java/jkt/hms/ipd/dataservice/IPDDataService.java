...
public interface IPDDataService {
	...
	public Map<String, Object> patientAdmissionAccept(Map<String, Object> mapForDs);
	...
	// Added by Amit Das on 23-02-2016
		...
		Map<String, Object> getIPDNoFortDeathCertificate(String hinNo);
	...
	String updateCentralServerIPDData(CentralServerIpdData centralServerIpdData); 
	
	String updateLeanServerIPDData(LeanServerIpdData leanServerIpdData); 
	 ...
	 Map<String, Object> getMotherBabyDeatils(Map<String, Object> mapForDs);
		...
		Map<String, Object> getItemBatch(Box box);//added by govind 23-9-2016
		...
		Map<String, Object> showNeonatalSpecialityScreenJsp(int inpatientId,String motherHinNo, int hinId);
