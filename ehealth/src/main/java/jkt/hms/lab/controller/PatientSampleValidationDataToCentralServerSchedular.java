...
public class PatientSampleValidationDataToCentralServerSchedular extends
		QuartzJobBean {

	private static final Logger logger = org.apache.log4j.Logger
			.getLogger(PatientSampleValidationDataToCentralServerSchedular.class);
	...
	protected void executeInternal(JobExecutionContext context)
		...
		Map<String, Object> dataMap = labDataService
				.getPatientSampleValidationDataForCentralServer();
	...
	private String hl7MessageSender(String msg, MasHospital hospital) {
		...
		try {
			...
			logger.debug("Connection refused in Patient Sample Validation Data To Central Server Schedular");
		} catch (ConnectException e) {
			logger.debug("Connection refused in Patient Sample Validation Data To Central Server Schedular");
		} catch (SocketTimeoutException e) {
			logger.debug("Connection timeout in Patient Sample Validation Data To Central Server Schedular");
		} catch (IOException e) {
			logger.debug("Connection refused in Patient Sample Validation Data To Central Server Schedular");
		}
