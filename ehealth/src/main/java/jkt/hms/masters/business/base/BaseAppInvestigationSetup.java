...
/**
 * This is an object that contains data related to the app_investigation_setup table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="app_investigation_setup"
 */
...
public abstract class BaseAppInvestigationSetup  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hms.masters.business.AppInvestigationSetup)) return false;
		else {
			jkt.hms.masters.business.AppInvestigationSetup appInvestigationSetup = (jkt.hms.masters.business.AppInvestigationSetup) obj;
			if (null == this.getId() || null == appInvestigationSetup.getId()) return false;
			else return (this.getId().equals(appInvestigationSetup.getId()));
		}
	}
