...
/**
 * This is an object that contains data related to the central_server_sample_data table.
...
public abstract class BaseCentralServerSampleData  implements Serializable {

	public static String REF = "CentralServerSampleData";
	...
	// constructors
	public BaseCentralServerSampleData () {
		initialize();
	}
	 ...
	 */
	public BaseCentralServerSampleData (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hms.masters.business.CentralServerSampleData)) return false;
		else {
			jkt.hms.masters.business.CentralServerSampleData centralServerSampleData = (jkt.hms.masters.business.CentralServerSampleData) obj;
			if (null == this.getId() || null == centralServerSampleData.getId()) return false;
			else return (this.getId().equals(centralServerSampleData.getId()));
		}
	}
