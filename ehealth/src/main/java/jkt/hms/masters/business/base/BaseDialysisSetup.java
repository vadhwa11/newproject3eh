...
/**
 * This is an object that contains data related to the dialysis_setup table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="dialysis_setup"
 */

public abstract class BaseDialysisSetup  implements Serializable {

	public static String REF = "DialysisSetup";
	 ...
	 */
	public BaseDialysisSetup (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	/**
	 * Return the value associated with the column: break_from_time_2
	 */
	...
	/**
	 * Set the value related to the column: break_from_time_2
	 * @param breakFromTime2 the break_from_time_2 value
	 */
	...
	/**
	 * Return the value associated with the column: break_to_time_2
	 */
	...
	/**
	 * Set the value related to the column: break_to_time_2
	 * @param breakToTime2 the break_to_time_2 value
	 */
	...
	/**
	 * Return the value associated with the column: break_from_time_3
	 */
	...
	/**
	 * Set the value related to the column: break_from_time_3
	 * @param breakFromTime3 the break_from_time_3 value
	 */
	...
	/**
	 * Return the value associated with the column: break_to_time_3
	 */
	...
	/**
	 * Set the value related to the column: break_to_time_3
	 * @param breakToTime3 the break_to_time_3 value
	 */
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hms.masters.business.DialysisSetup)) return false;
		else {
			jkt.hms.masters.business.DialysisSetup dialysisSetup = (jkt.hms.masters.business.DialysisSetup) obj;
			if (null == this.getId() || null == dialysisSetup.getId()) return false;
			else return (this.getId().equals(dialysisSetup.getId()));
		}
	}
