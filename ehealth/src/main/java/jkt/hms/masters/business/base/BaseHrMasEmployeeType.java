...
public abstract class BaseHrMasEmployeeType implements Serializable {

	public static String REF = "HrMasEmployeeType";
	 ...
	 */
	public BaseHrMasEmployeeType(java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof jkt.hms.masters.business.HrMasEmployeeType)) {
			return false;
		} else {
			jkt.hms.masters.business.HrMasEmployeeType hrMasEmployeeType = (jkt.hms.masters.business.HrMasEmployeeType) obj;
			if (null == this.getId() || null == hrMasEmployeeType.getId()) {
				return false;
			} else {
				return (this.getId().equals(hrMasEmployeeType.getId()));
			}
		}
	}
