...
/**
 * This is an object that contains data related to the ip_admission_for_server table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="ip_admission_for_server"
 */

public abstract class BaseIpAdmissionForServer  implements Serializable {

	public static String REF = "IpAdmissionForServer";
	...
	// constructors
	public BaseIpAdmissionForServer () {
		initialize();
	}
	 ...
	 */
	public BaseIpAdmissionForServer (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hms.masters.business.IpAdmissionForServer)) return false;
		else {
			jkt.hms.masters.business.IpAdmissionForServer ipAdmissionForServer = (jkt.hms.masters.business.IpAdmissionForServer) obj;
			if (null == this.getId() || null == ipAdmissionForServer.getId()) return false;
			else return (this.getId().equals(ipAdmissionForServer.getId()));
		}
	}
