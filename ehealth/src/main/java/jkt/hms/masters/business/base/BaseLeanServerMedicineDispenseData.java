...
/**
 * This is an object that contains data related to the lean_server_medicine_dispense_data table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="lean_server_medicine_dispense_data"
 */

public abstract class BaseLeanServerMedicineDispenseData  implements Serializable {

	public static String REF = "LeanServerMedicineDispenseData";
	...
	// constructors
	public BaseLeanServerMedicineDispenseData () {
		initialize();
	}
	 ...
	 */
	public BaseLeanServerMedicineDispenseData (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hms.masters.business.LeanServerMedicineDispenseData)) return false;
		else {
			jkt.hms.masters.business.LeanServerMedicineDispenseData leanServerMedicineDispenseData = (jkt.hms.masters.business.LeanServerMedicineDispenseData) obj;
			if (null == this.getId() || null == leanServerMedicineDispenseData.getId()) return false;
			else return (this.getId().equals(leanServerMedicineDispenseData.getId()));
		}
	}
