...
/**
 * This is an object that contains data related to the mas_house_keeping_frequency table.
...
public abstract class BaseMasHouseKeepingFrequency  implements Serializable {

	public static String REF = "MasHouseKeepingFrequency";
	...
	// constructors
	public BaseMasHouseKeepingFrequency () {
		initialize();
	}
	 ...
	 */
	public BaseMasHouseKeepingFrequency (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hms.masters.business.MasHouseKeepingFrequency)) return false;
		else {
			jkt.hms.masters.business.MasHouseKeepingFrequency masHouseKeepingFrequency = (jkt.hms.masters.business.MasHouseKeepingFrequency) obj;
			if (null == this.getId() || null == masHouseKeepingFrequency.getId()) return false;
			else return (this.getId().equals(masHouseKeepingFrequency.getId()));
		}
	}
