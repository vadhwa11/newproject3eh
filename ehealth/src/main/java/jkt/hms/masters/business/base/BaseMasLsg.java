...
/**
 * This is an object that contains data related to the mas_lsg table.
...
public abstract class BaseMasLsg  implements Serializable {

	public static String REF = "MasLsg";
	 ...
	 */
	public BaseMasLsg (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	private jkt.hms.masters.business.MasLsgType lsgType;
	...
	/**
	 * Return the value associated with the column: lsg_type_id
	 */
	public jkt.hms.masters.business.MasLsgType getLsgType () {
		return lsgType;
	}

	/**
	 * Set the value related to the column: lsg_type_id
	 * @param lsgType the lsg_type_id value
	 */
	public void setLsgType (jkt.hms.masters.business.MasLsgType lsgType) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hms.masters.business.MasLsg)) return false;
		else {
			jkt.hms.masters.business.MasLsg masLsg = (jkt.hms.masters.business.MasLsg) obj;
			if (null == this.getId() || null == masLsg.getId()) return false;
			else return (this.getId().equals(masLsg.getId()));
		}
	}
