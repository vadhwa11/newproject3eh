...
public abstract class BaseMasOpdFrequency  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hms.masters.business.MasOpdFrequency)) return false;
		else {
			jkt.hms.masters.business.MasOpdFrequency masOpdFrequency = (jkt.hms.masters.business.MasOpdFrequency) obj;
			if (null == this.getId() || null == masOpdFrequency.getId()) return false;
			else return (this.getId().equals(masOpdFrequency.getId()));
		}
	}
