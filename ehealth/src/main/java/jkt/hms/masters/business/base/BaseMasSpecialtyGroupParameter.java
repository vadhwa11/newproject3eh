...
/**
 * This is an object that contains data related to the mas_specialty_group_parameter table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="mas_specialty_group_parameter"
 */

public abstract class BaseMasSpecialtyGroupParameter  implements Serializable {

	public static String REF = "MasSpecialtyGroupParameter";
	...
	// constructors
	public BaseMasSpecialtyGroupParameter () {
		initialize();
	}
	 ...
	 */
	public BaseMasSpecialtyGroupParameter (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hms.masters.business.MasSpecialtyGroupParameter)) return false;
		else {
			jkt.hms.masters.business.MasSpecialtyGroupParameter masSpecialtyGroupParameter = (jkt.hms.masters.business.MasSpecialtyGroupParameter) obj;
			if (null == this.getId() || null == masSpecialtyGroupParameter.getId()) return false;
			else return (this.getId().equals(masSpecialtyGroupParameter.getId()));
		}
	}
