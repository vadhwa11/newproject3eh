...
/**
 * This is an object that contains data related to the opd_phototherapy_proforma_detail table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="opd_phototherapy_proforma_detail"
 */

public abstract class BaseOpdPhototherapyProformaDetail  implements Serializable {

	public static String REF = "OpdPhototherapyProformaDetail";
	...
	public static String PROP_ADDITIONAL_FEATURE = "AdditionalFeature";
	...
	public static String PROP_LESION_VALUE = "LesionValue";
	public static String PROP_PARAMETER_NAME = "ParameterName";


	// constructors
	public BaseOpdPhototherapyProformaDetail () {
		initialize();
	}
	 ...
	 */
	public BaseOpdPhototherapyProformaDetail (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	private java.lang.String lesionValue;
	...
	private java.lang.String additionalFeature;
     ...
     *  column="phototherapy_proforma_detail_id"
     */
	...
	/**
	 * Return the value associated with the column: lesion_value
	 */
	public java.lang.String getLesionValue () {
		return lesionValue;
	}

	/**
	 * Set the value related to the column: lesion_value
	 * @param lesionValue the lesion_value value
	 */
	public void setLesionValue (java.lang.String lesionValue) {
		this.lesionValue = lesionValue;
	}
	...
	/**
	 * Return the value associated with the column: additional_feature
	 */
	public java.lang.String getAdditionalFeature () {
		return additionalFeature;
	}

	/**
	 * Set the value related to the column: additional_feature
	 * @param additionalFeature the additional_feature value
	 */
	public void setAdditionalFeature (java.lang.String additionalFeature) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hms.masters.business.OpdPhototherapyProformaDetail)) return false;
		else {
			jkt.hms.masters.business.OpdPhototherapyProformaDetail opdPhototherapyProformaDetail = (jkt.hms.masters.business.OpdPhototherapyProformaDetail) obj;
			if (null == this.getId() || null == opdPhototherapyProformaDetail.getId()) return false;
			else return (this.getId().equals(opdPhototherapyProformaDetail.getId()));
		}
	}
