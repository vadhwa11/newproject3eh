...
/**
 * This is an object that contains data related to the opd_speciality_details table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="opd_speciality_details"
 */

public abstract class BaseOpdSpecialityDetails  implements Serializable {

	public static String REF = "OpdSpecialityDetails";
	...
	public static String PROP_STUDENT_REGISTRATION = "StudentRegistration";


	// constructors
	public BaseOpdSpecialityDetails () {
		initialize();
	}
	 ...
	 */
	public BaseOpdSpecialityDetails (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	private jkt.hms.masters.business.PhStudentRegistration studentRegistration;
     ...
     *  column="opd_speciality_details_id"
     */
	 ...
	 */
	public jkt.hms.masters.business.PhStudentRegistration getStudentRegistration () {
		return studentRegistration;
	}

	/**
	 * Set the value related to the column: student_id
	 * @param studentRegistration the student_id value
	 */
	public void setStudentRegistration (jkt.hms.masters.business.PhStudentRegistration studentRegistration) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hms.masters.business.OpdSpecialityDetails)) return false;
		else {
			jkt.hms.masters.business.OpdSpecialityDetails opdSpecialityDetails = (jkt.hms.masters.business.OpdSpecialityDetails) obj;
			if (null == this.getId() || null == opdSpecialityDetails.getId()) return false;
			else return (this.getId().equals(opdSpecialityDetails.getId()));
		}
	}
