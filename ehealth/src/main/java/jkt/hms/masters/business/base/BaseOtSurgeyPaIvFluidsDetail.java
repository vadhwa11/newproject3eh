...
/**
 * This is an object that contains data related to the ot_surgey_pa_iv_fluids_detail table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="ot_surgey_pa_iv_fluids_detail"
 */
...
public abstract class BaseOtSurgeyPaIvFluidsDetail  implements Serializable {
	...
	/**
	 * Return the value associated with the column: surgey_pa_iv_fluids_detail_volume
	 */
	 ...
	 * @param surgeyPaIvFluidsDetailVolume the surgey_pa_iv_fluids_detail_volume value
	 */
	public void setSurgeyPaIvFluidsDetailVolume (java.lang.Integer surgeyPaIvFluidsDetailVolume) {
	...
	/**
	 * Return the value associated with the column: surgey_pa_iv_fluids_detail_fluids_name
	 */
	...
	/**
	 * Set the value related to the column: surgey_pa_iv_fluids_detail_fluids_name
	 * @param surgeyPaIvFluidsDetailFluidsName the surgey_pa_iv_fluids_detail_fluids_name value
	 */
	public void setSurgeyPaIvFluidsDetailFluidsName (java.lang.String surgeyPaIvFluidsDetailFluidsName) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hms.masters.business.OtSurgeyPaIvFluidsDetail)) return false;
		else {
			...
			if (null == this.getId() || null == otSurgeyPaIvFluidsDetail.getId()) return false;
			else return (this.getId().equals(otSurgeyPaIvFluidsDetail.getId()));
		}
	}
