...
public abstract class BaseSct2DescriptionPK implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hms.masters.business.Sct2DescriptionPK)) return false;
		else {
			jkt.hms.masters.business.Sct2DescriptionPK mObj = (jkt.hms.masters.business.Sct2DescriptionPK) obj;
