...
public abstract class BaseSpGroupParameterM  implements Serializable {

	public static String REF = "SpGroupParameterM";
	 ...
	 */
	public BaseSpGroupParameterM (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hms.masters.business.SpGroupParameter)) return false;
			...
			jkt.hms.masters.business.SpGroupParameter spGroupParameterM = (jkt.hms.masters.business.SpGroupParameter) obj;
			if (null == this.getId() || null == spGroupParameterM.getId()) return false;
			else return (this.getId().equals(spGroupParameterM.getId()));
		}
	}
