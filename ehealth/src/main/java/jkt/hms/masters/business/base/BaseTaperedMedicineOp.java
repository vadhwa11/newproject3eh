...
/**
 * This is an object that contains data related to the tapered_medicine_op table.
...
public abstract class BaseTaperedMedicineOp  implements Serializable {

	public static String REF = "TaperedMedicineOp";
	 ...
	 */
	public BaseTaperedMedicineOp (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hms.masters.business.TaperedMedicineOp)) return false;
		else {
			jkt.hms.masters.business.TaperedMedicineOp taperedMedicineOp = (jkt.hms.masters.business.TaperedMedicineOp) obj;
			if (null == this.getId() || null == taperedMedicineOp.getId()) return false;
			else return (this.getId().equals(taperedMedicineOp.getId()));
		}
	}
