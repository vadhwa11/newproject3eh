...
public abstract class BaseUsers  implements Serializable {
	...
	public static String PROP_CURRENT_LAB = "CurrentLab";
	public static String PROP_LAST_CHG_TIME = "LastChgTime";
	public static String PROP_DEPARTMENT = "Department";
	public static String PROP_PACS_DESIGNATION = "PacsDesignation";
	public static String PROP_USER_TYPE = "UserType";
	public static String PROP_PACS_USERNAME = "PacsUsername";
	public static String PROP_CURRENT_COUNTER = "CurrentCounter";
	public static String PROP_HOSPITAL = "Hospital";
	public static String PROP_PACS_PASSWORD = "PacsPassword";
	public static String PROP_AVAILABLE_TODAY = "AvailableToday";
	...
	private java.lang.String pacsUsername;
	private java.lang.String pacsPassword;
	private java.lang.String pacsDesignation;
	private java.lang.String loginStatus;
	private java.lang.String availableToday;

	// many to one
	private jkt.hms.masters.business.MasServiceCentreCounter currentCounter;
	private jkt.hms.masters.business.MasSubChargecode currentLab;
	...
	/**
	 * Return the value associated with the column: pacs_username
	 */
	public java.lang.String getPacsUsername () {
		return pacsUsername;
	}

	/**
	 * Set the value related to the column: pacs_username
	 * @param pacsUsername the pacs_username value
	 */
	public void setPacsUsername (java.lang.String pacsUsername) {
	...
	/**
	 * Return the value associated with the column: pacs_password
	 */
	public java.lang.String getPacsPassword () {
		return pacsPassword;
	}

	/**
	 * Set the value related to the column: pacs_password
	 * @param pacsPassword the pacs_password value
	 */
	public void setPacsPassword (java.lang.String pacsPassword) {
	...
	/**
	 * Return the value associated with the column: pacs_designation
	 */
	public java.lang.String getPacsDesignation () {
		return pacsDesignation;
	}

	/**
	 * Set the value related to the column: pacs_designation
	 * @param pacsDesignation the pacs_designation value
	 */
	public void setPacsDesignation (java.lang.String pacsDesignation) {
	...
	/**
	 * Return the value associated with the column: available_today
	 */
	public java.lang.String getAvailableToday () {
		return availableToday;
	}

	/**
	 * Set the value related to the column: available_today
	 * @param availableToday the available_today value
	 */
	public void setAvailableToday (java.lang.String availableToday) {
	...
	/**
	 * Return the value associated with the column: current_counter_id
	 */
	public jkt.hms.masters.business.MasServiceCentreCounter getCurrentCounter () {
		return currentCounter;
	}

	/**
	 * Set the value related to the column: current_counter_id
	 * @param currentCounter the current_counter_id value
	 */
	public void setCurrentCounter (jkt.hms.masters.business.MasServiceCentreCounter currentCounter) {
	...
	/**
	 * Return the value associated with the column: current_lab_id
	 */
	public jkt.hms.masters.business.MasSubChargecode getCurrentLab () {
		return currentLab;
	}

	/**
	 * Set the value related to the column: current_lab_id
	 * @param currentLab the current_lab_id value
	 */
	public void setCurrentLab (jkt.hms.masters.business.MasSubChargecode currentLab) {
	...
	/**
	 * Return the value associated with the column: last_login_dept
	 */
	...
	/**
	 * Set the value related to the column: last_login_dept
	 * @param department the last_login_dept value
	 */
