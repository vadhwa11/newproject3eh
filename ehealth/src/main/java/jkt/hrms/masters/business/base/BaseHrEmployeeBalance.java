...
/**
 * This is an object that contains data related to the hr_employee_balance
 * table. Do not modify this class because it will be overwritten if the
 * configuration file related to this class is modified.
 * 
 * @hibernate.class table="hr_employee_balance"
 */
...
public abstract class BaseHrEmployeeBalance implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof jkt.hrms.masters.business.HrEmployeeBalance)) {
			return false;
		} else {
			jkt.hrms.masters.business.HrEmployeeBalance hrEmployeeBalance = (jkt.hrms.masters.business.HrEmployeeBalance) obj;
			if (null == this.getId() || null == hrEmployeeBalance.getId()) {
				return false;
			} else {
				return (this.getId().equals(hrEmployeeBalance.getId()));
			}
		}
	}
