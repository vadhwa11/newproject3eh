 ...
 * 
 * @hibernate.class table="hr_mas_institute"
 */
...
public abstract class BaseHrMasInstitute implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof jkt.hrms.masters.business.HrMasInstitute)) {
			return false;
		} else {
			jkt.hrms.masters.business.HrMasInstitute hrMasInstitute = (jkt.hrms.masters.business.HrMasInstitute) obj;
			if (null == this.getId() || null == hrMasInstitute.getId()) {
				return false;
			} else {
				return (this.getId().equals(hrMasInstitute.getId()));
			}
		}
	}
