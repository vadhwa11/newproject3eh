...
/**
 * This is an object that contains data related to the hr_mas_leave_status
 * table. Do not modify this class because it will be overwritten if the
 * configuration file related to this class is modified.
 * 
 * @hibernate.class table="hr_mas_leave_status"
 */
...
public abstract class BaseHrMasLeaveStatus implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof jkt.hrms.masters.business.HrMasLeaveStatus)) {
			return false;
		} else {
			jkt.hrms.masters.business.HrMasLeaveStatus hrMasLeaveStatus = (jkt.hrms.masters.business.HrMasLeaveStatus) obj;
			if (null == this.getId() || null == hrMasLeaveStatus.getId()) {
				return false;
			} else {
				return (this.getId().equals(hrMasLeaveStatus.getId()));
			}
		}
	}
