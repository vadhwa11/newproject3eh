 ...
 * hr_mas_leave_type_mediator_history table. Do not modify this class because it
 * will be overwritten if the configuration file related to this class is
 * modified.
 * 
 * @hibernate.class table="hr_mas_leave_type_mediator_history"
 */
...
public abstract class BaseHrMasLeaveTypeMediatorHistory implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof jkt.hrms.masters.business.HrMasLeaveTypeMediatorHistory)) {
			return false;
		} else {
			jkt.hrms.masters.business.HrMasLeaveTypeMediatorHistory hrMasLeaveTypeMediatorHistory = (jkt.hrms.masters.business.HrMasLeaveTypeMediatorHistory) obj;
			if (null == this.getId()
					|| null == hrMasLeaveTypeMediatorHistory.getId()) {
				return false;
			} else {
				return (this.getId().equals(hrMasLeaveTypeMediatorHistory
						.getId()));
			}
		}
	}
