...
/**
 * This is an object that contains data related to the hr_mas_reimbersement
 * table. Do not modify this class because it will be overwritten if the
 * configuration file related to this class is modified.
 * 
 * @hibernate.class table="hr_mas_reimbersement"
 */
...
public abstract class BaseHrMasReimbersement implements Serializable {
	 ...
	 * 
	 * @hibernate.id generator-class="native" column="reimb_id"
	 */
	 ...
	 * 
	 * @param maxTaxExemption
	 *            the max_tax_exemption value
	 */
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof jkt.hrms.masters.business.HrMasReimbersement)) {
			return false;
		} else {
			jkt.hrms.masters.business.HrMasReimbersement hrMasReimbersement = (jkt.hrms.masters.business.HrMasReimbersement) obj;
			if (null == this.getId() || null == hrMasReimbersement.getId()) {
				return false;
			} else {
				return (this.getId().equals(hrMasReimbersement.getId()));
			}
		}
	}
