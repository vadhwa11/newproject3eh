...
/**
 * This is an object that contains data related to the hr_prj_site_calendar table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="hr_prj_site_calendar"
 */

public abstract class BaseHrPrjSiteCalendar  implements Serializable {

	public static String REF = "HrPrjSiteCalendar";
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hrms.masters.business.HrPrjSiteCalendar)) return false;
		else {
			jkt.hrms.masters.business.HrPrjSiteCalendar hrPrjSiteCalendar = (jkt.hrms.masters.business.HrPrjSiteCalendar) obj;
			if (null == this.getId() || null == hrPrjSiteCalendar.getId()) return false;
			else return (this.getId().equals(hrPrjSiteCalendar.getId()));
		}
	}
