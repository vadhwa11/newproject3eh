...
public abstract class BaseMasParameterMaintenance implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof jkt.hrms.masters.business.MasParameterMaintenance)) {
			return false;
		} else {
			jkt.hrms.masters.business.MasParameterMaintenance masParameterMaintenance = (jkt.hrms.masters.business.MasParameterMaintenance) obj;
