...
/**
 * This is an object that contains data related to the temp_trvsub table.
...
public abstract class BaseTempTrvsub  implements Serializable {

	public static String REF = "TempTrvsub";
	 ...
	 */
	public BaseTempTrvsub (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hrms.masters.business.TempTrvsub)) return false;
		else {
			jkt.hrms.masters.business.TempTrvsub tempTrvsub = (jkt.hrms.masters.business.TempTrvsub) obj;
			if (null == this.getId() || null == tempTrvsub.getId()) return false;
			else return (this.getId().equals(tempTrvsub.getId()));
		}
	}
