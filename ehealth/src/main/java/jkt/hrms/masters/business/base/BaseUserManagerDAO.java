...
import jkt.hrms.masters.business.dao.iface.UserManagerDAO;
 ...
 */
public abstract class BaseUserManagerDAO extends
		jkt.hrms.masters.business.dao._RootDAO {
	...
	public static UserManagerDAO getInstance() {
		if (null == instance) {
			instance = new jkt.hrms.masters.business.dao.UserManagerDAO();
		}
		return instance;
	}

	public Class getReferenceClass() {
		return jkt.hrms.masters.business.UserManager.class;
	}
	...
	/**
	 * Cast the object as a jkt.hrms.masters.business.UserManager
	 */
	public jkt.hrms.masters.business.UserManager cast(Object object) {
		return (jkt.hrms.masters.business.UserManager) object;
	}

	public jkt.hrms.masters.business.UserManager get(java.lang.Integer key) {
		return (jkt.hrms.masters.business.UserManager) get(getReferenceClass(),
				key);
	}
	...
	public jkt.hrms.masters.business.UserManager load(java.lang.Integer key) {
		return (jkt.hrms.masters.business.UserManager) load(
	...
	public jkt.hrms.masters.business.UserManager loadInitialize(
			java.lang.Integer key, Session s) {
		jkt.hrms.masters.business.UserManager obj = load(key, s);
	 ...
	 */
	public java.lang.Integer save(
			jkt.hrms.masters.business.UserManager userManager, Session s) {
	 ...
	 * </ul>
	 */
	public void refresh(jkt.hrms.masters.business.UserManager userManager,
			Session s) {
