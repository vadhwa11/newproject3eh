...
public abstract class _BaseRootDAO {
	...
	public static void initialize(String configFileName) {
		jkt.hrms.recruitment.masters.business.dao._RootDAO.initialize(
				configFileName,
				jkt.hrms.recruitment.masters.business.dao._RootDAO
						.getNewConfiguration(null));
	}
	...
	public static void initialize(String configFileName,
		...
		if (null != sessionFactoryMap
			...
			if (null == configFileName) {
				...
				jkt.hrms.recruitment.masters.business.dao._RootDAO
						.setSessionFactory(configFileName,
								configuration.buildSessionFactory());
			}
		}
	}
	...
	public SessionFactory getSessionFactory(String configFileName) {
		...
		SessionFactory sf = sessionFactoryMap.get(configFileName);
		if (null == sf) {
