...
/**
 * This is an object that contains data related to the fa_account_hospital_type_mapping table.
...
public abstract class BaseFaAccountHospitalTypeMapping  implements Serializable {

	public static String REF = "FaAccountHospitalTypeMapping";
	...
	// constructors
	public BaseFaAccountHospitalTypeMapping () {
		initialize();
	}
	 ...
	 */
	public BaseFaAccountHospitalTypeMapping (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof jkt.hms.masters.business.FaAccountHospitalTypeMapping)) return false;
		else {
			jkt.hms.masters.business.FaAccountHospitalTypeMapping faAccountHospitalTypeMapping = (jkt.hms.masters.business.FaAccountHospitalTypeMapping) obj;
			if (null == this.getId() || null == faAccountHospitalTypeMapping.getId()) return false;
			else return (this.getId().equals(faAccountHospitalTypeMapping.getId()));
		}
	}
