 ...
 *
 */
public class SOE_1447752570411_686005 extends JREvaluator
{
    ...
    public Object evaluate(int id) throws Throwable
    {
        ...
        switch (id)
        {
            ...
            case 13 : 
            {
                value = (java.math.BigDecimal)((((java.math.BigDecimal)field_op_amount0.getValue()).add(((java.math.BigDecimal)field_cr_amount0.getValue()).add(((java.math.BigDecimal)field_cr.getValue()))).substract(((java.math.BigDecimal)field_dr_amount0.getValue()).add(((java.math.BigDecimal)field_dr_amount1.getValue())))));//$JR_EXPR_ID=13$
                break;
            }
            case 14 : 
            {
