...
<form name="pfStatement" method="post" action="" >
<div class="titleBg"> <h2>PF Statement</h2></div>
<div class="clear"></div>
<div class="Block">
...
<input name="Ok" type="button" class="button" value="OK" onclick="submitForm('pfStatement','report?method=printPFStatement');"/>
