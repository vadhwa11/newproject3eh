...
<script>
	...
	function showReport()
	{
		if (document.TenderSingleQuotationForm.<%=TENDER_NO%>.value=="" || document.TenderSingleQuotationForm.<%=TENDER_SUPPLIER_GROUP_ID %>.value=="")
		{
		alert('Pl. Check Your Inputs (Tender No & Group)');
		return;
		}
	
		document.TenderSingleQuotationForm.method="post";
		submitForm('TenderSingleQuotationForm','tender?method=generateTenderSingleQuotationReport');
	}
	function onChangeTender()
	{
		//document.TenderSingleQuotationForm.<%=TENDER_SUPPLIER_GROUP_ID%>.options.length=1;
		document.TenderSingleQuotationForm.method="post";
		submitForm('TenderSingleQuotationForm','tender?method=showSingleQuotationJsp&groupId='+document.TenderSingleQuotationForm.<%=TENDER_SUPPLIER_GROUP_ID%>.value);
	}
</script>
<div class="titleBg">
<h2>Tender - Single Quotation</h2>
</div>
<form name="TenderSingleQuotationForm">
...
<h4>Tender - Single Quotation</h4>
<div class="clear"></div>
<div class="Block"><label class="large">Group</label> <select
