...
<label>IP No & Admission date </label> 
	...
	<% if (inpatientList!=null && inpatientList.size() > 0 )
	     	{
				...
				while (itr.hasNext())
				{
					...
					{
					%>
	<option value="<%=inpatient.getAdNo()%>"><%=inpatient.getAdNo() + " " + HMSUtil.convertDateToStringTypeDateOnly(inpatient.getDateOfAddmission())%>
	</option>
