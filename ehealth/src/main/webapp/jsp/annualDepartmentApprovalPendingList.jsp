...
<form name="departmentWiseIndentApprovalPendingList" method="post">
<div class="titleBg">
<h2>Pending List For Department Annual Indent Approval </h2>
</div>
...
<table border="0" cellpadding="0" cellspacing="0">
					...
					%>
					<tr onclick="submitForm('departmentWiseIndentApprovalPendingList','stores?method=showAnnualDepartmentIndentCreationApproval&storeInternalMId=<%=storeInternalIndentM.getId() %>');">
