...
<form name="districtWiseIndentApprovalPendingList" method="post">
<div class="titleBg">
<h2>Annual District Wise Indent Approval Pending List</h2>
</div>
...
<table border="0" cellpadding="0" cellspacing="0">
					...
					%>
					<tr onclick="submitForm('districtWiseIndentApprovalPendingList','stores?method=showDistrictAnnualIndentApprovalJsp&storeInternalMId=<%=storeInternalIndentM.getId() %>');">
