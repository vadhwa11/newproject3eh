...
<form name="annualIndentTransferToKMSClPendingList" method="post">
<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
<div class="titleBg">
<h2>Annual  Indent Transfer to KMSCL Approval Pending List</h2>
</div>
...
<table border="0" cellpadding="0" cellspacing="0">
				...
				<%-- 		<th>Requested By</th>--%>
					...
					%>
					<tr onclick="submitForm('annualIndentTransferToKMSClPendingList','stores?method=showAnnualIndentTransferToKMSCLJsp&storeInternalMId=<%=storeInternalIndentM.getId() %>');">
