...
<div class="clear"></div>
<input type="button" name="Submit" id="searchButton" onclick="submitForm('patientSearch','/hms/hms/appointment?method=patientAppointmentRegisterList');" value="Search" class="button" accesskey="a" /> 
<input name="a"	type="reset" class="buttonHighlight" value="Reset" />
<div class="clear"></div>
