...
<input type="text" name="assetName" id="assetName" value="ABC" validate="Asset Name,metachar,no" class="textbox_size20" MAXLENGTH="32" tabindex="1"/> 
...
<textarea rows="" cols="" name="reason" maxlength="100"  onkeyup="return ismaxlength(this)" tabindex="1" class="textareaMediua">reason</textarea>
<div class="clear"></div>

<label>Asset Require Date<span>*</span></label> 
<input type="text" name="assetRequireDate" value="01/01/2015" class="date" maxlength="30" tabindex=1 />
...
<option value="AssCat">AssCat</option>
</select>
...
<label>Remarks</label>
<textarea name="remarks" id="remarks" maxlength="100"  validate="Remarks,string,no" tabindex="1" onkeyup="return ismaxlength(this)" class="textareaMediua"></textarea>
</div>
<div class="Block">

<h4>Approve/Reject Details</h4>
<div class="clear"></div>
<label><span>* </span> Status</label>
	<select onchange="forword(this.value);">
...
<input type="button" name="add" id="addbutton"	value="Back" class="button" onclick="submitFormForButton('assestDetails','procurement?method=showApproveTransferOfAssetJsp&'+csrfTokenName+'='+csrfTokenValue);"	accesskey="a" tabindex="1" />
