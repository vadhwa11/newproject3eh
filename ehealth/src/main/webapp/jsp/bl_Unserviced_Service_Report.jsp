...
<div class="titleBg">
<h2>Unserviced Service Report</h2>
</div>
<div class="Block">
...
<input type="button" name="OK" id="addbutton" value="Print" class="button" onClick="if(check()){submitForm('cashRegister','opBilling?method=printUnservicedServiceReport')};" accesskey="a" tabindex=1 />
