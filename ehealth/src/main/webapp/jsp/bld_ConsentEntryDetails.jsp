...
<form name="consentEntry" action="" method="post">
...
<img id="" src="/hms/jsp/images/cal.gif" 	width="16" height="16" border="0"onclick="setdate('<%=currentDate %>',document.consentEntry.<%=DATE%>,event)"	validate="Pick a date" tabindex="1" />
<div class="clear"></div>
<label>Address</label>
<textarea rows="5" cols="5" name="address" id="address" tabindex="1" class="textareaMediua"></textarea>
<label>Consent Cause</label>
<textarea rows="5" cols="5" name="cause" id="cause" tabindex="1" class="textareaMediua"></textarea>
...
class="button" onclick="submitForm('consentEntry','bloodBank?method=submitConsentForBlood');" accesskey="a" tabindex=1 />
