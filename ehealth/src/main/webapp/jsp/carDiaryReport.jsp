...
<%
	...
	%>
<div class="titleBg">
<h2>Car Diary Entry Register</h2>
</div>
...
<div class="clear"></div>
<input type="button" name="OK" value="OK" class="button" onClick="submitForm('accomReg','laundry?method=generateCarDiaryReport','validateFromToDate');" />
