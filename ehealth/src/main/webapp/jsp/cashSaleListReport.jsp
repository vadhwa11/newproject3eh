...
<label><span>*</span>To Date </label> <input type="text"
	name="<%= TO_DATE %>" class="date" maxlength="30" tabindex=1 /> <img
...
<input type="button" class="buttonBig" value="Generate Report"
	onclick="submitForm('stockRegisterReport','/hms/hms/billing?method=printReportForBilling');">
</input>
<div class="clear"></div>
</div>
</form>