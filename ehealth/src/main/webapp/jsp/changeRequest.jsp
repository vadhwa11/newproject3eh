...
<form name="changeRequest" method="post" action="">
<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
<div class="Block">
<div class="clear"></div>
 <div class="division"></div>
 
<label>Date</label> <input  id="date" name="date" class="auto" type="text" validate="Date,yes" readonly="readonly" value=""  size="10"/>
<img width="16" height="16" border="0" onclick="javascript:setdate('',document.changeRequest.date,event)"  src="/hms/jsp/images/cal.gif">
</img>	
  ...
  <div id="testDiv">
    ...
    <select name="locality" id="locality" onchange="seleclLoc(this.value)" validate="locality,string,yes">
             	<option value="0">Select</option>
                  <%for(PhMasLocality md : phMasLocalityList){ %>
            	 <option value="<%=md.getId() %>"><%=md.getLocalityName()%></option>
   					<%} %>
	</select>
