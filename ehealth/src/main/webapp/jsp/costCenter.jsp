...
<input type="hidden" name="colCode" value="cost_center_code">
<input type="hidden" name="colName" value="cost_center_name">
<input type="button" name="Report" value="Generate Report"
	...
	name="<%=JASPER_FILE_NAME%>" value="Mas_cost_center"></form>
</div>
</div>
...
<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"><input
	...
	type="hidden" name="<%=POJO_PROPERTY_NAME %>" value="CostCenterName"><input
	type="hidden" name="<%=JSP_NAME %>" value="costCenter"><input
	type="hidden" name="pojoPropertyCode" value="CostCenterCode">
<div class="paddingTop5"></div>
<div class="clear"></div>
<div class="Block">
<label><span>*</span> Cost Center Code</label>
<input id="codeId" type="text" name="<%= CODE%>" value=""
	validate="Cost Center Code,string,yes" 
	MAXLENGTH="8" tabindex=1 />
	<label><span>*</span> Cost Center Name</label>
	<input type="text" name="<%= SEARCH_NAME %>" value=""	validate="Cost Center Name,string,yes" MAXLENGTH="30" tabindex=1
	onkeypress="return submitenter(this,event,'hospital?method=addCostCenter')" /><script>
