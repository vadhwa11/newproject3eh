...
<input type="button" class="buttonBig" value="Generate Report New"	onclick="submitForm('stockRegisterReport','/hms/hms/stores?method=printStockRegisterDatewiseIssuePharmacyReport');"></input>
<div class="clear"></div>
<div class="division"></div>
<div class="clear"></div>
