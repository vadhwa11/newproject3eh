...
<div class="clear"></div>
<div class="Block">
<label><span>*</span> DC Code </label> 
<input id="codeId" type="text" name="<%= CODE%>" value="" validate="DC Code,string,yes" class="textbox_size20" MAXLENGTH="8" / tabindex=1>
<label><span>*</span> DC Name </label> 
<input type="text" name="<%= SEARCH_NAME %>" value="" validate="DC Name,string,yes" class="textbox_size20" MAXLENGTH="30" / tabindex=1 onkeypress="return submitenter(this,event,'laboratory?method=addDiagnosisConclusion')">
<script>
...
<input type="button" name="edit" id="editbutton" value="Update" style="display: none;" class="button" onClick="submitForm('diagnosisConclusion','laboratory?method=editDiagnosisConclusion')" accesskey="u" tabindex=1 /> 
<input type="button" name="Delete" id="deletebutton" value="Activate" style="display: none;" class="button" onClick="submitForm('diagnosisConclusion','laboratory?method=deleteDiagnosisConclusion&flag='+this.value)" accesskey="d" tabindex=1 /> 
