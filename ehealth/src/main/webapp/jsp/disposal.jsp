...
<form name="disposal" method="post" action=""><input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
...
<div class="clear"></div>
<div class="Block">
<label><span>*</span> Disposal Code </label> 
<input id="codeId" type="text" name="<%= CODE%>" value=""
	validate="Disposal Code,string,yes" class="textbox_size20"
	MAXLENGTH="8" / tabindex=1>
<label><span>*</span> Disposal Name </label> 
<input type="text" name="<%= SEARCH_NAME %>" value="" validate="Disposal Name,string,yes" class="textbox_size20" MAXLENGTH="30" / tabindex=1 onkeypress="return submitenter(this,event,'generalMaster?method=addDisposal')">
<script>
...
<input type="button" name="add" id="addbutton" value="Add"
	class="button"
	onClick="submitForm('disposal','generalMaster?method=addDisposal');"
	accesskey="a" tabindex=1 /> <input type="button" name="edit"
	id="editbutton" value="Update" style="display: none;" class="button"
	onClick="submitForm('disposal','generalMaster?method=editDisposal')"
	accesskey="u" tabindex=1 /> <input type="button" name="Delete"
	id="deletebutton" value="Activate" style="display: none;"
	class="button"
	onClick="submitForm('disposal','generalMaster?method=deleteDisposal&flag='+this.value)"
