...
<h4>Details</h4>
<label>Disposal No :</label> <input
	type="text" name="<%=DISPOSAL_NO%>" value="<%=max%>"
	class="textbox_size20" MAXLENGTH="20" />
<label>Disposal Date:</label> <input type="text" readonly="readonly"
	name="<%=DISPOSAL_NO%>" value="<%=date%>" class="readOnly"
	MAXLENGTH="20" />
	<label>BOS No:</label> <select
...
<input type="button" value="Generate Indent" class="button"	onclick="if(testForIndent()){submitForm('disposalEntry','nonExp?method=generateIndent&entryType=l');}" />
<input type="button" value="Generate CIV" class="button" onclick="if(testForIndent()){submitForm('disposalEntry','nonExp?method=generateCiv');}" />
<div class="clear"></div>
...
<div class="cmntable">
<table width="100%" colspan="0" id="mmfDepartmentDetails"
	class="grid_header" border="0" cellpadding="0" cellspacing="0">
	<thead>
		<tr>
			<th>S.No.</th>
			<th>PVMS No</th>
