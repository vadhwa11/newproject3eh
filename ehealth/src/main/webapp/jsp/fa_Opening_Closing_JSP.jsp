...
<div class="clear"></div>
<h2>Openiong and Closing Report</h2>
<div class="clear"></div>
<div class="clear"></div>
<div class="Block">
...
<input type="button" name="OK" id="addbutton" value="Print" class="button" onClick="submitForm('cashRegister','account?method=printOpeningandClosingReport');" accesskey="a" tabindex=1 />
