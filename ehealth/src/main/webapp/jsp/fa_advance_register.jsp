...
<form name="advanceRegister" method="post" action="">
<div class="clear"></div>
...
<img id="calendar"	src="/hms/jsp/images/cal.gif" width="16" height="16" border="0"	validate="Pick a date"	onclick="setdate('<%=currentDate%>',document.advanceRegister.<%= FROM_DATE%>,event);" />
<label><span>*</span> To Date </label> 
<input type="text"	name="<%= TO_DATE %>" value="<%=currentDate%>" class="date"	maxlength="30" tabindex=1 /> 
<img id="calendar"	src="/hms/jsp/images/cal.gif" width="16" height="16" border="0"	validate="Pick a date"	onclick="setdate('<%=currentDate%>',document.advanceRegister.<%= TO_DATE%>,true);" />
...
<input type="button" name="OK" id="addbutton" value="Print" class="button" onClick="submitForm('advanceRegister','account?method=printAdvanceRegisterReport2');" accesskey="a" tabindex=1 />
<!-- <input type="button" name="OK" id="addbutton" value="Print For NRHM" class="buttonBig" onClick="submitForm('advanceRegister','account?method=printStatementOfExpenditureReportForNRHM');" accesskey="a" tabindex=1 /> -->
