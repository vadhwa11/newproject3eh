...
<table width="100%" border="0" cellspacing="0" cellpadding="0"	id="voucherDetails" class="cmntable">
	...
	<tr class="background">
		...
		<td colspan=2><input id="totalCrAmountId" type="text" class="readOnlySmall" readonly="readonly" name="<%=TOTAL_CR_AMOUNT %>" value="" validate="Total CrAmount,float,yes" MAXLENGTH="15" tabindex=1 /></td>
	</tr>
	<tr class="background">
...
function validateAccountName( strValue,inc,tdid ) {
 	...
 	if(strValue != "")
	{
		    ...
		    if(id!="")
		    {
		    	submitProtoAjaxWithDivName('purchaseReturnVoucher','account?method=getSubLedgerForAccount&accName='+encodeURIComponent(strValue)+'&rowVal='+inc,tdid+inc);
		    }
	}
}
