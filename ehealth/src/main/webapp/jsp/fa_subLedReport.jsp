...
<form name="subLed" method="post" action="">
<div class="clear"></div>

<div class="titleBg">
<h2>Sub Ledger</h2></div>
<div class="clear"></div>
<div class="clear"></div>
<div class="Block">
...
<select id="accountId" name="accountId" validate="Account Name,string,yes"  />
...
<%--- Report Button   --%>
<input type="button" name="add" id="addbutton" value="Print" class="button" onClick="submitForm('subLed','account?method=printSubLed');" accesskey="a" tabindex=1 />
