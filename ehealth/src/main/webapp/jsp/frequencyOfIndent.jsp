...
<form name="frequencyOfIndent" method="post" action="">
<div class="titleBg">
...
<label><span>*</span> To Date</label> <input type="text"
	...
	validate="Pick a date" class="calender" tabindex="1"
	onClick="setdate('<%=currentDate%>',document.frequencyOfIndent.<%=TO_DATE%>,event)" />
<div class="clear"></div>
</div>
<div class="clear"></div>
...
<input type="button" name="add" id="addbutton" value="Ok" class="button"
	onClick="submitForm('frequencyOfIndent','stores?method=generateFrequencyOfIndentReport','check()');"
	accesskey="a" tabindex=1 /> <input type="button" name="clear"
	id="clearbutton" value="Clear" class="button"
	onClick="clearButton('frequencyOfIndent');" accesskey="a" tabindex=1 />
<div class="clear"></div>
<div class="division"></div>
<div class="clear"></div>
