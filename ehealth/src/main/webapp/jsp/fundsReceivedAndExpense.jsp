...
<%
	...
	System.out.println("subLedList.size() ------  --->>"+subLedList.size());
	String userName = "";
...
<form name="fundsReceived" method="post" action="">
<div class="clear"></div>
<h2>Funds Received And Expense </h2>
<div class="clear"></div>
<div class="Block">
<label><span>*</span> From Date </label> 
<input	type="text" name="<%= FROM_DATE %>" value="<%=currentDate%>"	class="date" maxlength="30" tabindex=1 /> 
<img id="calendar"	src="/hms/jsp/images/cal.gif" width="16" height="16" border="0"	validate="Pick a date"	onclick="setdate('<%=currentDate%>',document.fundsReceived.<%= FROM_DATE%>,event);" />
<label><span>*</span> To Date </label> 
<input type="text"	name="<%= TO_DATE %>" value="<%=currentDate%>" class="date"	maxlength="30" tabindex=1 /> 
<img id="calendar"	src="/hms/jsp/images/cal.gif" width="16" height="16" border="0"	validate="Pick a date"	onclick="setdate('<%=currentDate%>',document.fundsReceived.<%= TO_DATE%>,true);" />
<label>JHI Name</label>
<select name="subLedNamwe" id="subLedId">
...
<input type="button" name="OK" id="addbutton" value="Print" class="button" onClick="submitForm('fundsReceived','account?method=printFundsReceivedAndExpenseReport');" accesskey="a" tabindex=1 />
