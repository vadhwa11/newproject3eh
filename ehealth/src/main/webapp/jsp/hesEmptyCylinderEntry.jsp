...
<input type="text" id="entryNo" name="entryNo" value="CMGS/ECD-<%=Entry_data%>" tabindex=1 readonly="readonly" />
...
<input type="button" name="sss" align="right" class="button" value="Submit"
 onclick="if(checkFilledRow()){submitForm('purchaseGrid','hes?method=submitEmptyCylinderDispatchEntry');}" />
