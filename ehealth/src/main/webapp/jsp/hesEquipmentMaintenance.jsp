...
<%@page import="jkt.hms.masters.business.HesEquipmentMaster"%><script type="text/javascript" src="/hms/jsp/js/pops_global.js"></script>
...
<form name="hesMaintenacneSearchShowForm" method="post"">
...
<label>Date </label> <input type="text" name="<%=ON_DATE%>"
	...
	onclick="setdate('<%=currentDate%>',document.hesMaintenacneSearchShowForm.<%= ON_DATE%>,event);" />
...
<%
		...
		{
%>
			<option value=<%=hesEquipmentMaintenance.getId()%>><%=hesEquipmentMaintenance.getEntryNo()%></option>
<%
		}
%>
</select>
...
<%
		...
		{
%>
			<option value=<%=hesEquipmentMaintenance.getEquipmentMaster().getId()%>><%=hesEquipmentMaintenance.getEquipmentMaster().getEquipmentName()%></option>
<%
		}
%>
</select>
...
<input type="image" src="/hms/jsp/images/go.gif" class="button"
	onClick="submitForm('hesMaintenacneSearchShowForm','hes?method=searchEquipmentMaintenance');" />
...
<jsp:include page="searchResultBlock.jsp" /> <%
 ...
 %>
<div class="clear"></div>
<jsp:include page="hesEquipmentMaintenanceDetails.jsp" /> <%
 	}
 %> <script type="text/javascript">
<!--
...
//-->
	...
	onClick="submitForm('hesMaintenacneForm','hes?method=modifyMinorRoutine');" />
