...
<%@page import="jkt.hms.masters.business.MasCountry"%><label>Country</label>
...
<label>State</label>
<select id="stateId" name="<%= STATE %>" validate="State,string,no"
...
<select id="cityId" name="<%= DISTRICT %>" validate="City,string,no"
...
<div id="<%=OTHERCITY %>" style="display: none;"><input
	type="text" name="<%=OTHERCITY %>" value=""
	maxlength="45" /></div>
<script>
