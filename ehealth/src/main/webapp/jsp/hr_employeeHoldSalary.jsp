...
<form name="employeeHoldSalary" method="post" action="">
<div class="titleBg">
<h2>Employee Hold Salary</h2>
</div>
<div class="clear"></div>
...
<div class="clear"></div>
<input name="Ok" type="button" class="button" value="OK" onclick="submitForm('employeeHoldSalary','payroll?method=printEmployeeHoldSalaryReport');" />
