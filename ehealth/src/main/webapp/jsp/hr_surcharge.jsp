...
<div class="clear"></div>
 <div id="edited"></div>
	...
	<input type="button" name="add" id="addbutton" value="Add" class="button" onClick="submitForm('surcharge','incomeTaxMaster?method=addSurcharge');" accesskey="a" tabindex=1/>

	<input type="button" name="edit" id="editbutton" value="Update" class="button" style="display: none;" onClick="submitForm('surcharge','incomeTaxMaster?method=editSurcharge')" accesskey="u" tabindex=1 />

	<input type="button" name="Delete" id="deletebutton" value="Activate" class="button" onClick="submitForm('surcharge','incomeTaxMaster?method=deleteSurcharge&flag='+this.value)" accesskey="d" tabindex=1/>		
