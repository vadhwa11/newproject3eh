...
<%
				...
				if(map.get("ptVisitList")!= null){
				 ...
				 int visitTypeId1 = 0;
				if(map.get("visitTypeId")!= null){
					visitTypeId1 = (Integer)map.get("visitTypeId");
				}
...
<div class="titleBg"> <h2>Update Schedule</h2></div>

<div class="clear"></div>
<form name="updateScheduleSetting" method="post" action="" >
<div class="clear"></div>
<div class="Block">
...
<div class="clear"></div>
	...
	<select name="<%=PATIENT_VISIT_TYPE%>" id="<%= PATIENT_VISIT_TYPE %>" validate="P Visit Type,string,yes" onchange="submitForm('updateScheduleSetting','projectTracking?method=saveUpdateSchedule');" >
		<option value="0">Select</option>
	<%
			
			for (HrMasVisitType hrMasVisitType: masVisitTypeList ) {
				if(hrMasVisitType.getId().equals(visitTypeId1) ){
				%>
...
<input name="add" type="button" class="button" value="Submit" onClick="submitForm('updateScheduleSetting','projectTracking?method=updateScheduleDetails');"/>
