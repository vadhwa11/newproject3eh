...
<form name="ipdPhysiotherapyList" method="post">
<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
...
<div class="Block"><label class="auto">Consulting Doctor</label> <select
	...
	onClick="submitForm('ipdPhysiotherapyList','opd?method=showPhysiotherapyPatientList&filter=true')"
	class="button" "/>
