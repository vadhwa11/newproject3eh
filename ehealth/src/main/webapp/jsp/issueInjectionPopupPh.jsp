...
function saveNursingCareValues(Id,rowVal)
{
	    ...
	    var url = "pubHealth?method=submitNursingCare&"+csrfTokenName+"="+csrfTokenValue+"&immunizationInj="+document.getElementById("immunizationInj").value+"&vaccinId="+document.getElementById("vaccinId").value+"&hinId="+document.getElementById("hinId").value+"&sessionId="+sessionId;
