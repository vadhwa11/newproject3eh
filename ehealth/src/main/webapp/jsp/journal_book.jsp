...
<form name="Journalbook" method="post" action="">
<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
<div class="clear"></div>

<div class="paddingTop15"></div>
<h4>Journal Book Report</h4>
<div class="clear"></div>
<div class="clear"></div>
<div class="Block">
	...
	<img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0" onclick="setdate('',document.Journalbook.from_date,event)" />

<label><span>*</span>To Date:</label>
	<input type="text" name="to_date" id="to_date" value="<%=date %>" class="date" readonly="readonly" MAXLENGTH="30" />
	<img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0" onclick="setdate('',document.Journalbook.to_date,event)" />


<div class="clear"></div>
<input type="button" name="add" id="addbutton" value="Print" class="button" onClick="submitForm('Journalbook','account?method=printJournalBookReport');" accesskey="a" tabindex=1 />
