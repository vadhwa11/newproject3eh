...
HTMLstr += "<table class='calenderD' style='position:absolute;top:350px; left:730px;' cellspacing='0' cellpadding='0' border='1'>\n";
HTMLstr += "<tr><td bgcolor='darkblue'>\n";
HTMLstr += "\n";
HTMLstr += "<table border='0' cols='3' class='calenderD'  width='100%'>\n";
HTMLstr += "<tr>\n";
...
HTMLstr += "\n";
HTMLstr += "<table border=0 cols=7 class='calenderD'>\n";
HTMLstr += "<tr>\n";
