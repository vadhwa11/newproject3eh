...
<%
if(searchMajorHeadList!= null){

		if(searchMajorHeadList.size()>0 )
...
%><h4> <a href="budget?method=showBudgetMajorHead">Show All Records</a></h4> <%
	 ...
	 if(searchMajorHeadList.size()==0 && map.get("search") != null)
	  {
	 %> <h4><a href="budget?method=showBudgetMajorHead">Show All Records</a></h4>
...
formFields =
	[[0, "<%= COMMON_ID%>", "id"], [1,"<%= CODE%>"], [2,"<%= SEARCH_NAME %>"], [3,"<%= STATUS%>"]  ];
...
<div class="Block">
<label><span>*</span>	Major Head Code</label>
...
<input type="text" id="fname11"  name="" value="" class="textbox_size20" MAXLENGTH="8" onblur="getSequenceNo(this.value);" tabindex=1 validate="Sequence No.,string,yes">
...
data_header[0][0] = "Major Head Code"
data_header[0][1] = "data";
data_header[0][2] = "25%";
data_header[0][3] = "<%= CODE%>"

data_header[1] = new Array;
data_header[1][0] = "Major Head Name"
...
<%
	if(searchMajorHeadList != null)
	{
		Iterator itr=  searchMajorHeadList.iterator();
		int  counter=0;
		while(itr.hasNext())
		{
