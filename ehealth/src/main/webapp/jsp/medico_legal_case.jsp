...
<div class="Block"><label class="medium"><%=prop.getProperty("com.jkt.hms.registration_no") %></label> <label
	...
	%> <label><%=prop.getProperty("com.jkt.hms.ipd_no") %></label> <label class="value"><%=adNo %></label> <%}else if(flag.equals("opMlc")){ %>

<label><%=prop.getProperty("com.jkt.hms.opd_no") %></label> <label class="value"><%=visitNo %></label>
