...
<div class="clear"></div>
<input type="button" name="yes" value="Yes" class="button"	onclick="submitForm('messageMisBirth','/hms/hms/opd?method=printFitenessCertificate&opreferralId=<%=opPatientReferralId %>');" />
