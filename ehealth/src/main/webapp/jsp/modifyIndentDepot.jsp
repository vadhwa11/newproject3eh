...
<h2 align="left" class="style1">Indent To Depot-Modify</h2>
		...
		<table width="20%" align="right" border="0" cellpadding="0"
			...
			<tr>
				...
				<td width="4%" background="/hms/jsp/images/toolbuttBack.gif"><input
					...
					onClick="submitForm('indent','stores?method=printIndentDepotJsp&indentId='+<%=indentId %>);" /></td>
...
<select name="<%= RequestConstants.TYPE_OF_INDENT%>" tabindex="1"
	...
	type="text" name="<%= RequestConstants.NRS %>" tabindex="1"
...
<div style="float: left; padding-left: 15px;"><input type="button"
	...
	onclick="if( checkSave()&&checkForNext()){submitForm('indentGrid','stores?method=updateNextOrSubmitIndentToDepot&buttonName=next');}"
	align="right" /> <input type="button" name="sss" align="right"
	class="button" value="Submit"
	onclick="if( checkSave()&&checkForSubmit()){submitForm('indentGrid','stores?method=updateNextOrSubmitIndentToDepot&buttonName=submit');}" />
</div>
	...
	<tbody>
		...
		<tr>
			...
			<td width="10%"><input type="text"
				...
				id="<%=section%>" class="medcaption" readonly="readonly"></td>
			<%}catch(Exception e){ %>
			...
			<td width="10%"><input type="text" MAXLENGTH="7"
				value="<%=storeIndentT.getQtyInMmf() %>" class="medcaption"
				tabindex=1 name="0" id="<%=mmfVarTemp%>"
		...
		<tr>
			...
			<td width="3%"><input type="text" value="" class="smcaption"
