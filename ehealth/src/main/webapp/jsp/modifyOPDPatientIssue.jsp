...
<%
	...
	List storeOPDIssueTList= new ArrayList();
	try {
...
<div style="padding-left: 5px;"><input type="button"
	class="button" value="Delete " align="left"
	onClick="if(validateRadioForDelete()){submitForm('modifyOPDPatientIssue','stores?method=deleteStockDetails');}" />
