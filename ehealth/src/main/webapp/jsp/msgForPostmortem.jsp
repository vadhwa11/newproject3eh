...
function getBackPage(){
	...
	window.location="/hms/hms/mlc?method=showMortuaryRegisteredDetails";
...
function printReport(){
	...
	window.location="/hms/hms/mlc?method=generateReportForPostmortem&mortuaryRegdDetailId="+mortuaryId;
