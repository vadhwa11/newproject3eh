...
<script type="text/javascript" language="javascript">
	...
	{	
		...
		<%-- data_arr[<%= i%>][12] ="<select name='skip<%=i%>' id='skip<%=i%>' ><option value='0'>Select</option><option value='E'>Emergency</option><option value='S'>Special</option></select>"; --%>
 ...
 */	}
	...
	function stopRegistration()
	{
		if(confirm("Are You sure, You want to stop your registration for rest of the day?"))
			submitForm('opd_OP_Clinic_Waiting_PatientList','/hms/hms/opd?method=setVisitUptoTimeOfDoctor');
		else
			return false;
