...
<span><%=message1 %></span>
<h4>Lab Waiting list</h4>
<div class="Block">
<form name="labWaitingList" action="" method="post">
...
<form name="opd_OP_Clinic_Waiting_PatientListLab" method="post" action="">
<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
...
<script type="text/javascript">
	function openWindows(){
	    obj1 = eval('document.opd_OP_Clinic_Waiting_PatientListLab');
	    var url = "/hms/hms/opd?method=getOPClinicalReadViewList";
	    obj1.action = url;
		obj1.submit();
	}
	function validate(){
		...
		if(!chkInputLength(patientName))
			...
			submitForm('labWaitingList','/hms/hms/lab?method=getOPClinicalWaitingListLab');
	}
