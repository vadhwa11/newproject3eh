...
<script type="text/javascript" language="javascript">
	...
	{	
		...
		var releaseButton = "<input type=\"button\" name=\"btn\" id=\"btn\" value=\"Release\" onclick=\"doPatientRelease(\'"+visitid+"\',\'opDetail\');\"  />";
 ...
 */	}
						...
						if(msg.indexOf("success~~~true") != -1)
							{
									...
									bReleaseClick ='N';
									window.location ="opd?method=showNewOPWaitingList&selectedAppId=A2174";
	...
	function transferToCommonPool(employeeId,page){
		 ...
		 newwindow=window.open(url,"Second Opinion","left=150,top=100,height=130,width=1050,status=1,scrollbars=1,resizable=0");
