...
%>
<div class="titleBg">
<h2>OPD Ophthalmology Format</h2>
</div>
<div class="clear"></div>
...
<label><%=prop.getProperty("com.jkt.hms.registration_no") %></label> <input type="text" id="hinNo" name="<%=HIN_NO%>"
	validate="Reg No,string,yes" value="" MAXLENGTH="20"
...
<input type="button" name="OK" value="OK" class="button"
	onClick="submitForm('search','opd?method=showOpdOphthalmologyMainCaseSheetReport');" />
