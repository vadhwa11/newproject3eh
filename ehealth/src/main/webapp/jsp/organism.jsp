...
<%--- Report Button  <input type="button" name="report" value="Generate Report Based on Search" class="button" onclick="submitForm('search','laboratory?method=generateReportForLabOrganismDesc')" tabindex=1  /> --%>
...
<div class="clear"></div>
<div class="Block">
<label><span>*</span> Organism Code  </label> 
<input id="codeId" type="text" name="<%= CODE%>" value="" validate="Organism Code,string,yes" class="textbox_date" MAXLENGTH="8" / tabindex=1>
<label><span>*</span> Organism Name </label> 
<input type="text" name="<%= SEARCH_NAME %>" value="" validate="Organism Name,string,yes" class="textbox_date" MAXLENGTH="30" / tabindex=1 onkeypress="return submitenter(this,event,'laboratory?method=addOrganism')">
<script>
...
<input type="button" name="edit" id="editbutton" value="Update" style="display: none;" class="button" onClick="submitForm('organism','laboratory?method=editOrganism')" accesskey="u" tabindex=1 /> 
<input type="button" name="Delete" id="deletebutton" value="Activate" style="display: none;" class="button" onClick="submitForm('organism','laboratory?method=deleteOrganism&flag='+this.value)" accesskey="d" tabindex=1 /> 
