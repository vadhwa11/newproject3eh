...
<input type="button" name="yes" value="Yes" class="button"
	onclick="submitForm('message','/hms/hms/ot?method=printOtPostAnesthesiaProcedureReport&yearlySlNo=<%=YearlySrNo %>','checkTargetForYes','checkTargetForNo');" />
<input type="button" name="no" class="button" value="No"
	onclick="showBack('message');checkTargetForNo()" /></form>