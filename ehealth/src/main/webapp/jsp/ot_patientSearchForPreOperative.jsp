...
<%
    ...
    %></span></h4> <%if(otProcedure.equals("yes")){ %>
<div class="titleBg">
...
<script type="text/javascript">
 ...
 <input type="button" name="Submit" id="addbutton" value="Search" class="button" accesskey="a" 
 	onclick="if(checkBlank()){submitForm('search','/hms/hms/ot?method=showPreOperativeCheckList&otProcedure=<%=otProcedure%>');}" />
 <%--
<input type="button" name="Submit" id="addbutton"
	...
	value="New Record Search" class="buttonBig2" accesskey="a" /> 
<%if(otProcedure.equals("yes")){ %>
...
<div class="clear"></div>
<form name="consent11" method="post" action="">
<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
