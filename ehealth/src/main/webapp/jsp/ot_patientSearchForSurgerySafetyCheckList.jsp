<%-- 
	 ...
	 * File Name           : ot_patientSearchForSurgerySafetyCheckList.jsp 
	 * Tables Used         : 
	 * Description         : 
	 * @author  Create Date: 07.03.2008    Name: Amit Das
...
<div class="titleBg">
<h2>Surgery Safety CheckList Search</h2>
</div>
...
<script type="text/javascript">
 ...
 <input type="button" name="Submit" id="addbutton" value="Search" class="button" accesskey="a" 
 	onclick="if(checkBlank()){submitForm('search','/hms/hms/ot?method=showSurgerySafetyCheckWaitngListJsp&otProcedure=<%=otProcedure%>');}" />
</div>
</form>
<div class="clear"></div>
<div class="clear"></div>
...
<div class="clear"></div>
<form name="surgeryCheckList" method="post" action="">
<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
...
<script type="text/javascript" language="javascript">
	...
	data_header[7][0] = "Booking Id"
	data_header[7][1] = "hide";
	data_header[7][2] = "10%";
	data_header[7][3] = "bookingId"
