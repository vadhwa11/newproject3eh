...
<%
		...
		if(map.get("testList") != null){
			chargeCodeList = (List<DgMasInvestigation>)map.get("testList");
		}
...
<div class="titleBg">
<h2>Patient Category wise Total Test Performed</h2>
</div>
...
<select name="investigationName" id="investigationName" >
<option value="0">--Select--</option>
<%
if(chargeCodeList.size()>0){
for(DgMasInvestigation masInvestigation:chargeCodeList){ %>
<option value="<%=masInvestigation.getId()%>"><%=masInvestigation.getInvestigationName()%></option>
<%}}%>
</select>
<script type="text/javascript">
...
<input type="button" name="OK" value="OK" class="button"
	onClick="submitForm('diagnosisWise','lab?method=generateTotalTestPerformedReport','validateFromToDate');" />
