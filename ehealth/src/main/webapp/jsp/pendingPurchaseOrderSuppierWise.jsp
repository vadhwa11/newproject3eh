...
<%
	...
	if(map.get("searchMasStoreSupplierList")!=null){
		searchMasStoreSupplierList=(List<MasStoreSupplier>)map.get("searchMasStoreSupplierList");
	}
...
<div class="titleBg">
<h2>Pending PO Supplier Wise</h2>
</div>
<div class="clear"></div>
<div class="Block">
...
<div class="clear"></div>
<label>Pending PO Supplier Wise</label>
<input type="radio" name="reportType"	value="<%=SUMMARY  %>" class="inputRadiobutton" checked="checked"	tabindex=1 validate="reportType,metachar,no"/>
<label class="auto" style="padding:0px 12px 0px 5px;">Pending Vendor Wise PO Wise</label>
<input	type="radio" name="reportType" value="<%=DETAIL  %>" class="radioCheck"	tabindex=1 validate="reportType,metachar,no"/>
<div class="clear"></div>
