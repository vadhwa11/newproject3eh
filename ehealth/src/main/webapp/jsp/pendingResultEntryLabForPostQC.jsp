...
<label>Patient Name</label> <input type="text" name="<%=P_FIRST_NAME %>"
	...
	onclick="submitForm('patientSearch','/hms/hms/investigation?method=showPendingForResultEntryLabJspForPostQC','checkFromNTodata');"
...
<div class="clear"></div>
<form name="pendingResultEntryLabForPostQC" method="post" action="">
...
<script type="text/javascript" language="javascript">
//searchPatientForResultEntryLabForPostQC
	formName = "pendingResultEntryLabForPostQC";
	start = 0
