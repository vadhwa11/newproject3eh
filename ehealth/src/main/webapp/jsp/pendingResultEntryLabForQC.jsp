...
<select id="departmentId" name="<%=DEPARTMENT_ID %>">
	...
	<input type="button" value="Search" class="button"
		onclick="submitForm('patientSearch','/hms/hms/investigation?method=searchPatientForLabForQC','checkFromNTodata','chkPatientTypeForBillno');"
...
<div id="searchresults" tabindex="2">
	...
	<form name="pendingResultForLabForQC" method="post" action="">
...
<script type="text/javascript" language="javascript">
formName = "pendingResultForLabForQC"
start = 0
