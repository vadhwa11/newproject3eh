...
<h4><%=message%></h4>
<input type="button" name="add" id="addbutton" value="Back" class="button" onClick="submitForm('patientAD','pubHealth?method=showAtpJphnJhiApprovalJsp');" accesskey="a" tabindex=1 />
