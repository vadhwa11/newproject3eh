...
<input type="button" name="add" id="addbutton" value="Back" class="button" onClick="submitForm('patientAD','pubHealth?method=showJphnAndJhiMonthlyObservationsJsp');" accesskey="a" tabindex=1 />
