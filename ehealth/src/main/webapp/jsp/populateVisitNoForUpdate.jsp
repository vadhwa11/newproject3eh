...
<%
	...
	validate="<%=prop.getProperty("com.jkt.hms.opd_no") %>,string,yes" id="visitId">
	...
	<% } 
	     	 %>
</select> <%}else{ %> <input type="text" name="<%=VISIT_NUMBER%>" value=""
	MAXLENGTH="6" class="readOnly" validate="<%=prop.getProperty("com.jkt.hms.opd_no") %>,String,yes" readonly="readonly"  /> <script>
