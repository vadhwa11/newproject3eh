...
<form name="projectTaskTimeCost" method="post" action="">
<div class="titleBg">
<h2>Project Task Time Cost</h2></div>
    ...
    <div class="clear"></div>
    	...
    	<input name="<%=FROM_DATE%>" id="fromDateForApply" type="text" readonly validate='From Date,date,yes' value="" class="date" />
   		<img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0" id="calFromDate" 
   			onclick="javascript:setdate('',document.projectTaskTimeCost.<%=FROM_DATE%>,event)"  />
    	<div class="clear"></div>
    	...
    	<img src="/hms/jsp/images/cal.gif" width="16" height="16" border="0" id="calToDate"
    		onclick="javascript:setdate('',document.projectTaskTimeCost.<%=TO_DATE%>,event)" />
    	
    	 <div class="clear"></div>
    	<input type="button" class="button" value="print" name="print" onclick="submitForm('projectTaskTimeCost','/hms/hrms/report?method=printProjectTaskTimeCostReport');"/>
