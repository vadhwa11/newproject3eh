...
<label>CHC</label>
<select name="chcphc" id="chcphc" onblur="submitProtoAjaxWithDivName('search','/hms/hms/pubHealth?method=getBirthBasicCenterListchc&chcphc='+this.value,'testDiv');" >
<%	if(chcList.size() >0){%>
...
<label>PHC</label>
<select name="chcphc" id="chcphc" onblur="submitProtoAjaxWithDivName('search','/hms/hms/pubHealth?method=getBirthBasicCenterListphc&chcphc='+this.value,'testDiv');" >
<%	if(phcList.size() >0){%>
				<option value="0">Select</option>
				 <%
