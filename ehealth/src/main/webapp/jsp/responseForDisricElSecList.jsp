...
<select name="distId" id="distId" onchange="submitProtoAjaxWithDivNameToShowStatus('phMapping','/hms/hms/pubHealth?method=getTalukForElSectionList&disId='+this.value,'teDivss');">
