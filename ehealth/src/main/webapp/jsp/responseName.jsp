...
<label><span>*</span>Name of School </label>
<select name="schoolNameId" id="schoolNameId"  validate="Name Of School,string,no"   tabindex=1   
onblur="submitProtoAjaxWithDivNameToShowStatus('schoolRegistration','/hms/hms/pubHealth?method=getNameDetailList&schoolTypeMap=<%=schoolTypeMap%>&villageSurveyId='+this.value,'wSDiv');"
onchange="submitProtoAjaxWithDivNameToShowStatus('schoolRegistration','/hms/hms/pubHealth?method=getNameDetailList&schoolTypeMap=<%=schoolTypeMap%>&villageSurveyId='+this.value,'wSDiv');" >
