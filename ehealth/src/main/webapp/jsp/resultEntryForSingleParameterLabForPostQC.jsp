...
function resetResult(){
	...
	<h4>Post Result Entry Details</h4>
	<div class="clear"></div>
	<div class="Block">
		<div class="clear"></div>
		...
		</label> <label><span>*</span>Post Result Entry By</label>
				...
				<tr>
					...
					<td width="7%">
						<%if(dgDetail.getInvestigation() !=null){
			              ...
			              %><input type="hidden"
						name="resultEntryDetailId"
						id="resultEntryDetailId"
						value="<%=dgDetail.getId() %>" />
						 <input type="hidden"
					...
					<td width="10%">
						...
						readonly="readonly" size="5"/> <%}else { %> <input name="uom" value="-"
	...
	<input type="button" class="button" value="Submit"
		onclick="submitForm('sampleCollection','investigation?method=submitResultEntryForAllInvestigationTypeLabForPostQC');"
