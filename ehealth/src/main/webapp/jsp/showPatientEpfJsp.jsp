...
<input type="text" id="hin_no"  name="hin_no" value="<%=hin_no%>" validate="Reg. No,integer,yes"  onblur="getPatientEpisodes();"  />
<!-- <div class="clear"></div> -->
...
<input type="reset" name="Reset" id="reset" value="Reset" class="buttonHighlight" onclick="resetCheck();" accesskey="r" /> changed by govind 16-11-2016-->
<div class="clear"></div>
<div class="division"></div>
<div class="clear"></div>
<input type="hidden" name="editDate" value="<%=currenDate%>"/>
