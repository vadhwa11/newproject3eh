...
<div class="clear"></div>
<input type="button" name="yes" value="Yes" class="button"	onClick="submitForm('silDilStatusMessage','/hms/hms/adt?method=showSiDiReport&<%=AD_NO%>=<%=andNo%>');" />
<input type="button" name="no" value="No" class="button"	onclick="submitForm('silDilStatusMessage','/hms/hms/adt?method=showSilDilInAdt');" />
