...
<div class="clear"></div>
<input type="button" name="search" value="Search" class="button" onClick="submitForm('replaceMedicinEquipment','stores?method=slowMovingMedicineReport');"	accesskey="g" tabindex=1 />
