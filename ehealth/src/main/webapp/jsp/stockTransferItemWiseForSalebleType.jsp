...
<div class="titleBg">
<h2>Stock Transfer Item Wise For Saleble/Non Saleble</h2>
</div>
<div class="clear"></div>
...
<label>Select Saleble Type</label> <select name="salebaleType">
	<option value=0>Select</option>


	<option value="y">Saleble</option>
	<option value="n">Non Saleble</option>




</select> <input type="hidden" name="reportName" value="<%=NON_SALEBLE %>" validate="reportName,metachar,no">
<div class="clear"></div></div>
<div class="clear"></div>
<input type="button" class="buttonBig" value="Generate Report"
	onclick="submitForm('stockRegisterReport','/hms/hms/stores?method=printReportForStores');" />
