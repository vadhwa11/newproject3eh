...
<label class="auto">SST Code </label> 
<input type="radio"	name="<%=SELECTED_RADIO  %>" value="1" checked="checked"  class="radiobutMargin" />
<label class="auto"> SST Name </label>
...
<%
	...
	if(searchStoreSupplierTypeList.size()==0 && map.get("search") != null)
	  {
	 %> <h4><a href="pharmacy?method=showStoreSupplierTypeJsp">Show All
Records</a></h4> <%
  }
	%> 
...
<div class="clear"></div>
<form name="storeSupplierType" method="post" action=""><input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
...
<div class="clear"></div>
<div class="Block">
<label><span>*</span> SST Code  </label> 
<input id="codeId" type="text" name="<%= CODE%>" value="" validate="SST Code,alphanumeric,yes" class="textbox_size20" MAXLENGTH="8" / tabindex=1> 
<label><span>*</span> SST Name</label> 
<input type="text" name="<%= SEARCH_NAME %>" value="" validate="SST Name,alphanumeric,yes" class="textbox_size20" MAXLENGTH="30" / tabindex=1 onkeypress="return submitenter(this,event,'pharmacy?method=addStoreSupplierType')">
<script>
...
<input type="button" name="edit" id="editbutton" value="Update" style="display: none;" class="button" onClick="submitForm('storeSupplierType','pharmacy?method=editStoreSupplierType')"	accesskey="u" tabindex=1 /> 
<input type="button" name="Delete" id="deletebutton" value="Activate" style="display: none;" class="button" onClick="submitForm('storeSupplierType','pharmacy?method=deleteStoreSupplierType&flag='+this.value)" accesskey="d" tabindex=1 />
...
data_arr[<%= counter%>][2] = "<%= masStoreSupplierType.getSupplierTypeName()!=null?masStoreSupplierType.getSupplierTypeName():""%>"

	 data_arr[<%= counter%>][3] = "<%= masStoreSupplierType.getLastChgBy()!=null?(masStoreSupplierType.getLastChgBy().getId()!=null?masStoreSupplierType.getLastChgBy().getId():"0" ):"0"%>"
