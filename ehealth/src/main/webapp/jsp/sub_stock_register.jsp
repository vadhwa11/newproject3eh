...
<label>Item Name</label> <input type="text" value=""
			tabindex="1" id="itemId" size="40" name="itemId" />
		...
		<script type="text/javascript" language="javascript" charset="utf-8">
			new Ajax.Autocompleter(
					'itemId',
					'ac2update',
					'stores?method=getItemListForAutoCompleteForStockRegister&'+csrfTokenName+'='+csrfTokenValue,
					{
						minChars : 3,
						callback : function(element, entry) {
							return entry;
						},
						parameters : 'requiredField=itemId'
					});
		</script>
...
<div class="clear"></div>
<input type="button" name="OK" value="Generate Report" class="button" onClick="submitForm('stockRegisterReport','stores?method=printDetailedSubStockRegisterReport');" />
