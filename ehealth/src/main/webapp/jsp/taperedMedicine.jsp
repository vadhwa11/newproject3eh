...
<label>Item Name</label><input type="text"
				value="<%=nomenclature%>" readonly="readonly" style="height:25px;" />
<label>Unit</label><input type="text"
				value="<%=unitValue%>" readonly="readonly" style="height:25px;" />
...
<%}%>
<div class="clear"></div>
<div class="tableForTab" style="width:1190px; height:230px; overflow:auto;">
...
function validateTaperedForm(){
	...
	window.opener.document.getElementById("total"+<%=row%>).value=parseFloat(total);
	window.opener.document.getElementById("total"+<%=row%>).readOnly=true;
	window.opener.document.getElementById("dosage"+<%=row%>).value="";
	window.opener.document.getElementById("dosage"+<%=row%>).readOnly=true;
	window.opener.document.getElementById("dosage"+<%=row%>).removeAttribute('onblur');
	window.opener.document.getElementById("nomenclature"+<%=row%>).readOnly=true;
	window.opener.document.getElementById("nomenclature"+<%=row%>).removeAttribute('onblur');
	window.opener.document.getElementById("nomenclature"+<%=row%>).setAttribute('onblur','editTaperedMedicine('+<%=row%>+','+<%=itemId%>+')');
	window.opener.document.getElementById("route"+<%=row%>).disabled= true;
	window.opener.document.getElementById("unit"+<%=row%>).readOnly=true;
	window.opener.document.getElementById("unit"+<%=row%>).value="";
	window.opener.document.getElementById("unit"+<%=row%>).removeAttribute('onblur');
	window.opener.document.getElementById("frequency"+<%=row%>).disabled= true;
	window.opener.document.getElementById("noOfDays"+<%=row%>).readOnly=true;
	window.opener.document.getElementById("noOfDays"+<%=row%>).removeAttribute('onblur');
	window.opener.document.getElementById("noOfDays"+<%=row%>).value="";
	if(window.opener.document.getElementById("instrunction"+<%=row%>)!=null){
	window.opener.document.getElementById("instrunction"+<%=row%>).disabled= true;
	}
	if(window.opener.document.getElementById("instruction"+<%=row%>)!=null){
		window.opener.document.getElementById("instruction"+<%=row%>).disabled= true;
	}
	...
	if(window.opener.document.getElementById("splInstrunction"+<%=row%>)!=null){
		window.opener.document.getElementById("splInstrunction"+<%=row%>).readOnly=true;
		window.opener.document.getElementById("splInstrunction"+<%=row%>).value=dosage;
	}
	if(window.opener.document.getElementById("itemRadio"+<%=row%>)!=null){
		window.opener.document.getElementById("itemRadio"+<%=row%>).disabled= true;  
	}	
...
function cancelFunction(update){
	if(update=="N"){
	window.opener.document.getElementById("nomenclature"+<%=row%>).value="";
