...
%> 
<h2>History of Past Illness Templates</h2>
...
<%
	...
	for(OpdTemplateTreatment treaTemplateTreatment :templateFamilyList){
		...
		if(treaTemplateTreatment.getPastIllnessHistory() !=null){
			if(treaTemplateTreatment.getTemplate() !=null  && treaTemplateTreatment.getPastIllnessHistory() !=null && !treaTemplateTreatment.getPastIllnessHistory().equals("") && treaTemplateTreatment.getPastIllnessHistory().length()>0){
		 		familyHistory=treaTemplateTreatment.getPastIllnessHistory();
 %>
		<tr>
			<td>
...
<script>
 function cancelForm(){
   ...
   function setFamilyHistoryTempalte(){
	 ...
	 window.opener.document.getElementById('pastIllness').value=generalExam;
	 window.opener.document.getElementById('pastIllness').focus();
		 window.close();
  	}
