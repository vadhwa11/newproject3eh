...
%> 
<h2>Personal History Templates</h2>
...
<%
	...
	for(OpdTemplateTreatment treaTemplateTreatment :templateFamilyList){
		...
		if(treaTemplateTreatment.getPersonalHistory() !=null){
			if(treaTemplateTreatment.getTemplate() !=null  && treaTemplateTreatment.getPersonalHistory() !=null && !treaTemplateTreatment.getPersonalHistory().equals("") && treaTemplateTreatment.getPersonalHistory().length()>0){
		 		familyHistory=treaTemplateTreatment.getPersonalHistory();
 %>
		<tr>
			<td>
...
<script>
 function cancelForm(){
   ...
   function setFamilyHistoryTempalte(){
	 ...
	 window.opener.document.getElementById('personalHistory').value=generalExam;
	 window.opener.document.getElementById('personalHistory').focus();
		 window.close();
  	}
