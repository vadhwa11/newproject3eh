...
<input type="button" name="search" value="Search" class="button"
	onclick="submitForm('search','generalMaster?method=searchTitle','checkSearch')"
	...
	name="<%=JASPER_FILE_NAME%>" value="Mas_title"></form>
</div>
</div>
...
<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"><input type="hidden"
	name="<%= POJO_NAME %>" value="MasTitle"> <input type="hidden"
	name="<%=POJO_PROPERTY_NAME %>" value="TitleName"> <input
	type="hidden" name="title" value="Title"> <input type="hidden"
	name="<%=JSP_NAME %>" value="title"> <input type="hidden"
	name="pojoPropertyCode" value="TitleCode">

<div class="paddingTop5"></div>
<div class="clear"></div>
<div class="Block">
<label><span>*</span> Title Code </label> 
<input id="codeId" type="text" name="<%= CODE%>" value="" validate="Title Code,string,yes" class="textbox_size20" MAXLENGTH="8"	/ tabindex=1>
<label><span>*</span> Title Name </label> 
<input type="text" name="<%= SEARCH_NAME %>" value="" validate="Title Name,string,yes" class="textbox_size20" MAXLENGTH="30" / tabindex=1 onkeypress="return submitenter(this,event,'generalMaster?method=addTitle')">
<script>
...
<input type="button" name="add" id="addbutton" value="Add"
	class="button"
	onClick="submitForm('title','generalMaster?method=addTitle');"
	accesskey="a" tabindex=1 /> <input type="button" name="edit"
	id="editbutton" value="Update" style="display: none;" class="button"
	onClick="submitForm('title','generalMaster?method=editTitle')"
