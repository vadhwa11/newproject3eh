...
<label><span>* </span>Status</label> <select name="status"
...
<input type="button" name="Print" id="Print" value="View Report"
	class="button"
	onclick="submitForm('departmentList','report?method=printMyTimeSheetReport');"
	accesskey="r" /> <input type="button" name="xlPrint" id="xlPrint"
	value="Export To Excel" class="button"
	onclick="submitForm('departmentList','report?method=exportToExcelMyTimeSheetReport');"
	accesskey="r" /></div>
