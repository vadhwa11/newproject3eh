...
<input type="button" name="Print" id="Print" value="View Report"
	class="buttonBig"
	onclick="submitForm('departmentList','report?method=printStatusWiseTimeSheetReport');"
	accesskey="r" /> <input type="button" name="xlPrint" id="xlPrint"
	value="Export To Excel" class="buttonBig"
	onclick="submitForm('departmentList','report?method=exportToExcelStatusWiseTimeSheetReport');"
	accesskey="r" /></div>
