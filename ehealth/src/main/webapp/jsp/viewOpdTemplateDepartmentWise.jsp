...
<!--Rich text editor-->
				...
				<%if(opdTemplateDepartmentWise.getResult()!=""){ %>
 <label	class="auto"><%=opdTemplateDepartmentWise.getResult() %></label>
				<%}else{ %>
<label class="value">-</label>
<%} %>
<label class="auto">Remarks</label>
<%if(opdTemplateDepartmentWise.getRemarks()!=""){ %>
<textarea class="large" readonly="readonly"><%=opdTemplateDepartmentWise.getRemarks() %></textarea>
<%}else{ %>
<label class="value">-</label>
 <%} %>
...
<label	class="value"><%=userName %></label> <label>Changed Date:</label> <label
...
<input type="hidden" id="max" name="currentVisitId"
	value="<%=currentVisitId %>"> <%}else{%> <label><span>No
...
<input name="next" type="button" class="button" value="Next"	onclick="submitForm('opdTemplateDepartmentWise','opd?method=viewOpdTemplateDepartmentWisePreNext&flag=next','patientVisitNext');">

<input name="Back" type="button" 	alt="Back" value="Back" class="button"	onclick="submitForm('opdTemplateDepartmentWise','opd?method=showOpdTemplateDepartmentWiseJsp&visitId=<%=currentVisitId%>');"	align="right" />
...
<input type="hidden" id="max" name="currentVisitId"	value="<%=currentVisitId %>"> <!--Bottom labels ends--> <%} %>
<div class="clear"></div>
