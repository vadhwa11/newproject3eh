...
<input 	type="text" name="<%=FROM_DATE%>" value="<%=currentDate%>"
	...
	onclick="setdate('<%=currentDate%>',document.report.<%=FROM_DATE%>,event);" />
<label><span>*</span> To Date </label> <input type="text"
	...
	src="/hms/jsp/images/cal.gif" width="16" height="16" border="0"
	validate="Pick a date"
	onclick="setdate('<%=currentDate%>',document.report.<%=TO_DATE%>,event);" />
<div class="clear"></div>
<div class="clear"></div>

<div class="clear"></div>
<input type="button" name="Report" id="addbutton" value="Generate Excel Report"
class="buttonBig"
onClick="submitForm('report','pubHealth?method=generateHMISExcelReport')" accesskey="e" tabindex=1 />
</div> 
